window.Modernizr = function(t, e, n) {
    ...
    x = function(t, n, i, s) {
        ...
        if (parseInt(i, 10)) for (; i--;) a = e.createElement("div"),
        a.id = s ? s[i] : v + (i + 1),
        c.appendChild(a);
    ...
    A = {}.hasOwnProperty;
    h = o(A, "undefined") || o(A.call, "undefined") ?
    function(t, e) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(t) {
        ...
        i = function() {
            if (this instanceof i) {
                ...
                var o = new s,
                r = e.apply(o, n.concat(C.call(arguments)));
    ...
    k.touch = function() {
        var n;
        return "ontouchstart" in t || t.DocumentTouch && e instanceof DocumentTouch ? n = !0 : x(["@media (", S.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""),
        function(t) {
            n = 9 === t.offsetTop
        }),
        n
    ...
    for (var I in k) h(k, I) && (d = I.toLowerCase(), f[d] = k[I](), L.push((f[d] ? "": "no-") + d));
    return f.addTest = function(t, e) {
        if ("object" == typeof t) for (var i in t) h(t, i) && f.addTest(i, t[i]);
        else {
            if (t = t.toLowerCase(), f[t] !== n) return f;
            e = "function" == typeof e ? e() : e,
            "undefined" != typeof m && m && (g.className += " mz-" + (e ? "": "no-") + t),
            f[t] = e
        }
        return f
    },
    ...
    f.testAllProps = c,
    f.testStyles = x,
    g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (m ? " mz-js mz-" + L.join(" mz-") : ""),
    f
} (this, this.document),
function(t, e) {
    function n(t, e) {
    ...
    function o(t, n, i) {
        ...
        i || (i = s(n));
        var o;
        return o = i.cache[t] ? i.cache[t].cloneNode() : y.test(t) ? (i.cache[t] = i.createElem(t)).cloneNode() : i.createElem(t),
        o.canHaveChildren && !v.test(t) ? i.frag.appendChild(o) : o
    }
    function r(t, n) {
    ...
    function l(t) {
        t || (t = e);
        var i = s(t);
        return T.shivCSS && !f && !i.hasCSS && (i.hasCSS = !!n(t, "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}")),
        m || a(t, i),
        t
    }
    function c(t) {
        for (var e, n = t.getElementsByTagName("*"), s = n.length, o = RegExp("^(?:" + i().join("|") + ")$", "i"), r = []; s--;) e = n[s],
        o.test(e.nodeName) && r.push(e.applyElement(u(e)));
        return r
    }
    function u(t) {
        for (var e, n = t.attributes,
        i = n.length,
        s = t.ownerDocument.createElement(_ + ":" + t.nodeName); i--;) e = n[i],
        e.specified && s.setAttribute(e.nodeName, e.nodeValue);
        return s.style.cssText = t.style.cssText,
        s
    }
    function d(t) {
        for (var e, n = t.split("{"), s = n.length, o = RegExp("(^|[\\s,>+~])(" + i().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), r = "$1" + _ + "\\:$2"; s--;) e = n[s] = n[s].split("}"),
        e[e.length - 1] = e[e.length - 1].replace(o, r),
        n[s] = e.join("}");
        return n.join("{")
    }
    function h(t) {
    ...
    function p(t) {
        ...
        a = t.namespaces,
        l = t.parentWindow;
        return ! k || t.printShived ? t: ("undefined" == typeof a[_] && a.add(_), l.attachEvent("onbeforeprint",
        function() {
            e();
            for (var s, r, a, l = t.styleSheets,
            u = [], h = l.length, p = Array(h); h--;) p[h] = l[h];
            for (; a = p.pop();) if (!a.disabled && w.test(a.media)) {
                try {
                    s = a.imports,
                    r = s.length
                } catch(f) {
        ...
        function() {
            h(o),
            clearTimeout(r._removeSheetTimer),
            r._removeSheetTimer = setTimeout(e, 500)
        }), t.printShived = !0, t)
    }
    var f, m, g = t.html5 || {},
...
function() {
    for (var t = 0; t < Modernizr._domPrefixes.length; t++) if (document[Modernizr._domPrefixes[t].toLowerCase() + "CancelFullScreen"]) return ! 0;
...
function(t, e) {
    ...
    function u(t, e, n, i) {
        if (se.acceptData(t)) {
            ...
            l = a ? se.cache: t,
            c = a ? t[r] : t[r] && r;
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof e) return c || (c = a ? t[r] = q.pop() || se.guid++:r),
            l[c] || (l[c] = a ? {}: {
                toJSON: se.noop
            }),
            ("object" == typeof e || "function" == typeof e) && (i ? l[c] = se.extend(l[c], e) : l[c].data = se.extend(l[c].data, e)),
            o = l[c],
            i || (o.data || (o.data = {}), o = o.data),
            void 0 !== n && (o[se.camelCase(e)] = n),
    ...
    function g(t, e) {
        ...
        if (!o) for (o = [], n = t.childNodes || t; null != (i = n[s]); s++) ! e || se.nodeName(i, e) ? o.push(i) : se.merge(o, g(i, e));
    ...
    function T(t, e) {
        if (1 === e.nodeType && se.hasData(t)) {
            ...
            if (a) {
                delete r.handle,
                r.events = {};
                for (n in a) for (i = 0, s = a[n].length; s > i; i++) se.event.add(e, n, a[n][i])
            }
    ...
    function k(t) {
        var e = fe,
        n = Qe[t];
        return n || (n = _(t, e), "none" !== n && n || (Ze = (Ze || se("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = (Ze[0].contentWindow || Ze[0].contentDocument).document, e.write(), e.close(), n = _(t, e), Ze.detach()), Qe[t] = n),
        n
    }
    function L(t, e) {
        return {
    ...
    function x(t, e) {
        for (var n, i, s, o = [], r = 0, a = t.length; a > r; r++) i = t[r],
        i.style && (o[r] = se._data(i, "olddisplay"), n = i.style.display, e ? (o[r] || "none" !== n || (i.style.display = ""), "" === i.style.display && xe(i) && (o[r] = se._data(i, "olddisplay", k(i.nodeName)))) : (s = xe(i), (n && "none" !== n || !s) && se._data(i, "olddisplay", s ? n: se.css(i, "display"))));
        for (r = 0; a > r; r++) i = t[r],
        i.style && (e && "none" !== i.style.display && "" !== i.style.display || (i.style.display = e ? o[r] || "": "none"));
        return t
    }
    function A(t, e, n) {
        var i = cn.exec(e);
    ...
    function I(t, e, n, i, s) {
        for (var o = n === (i ? "border": "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > o; o += 2)"margin" === n && (r += se.css(t, n + Ce[o], !0, s)),
        i ? ("content" === n && (r -= se.css(t, "padding" + Ce[o], !0, s)), "margin" !== n && (r -= se.css(t, "border" + Ce[o] + "Width", !0, s))) : (r += se.css(t, "padding" + Ce[o], !0, s), "padding" !== n && (r += se.css(t, "border" + Ce[o] + "Width", !0, s)));
        return r
    }
    function D(t, e, n) {
        var i = !0,
        ...
        if (0 >= s || null == s) {
            ...
            i = r && (ne.boxSizingReliable() || s === t.style[e]),
            s = parseFloat(s) || 0
        }
    ...
    function N(t, e) {
        ...
        s = 0;
        for (e = e ? 1 : 0; 4 > s; s += 2 - e) n = Ce[s],
        i["margin" + n] = i["padding" + n] = t;
        return e && (i.opacity = i.width = t),
        i
    }
    function O(t, e, n) {
        for (var i, s = (Sn[e] || []).concat(Sn["*"]), o = 0, r = s.length; r > o; o++) if (i = s[o].call(n, e, t)) return i
    }
    function P(t, e, n) {
        var i, s, o, r, a, l, c, u, d = this,
        h = {},
        p = t.style,
        f = t.nodeType && xe(t),
        m = se._data(t, "fxshow");
        ...
        1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], c = se.css(t, "display"), u = "none" === c ? se._data(t, "olddisplay") || k(t.nodeName) : c, "inline" === u && "none" === se.css(t, "float") && (ne.inlineBlockNeedsLayout && "inline" !== k(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
        n.overflow && (p.overflow = "hidden", ne.shrinkWrapBlocks() || d.always(function() {
            p.overflow = n.overflow[0],
            p.overflowX = n.overflow[1],
            p.overflowY = n.overflow[2]
        }));
        for (i in e) if (s = e[i], gn.exec(s)) {
        ...
        if (se.isEmptyObject(h))"inline" === ("none" === c ? k(t.nodeName) : c) && (p.display = c);
            ...
            for (i in h) r = O(f ? m[i] : 0, i, d),
            i in m || (m[i] = r.start, f && (r.end = r.start, r.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    function $(t, e) {
        var n, i, s, o, r;
        for (n in t) if (i = se.camelCase(n), s = e[i], o = t[n], se.isArray(o) && (s = o[1], o = t[n] = o[0]), n !== i && (t[i] = o, delete t[n]), r = se.cssHooks[i], r && "expand" in r) {
            o = r.expand(o),
            delete t[i];
    ...
    function j(t, e, n) {
        ...
        l = function() {
            if (s) return ! 1;
            for (var e = fn || R(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, o = 1 - i, r = 0, l = c.tweens.length; l > r; r++) c.tweens[r].run(o);
        ...
        u = c.props;
        for ($(u, c.opts.specialEasing); r > o; o++) if (i = bn[o].call(c, t, u, c.opts)) return i;
        return se.map(u, O, c),
    ...
    function U(t) {
        return function(e, n) {
            ...
            if (se.isFunction(n)) for (; i = o[s++];)"+" === i.charAt(0) ? (i = i.slice(1) || "*", (t[i] = t[i] || []).unshift(n)) : (t[i] = t[i] || []).push(n)
        }
    }
    function H(t, e, n, i) {
        function s(a) {
    ...
    function z(t, e, n, i) {
        ...
        for (o = u.shift(); o;) if (t.responseFields[o] && (n[t.responseFields[o]] = e), !l && i && t.dataFilter && (e = t.dataFilter(e, t.dataType)), l = o, o = u.shift()) if ("*" === o) o = l;
        else if ("*" !== l && l !== o) {
    ...
    se.extend = se.fn.extend = function() {
        ...
        a++), "object" == typeof r || se.isFunction(r) || (r = {}), a === l && (r = this, a--); l > a; a++) if (null != (s = arguments[a])) for (i in s) t = r[i],
        n = s[i],
        r !== n && (c && n && (se.isPlainObject(n) || (e = se.isArray(n))) ? (e ? (e = !1, o = t && se.isArray(t) ? t: []) : o = t && se.isPlainObject(t) ? t: {},
        r[i] = se.extend(c, o, n)) : void 0 !== n && (r[i] = n));
        return r
    },
    se.extend({
        ...
        each: function(t, e, i) {
            ...
            a = n(t);
            if (i) {
                if (a) for (; r > o && (s = e.apply(t[o], i), s !== !1); o++);
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (n(Object(t)) ? se.merge(i, "string" == typeof t ? [t] : t) : K.call(i, t)),
            i
        },
        ...
        merge: function(t, e) {
            for (var n = +e.length,
            i = 0,
            s = t.length; n > i;) t[s++] = e[i++];
            if (n !== n) for (; void 0 !== e[i];) t[s++] = e[i++];
            return t.length = s,
            t
        },
        grep: function(t, e, n) {
            for (var i, s = [], o = 0, r = t.length, a = !n; r > o; o++) i = !e(t[o], o),
            i !== a && s.push(t[o]);
            return s
        },
        map: function(t, e, i) {
            ...
            a = n(t),
            l = [];
            if (a) for (; r > o; o++) s = e(t[o], o, i),
            null != s && l.push(s);
            else for (o in t) s = e(t[o], o, i),
            null != s && l.push(s);
            return J.apply([], l)
        },
        guid: 1,
        proxy: function(t, e) {
            ...
            se.isFunction(t) ? (n = G.call(arguments, 2), i = function() {
    ...
    var ce = function(t) {
        function e(t, e, n, i) {
            ...
            if ((e ? e.ownerDocument || e: H) !== M && D(e), e = e || M, n = n || [], !t || "string" != typeof t) return n;
            ...
            if (N && !i) {
                if (s = ye.exec(t)) if (r = s[1]) {
                    if (9 === a) {
                        ...
                        n
                    } else if (e.ownerDocument && (o = e.ownerDocument.getElementById(r)) && j(e, o) && o.id === r) return n.push(o),
                    n
                } else {
                    if (s[2]) return Q.apply(n, e.getElementsByTagName(t)),
                    n;
                    if ((r = s[3]) && E.getElementsByClassName && e.getElementsByClassName) return Q.apply(n, e.getElementsByClassName(r)),
                    n
                }
                if (E.qsa && (!O || !O.test(t))) {
                    if (p = d = U, f = e, m = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (c = k(t), (d = e.getAttribute("id")) ? p = d.replace(Se, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = c.length; l--;) c[l] = p + h(c[l]);
        ...
        function p(t, e, n) {
            ...
            function(e, n, o) {
                ...
                if (r) {
                    ...
                    if (l = e[U] || (e[U] = {}), (a = l[i]) && a[0] === B && a[1] === o) return c[2] = a[2];
        ...
        function v(t, e, n, s, o, r) {
            ...
            i(function(i, r, a, l) {
                ...
                b = n ? o || (i ? t: f || s) ? [] : r: y;
                if (n && n(y, b, a, l), s) for (c = g(b, p), s(c, [], a, l), u = c.length; u--;)(d = c[u]) && (b[p[u]] = !(y[p[u]] = d));
                if (i) {
                    if (o || t) {
                        if (o) {
                        ...
                        for (u = b.length; u--;)(d = b[u]) && (c = o ? ee.call(i, d) : h[u]) > -1 && (i[c] = !(r[c] = d))
                    }
        ...
        function y(t) {
            ...
            o = T.relative[t[0].type], r = o || T.relative[" "], a = o ? 1 : 0, l = p(function(t) {
                return t === e
            },
            r, !0), c = p(function(t) {
            ...
            r, !0), u = [function(t, n, i) {
            ...
            }]; s > a; a++) if (n = T.relative[t[a].type]) u = [p(f(u), n)];
            else {
                if (n = T.filter[t[a].type].apply(null, t[a].matches), n[U]) {
                    ...
                    return v(a > 1 && f(u), a > 1 && h(t.slice(0, a - 1).concat({
                        value: " " === t[a - 2].type ? "*": ""
                    })).replace(le, "$1"), n, i > a && y(t.slice(a, i)), s > i && y(t = t.slice(i)), s > i && h(t))
                }
                u.push(n)
            }
            return f(u)
        ...
        var S, E, T, w, _, k, L, C, x, A, I, D, M, R, N, O, P, $, j, U = "sizzle" + -new Date,
        H = t.document,
        B = 0,
        F = 0,
        z = n(),
        ...
        try {
            Q.apply(J = te.call(H.childNodes), H.childNodes),
        ...
        D = e.setDocument = function(t) {
            ...
            i = n.defaultView;
            return n !== M && 9 === n.nodeType && n.documentElement ? (M = n, R = n.documentElement, N = !_(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload",
            function() {
                D()
            },
            ...
            P = [], O = [], (E.qsa = ve.test(n.querySelectorAll)) && (s(function(t) {
                ...
                t.querySelectorAll("[msallowclip^='']").length && O.push("[*^$]=" + ie + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || O.push("\\[" + ie + "*(?:value|" + ne + ")"),
                t.querySelectorAll(":checked").length || O.push(":checked")
            }), s(function(t) {
                var e = n.createElement("input");
                e.setAttribute("type", "hidden"),
                t.appendChild(e).setAttribute("name", "D"),
                t.querySelectorAll("[name=d]").length && O.push("name" + ie + "*[*^$|!~]?="),
                ...
                $.call(t, "[s!='']:x"),
                P.push("!=", ae)
            }), O = O.length && new RegExp(O.join("|")), P = P.length && new RegExp(P.join("|")), e = ve.test(R.compareDocumentPosition), j = e || ve.test(R.contains) ?
            function(t, e) {
        ...
        e.matchesSelector = function(t, n) {
            if ((t.ownerDocument || t) !== M && D(t), n = n.replace(de, "='$1']"), !(!E.matchesSelector || !N || P && P.test(n) || O && O.test(n))) try {
                var i = $.call(t, n);
        ...
        e.attr = function(t, e) { (t.ownerDocument || t) !== M && D(t);
            ...
            i = n && G.call(T.attrHandle, e.toLowerCase()) ? n(t, e, !N) : void 0;
        ...
        T = e.selectors = {
            ...
            filter: {
                ...
                CLASS: function(t) {
                    var e = z[t + " "];
                    return e || (e = new RegExp("(^|" + ie + ")" + t + "(" + ie + "|$)")) && z(t,
                    function(t) {
                    ...
                    function(t) {
                        ...
                        if (g) {
                            ...
                            if (f = [r ? g.firstChild: g.lastChild], r && y) {
                                for (u = g[U] || (g[U] = {}), c = u[t] || [], p = c[0] === B && c[1], h = c[0] === B && c[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (h = p = 0) || f.pop();) if (1 === d.nodeType && ++h && d === e) {
                                    u[t] = [B, p, h];
                                    break
                                }
                            } else if (y && (c = (e[U] || (e[U] = {}))[t]) && c[0] === B) h = c[1];
                            else for (; (d = ++p && d && d[m] || (h = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v: 1 !== d.nodeType) || !++h || (y && ((d[U] || (d[U] = {}))[t] = [B, h]), d !== e)););
                            return h -= s,
                            h === i || h % i === 0 && h / i >= 0
                        }
                    }
                ...
                PSEUDO: function(t, n) {
                    ...
                    return o[U] ? o(n) : o.length > 1 ? (s = [t, t, "", n], T.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function(t, e) {
                        for (var i, s = o(t, n), r = s.length; r--;) i = ee.call(t, s[r]),
                        t[i] = !(e[i] = s[r])
                    }) : function(t) {
                        return o(t, 0, s)
                    }) : o
        ...
        k = e.tokenize = function(t, n) {
            ...
            for (a = t, l = [], c = T.preFilter; a;) { (!i || (s = ce.exec(a))) && (s && (a = a.slice(s[0].length) || a), l.push(o = [])),
                i = !1,
                (s = ue.exec(a)) && (i = s.shift(), o.push({
                    value: i,
                    type: s[0].replace(le, " ")
                }), a = a.slice(i.length));
                for (r in T.filter) ! (s = fe[r].exec(a)) || c[r] && !(s = c[r](s)) || (i = s.shift(), o.push({
                    value: i,
                    type: r,
                    matches: s
                }), a = a.slice(i.length));
        ...
        L = e.compile = function(t, e) {
            ...
            o = W[t + " "];
            if (!o) {
                for (e || (e = k(t)), n = e.length; n--;) o = y(e[n]),
                o[U] ? i.push(o) : s.push(o);
                o = W(t, b(s, i)),
                o.selector = t
            }
            return o
        ...
        C = e.select = function(t, e, n, i) {
            ...
            if (n = n || [], 1 === d.length) {
                if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (r = o[0]).type && E.getById && 9 === e.nodeType && N && T.relative[o[1].type]) {
                    if (e = (T.find.ID(r.matches[0].replace(Ee, Te), e) || [])[0], !e) return n;
                    c && (e = e.parentNode),
                    t = t.slice(o.shift().value.length)
                }
                for (s = fe.needsContext.test(t) ? 0 : o.length; s--&&(r = o[s], !T.relative[a = r.type]);) if ((l = T.find[a]) && (i = l(r.matches[0].replace(Ee, Te), be.test(o[0].type) && u(e.parentNode) || e))) {
                    if (o.splice(s, 1), t = i.length && h(o), !t) return Q.apply(n, i),
                    n;
                    break
                }
            }
            return (c || L(t, d))(i, e, !N, n, be.test(t) && u(e.parentNode) || e),
            n
        },
        E.sortStable = U.split("").sort(Y).join("") === U,
    ...
    se.fn.extend({
        find: function(t) {
            ...
            if ("string" != typeof t) return this.pushStack(se(t).filter(function() {
                for (e = 0; s > e; e++) if (se.contains(i[e], this)) return ! 0
            }));
    ...
    ge = se.fn.init = function(t, e) {
        ...
        if ("string" == typeof t) {
            ...
            if (n[1]) {
                if (e = e instanceof se ? e[0] : e, se.merge(this, se.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e: fe, !0)), de.test(n[1]) && se.isPlainObject(e)) for (n in e) se.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                return this
            }
    ...
    se.extend({
        dir: function(t, e, n) {
            for (var i = [], s = t[e]; s && 9 !== s.nodeType && (void 0 === n || 1 !== s.nodeType || !se(s).is(n));) 1 === s.nodeType && i.push(s),
            s = s[e];
            return i
        },
    ...
    se.fn.extend({
        ...
        closest: function(t, e) {
            for (var n, i = 0,
            s = this.length,
            o = [], r = ue.test(t) || "string" != typeof t ? se(t, e || this.context) : 0; s > i; i++) for (n = this[i]; n && n !== e; n = n.parentNode) if (n.nodeType < 11 && (r ? r.index(n) > -1 : 1 === n.nodeType && se.find.matchesSelector(n, t))) {
                o.push(n);
                break
            }
    ...
    se.Callbacks = function(t) {
        t = "string" == typeof t ? Se[t] || o(t) : se.extend({},
        t);
        var e, n, i, s, r, a, l = [],
        c = !t.once && [],
        u = function(o) {
            for (n = t.memory && o, i = !0, r = a || 0, a = 0, s = l.length, e = !0; l && s > r; r++) if (l[r].apply(o[0], o[1]) === !1 && t.stopOnFalse) {
                n = !1;
                break
            }
            e = !1,
    ...
    se.extend({
        ...
        when: function(t) {
            ...
            c = function(t, n, i) {
                return function(s) {
                    n[t] = this,
                    i[t] = arguments.length > 1 ? G.call(arguments) : s,
                    i === e ? l.notifyWith(n, i) : --a || l.resolveWith(n, i)
                }
            };
            if (r > 1) for (e = new Array(r), n = new Array(r), i = new Array(r); r > s; s++) o[s] && se.isFunction(o[s].promise) ? o[s].promise().done(c(s, i, o)).fail(l.reject).progress(c(s, n, e)) : --a;
    ...
    se.extend({
        ...
        ready: function(t) {
            if (t === !0 ? !--se.readyWait: !se.isReady) {
                ...
                se.isReady = !0,
                t !== !0 && --se.readyWait > 0 || (Ee.resolveWith(fe, [se]), se.fn.triggerHandler && (se(fe).triggerHandler("ready"), se(fe).off("ready")))
            }
        }
    }),
    se.ready.promise = function(e) {
        if (!Ee) if (Ee = se.Deferred(), "complete" === fe.readyState) setTimeout(se.ready);
    ...
    se.extend({
        ...
        dequeue: function(t, e) {
            ...
            s && ("fx" === e && n.unshift("inprogress"), delete o.stop, s.call(t, r, o)),
            !i && o && o.empty.fire()
        },
    ...
    se.fn.extend({
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;) n = se._data(o[r], t + "queueHooks"),
    ...
    se.event = {
        ...
        add: function(t, e, n, i, s) {
            ...
            if (g) {
                ...
                u.elem = t), e = (e || "").match(be) || [""], a = e.length; a--;) o = Oe.exec(e[a]) || [],
                p = m = o[1],
                f = (o[2] || "").split(".").sort(),
                ...
                l), (h = r[p]) || (h = r[p] = [], h.delegateCount = 0, c.setup && c.setup.call(t, i, f, u) !== !1 || (t.addEventListener ? t.addEventListener(p, u, !1) : t.attachEvent && t.attachEvent("on" + p, u))), c.add && (c.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), s ? h.splice(h.delegateCount++, 0, d) : h.push(d), se.event.global[p] = !0);
                t = null
            }
        },
        remove: function(t, e, n, i, s) {
            ...
            if (g && (u = g.events)) {
                for (e = (e || "").match(be) || [""], c = e.length; c--;) if (a = Oe.exec(e[c]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                    for (d = se.event.special[p] || {},
                    p = (i ? d.delegateType: d.bindType) || p, h = u[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = h.length; o--;) r = h[o],
                    !s && m !== r.origType || n && n.guid !== r.guid || a && !a.test(r.namespace) || i && i !== r.selector && ("**" !== i || !r.selector) || (h.splice(o, 1), r.selector && h.delegateCount--, d.remove && d.remove.call(t, r));
                    l && !h.length && (d.teardown && d.teardown.call(t, f, g.handle) !== !1 || se.removeEvent(t, p, g.handle), delete u[p])
                } else for (p in u) se.event.remove(t, p + e[c], n, i, !0);
                se.isEmptyObject(u) && (delete g.handle, se._removeData(t, "events"))
            }
        },
        trigger: function(e, n, i, s) {
            var o, r, a, l, c, u, d, h = [i || fe],
            p = ee.call(e, "type") ? e.type: e,
            f = ee.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = u = i = i || fe, 3 !== i.nodeType && 8 !== i.nodeType && !Ne.test(p + se.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), r = p.indexOf(":") < 0 && "on" + p, e = e[se.expando] ? e: new se.Event(p, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : se.makeArray(n, [e]), c = se.event.special[p] || {},
            s || !c.trigger || c.trigger.apply(i, n) !== !1)) {
                if (!s && !c.noBubble && !se.isWindow(i)) {
                    for (l = c.delegateType || p, Ne.test(l + p) || (a = a.parentNode); a; a = a.parentNode) h.push(a),
                    u = a;
                ...
                o && o.apply(a, n),
                o = r && a[r],
                o && o.apply && se.acceptData(a) && (e.result = o.apply(a, n), e.result === !1 && e.preventDefault());
        ...
        fix: function(t) {
            ...
            o = t,
            r = this.fixHooks[s];
            for (r || (this.fixHooks[s] = r = Re.test(s) ? this.mouseHooks: Me.test(s) ? this.keyHooks: {}), i = r.props ? this.props.concat(r.props) : this.props, t = new se.Event(o), e = i.length; e--;) n = i[e],
            t[n] = o[n];
        ...
        mouseHooks: {
            ...
            filter: function(t, e) {
                ...
                r = e.fromElement;
                return null == t.pageX && null != e.clientX && (i = t.target.ownerDocument || fe, s = i.documentElement, n = i.body, t.pageX = e.clientX + (s && s.scrollLeft || n && n.scrollLeft || 0) - (s && s.clientLeft || n && n.clientLeft || 0), t.pageY = e.clientY + (s && s.scrollTop || n && n.scrollTop || 0) - (s && s.clientTop || n && n.clientTop || 0)),
        ...
        simulate: function(t, e, n, i) {
            ...
            i ? se.event.trigger(s, null, e) : se.event.dispatch.call(e, s),
    ...
    function(t, e) {
        se.event.special[t] = {
            ...
            handle: function(t) {
                ...
                s = t.relatedTarget,
                o = t.handleObj;
                return (!s || s !== i && !se.contains(i, s)) && (t.type = o.origType, n = o.handler.apply(this, arguments), t.type = e),
                n
            }
        }
    }),
    ...
    ne.changeBubbles || (se.event.special.change = {
        setup: function() {
            return De.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (se.event.add(this, "propertychange._change",
            function(t) {
            ...
            function(t) {
                var e = t.target;
                De.test(e.nodeName) && !se._data(e, "changeBubbles") && (se.event.add(e, "change._change",
    ...
    Je = m(fe),
    Ke = Je.appendChild(fe.createElement("div"));
    ...
    se.extend({
        clone: function(t, e, n) {
            ...
            if (ne.html5Clone || se.isXMLDoc(t) || !je.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (Ke.innerHTML = t.outerHTML, Ke.removeChild(o = Ke.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || se.isXMLDoc(t))) for (i = g(o), a = g(t), r = 0; null != (s = a[r]); ++r) i[r] && w(s, i[r]);
            if (e) if (n) for (a = a || g(t), i = i || g(o), r = 0; null != (s = a[r]); r++) T(s, i[r]);
            else T(t, o);
            return i = g(o, "script"),
            i.length > 0 && E(i, !l && g(t, "script")),
            i = a = s = null,
            o
        },
        buildFragment: function(t, e, n, i) {
            for (var s, o, r, a, l, c, u, d = t.length,
            h = m(e), p = [], f = 0; d > f; f++) if (o = t[f], o || 0 === o) if ("object" === se.type(o)) se.merge(p, o.nodeType ? [o] : o);
            else if (ze.test(o)) {
                for (a = a || h.appendChild(e.createElement("div")), l = (Be.exec(o) || ["", ""])[1].toLowerCase(), u = Ge[l] || Ge._default, a.innerHTML = u[1] + o.replace(He, "<$1></$2>") + u[2], s = u[0]; s--;) a = a.lastChild;
                if (!ne.leadingWhitespace && Ue.test(o) && p.push(e.createTextNode(Ue.exec(o)[0])), !ne.tbody) for (o = "table" !== l || Fe.test(o) ? "<table>" !== u[1] || Fe.test(o) ? 0 : a: a.firstChild, s = o && o.childNodes.length; s--;) se.nodeName(c = o.childNodes[s], "tbody") && !c.childNodes.length && o.removeChild(c);
                for (se.merge(p, a.childNodes), a.textContent = ""; a.firstChild;) a.removeChild(a.firstChild);
                a = h.lastChild
            } else p.push(e.createTextNode(o));
            for (a && h.removeChild(a), ne.appendChecked || se.grep(g(p, "input"), v), f = 0; o = p[f++];) if ((!i || -1 === se.inArray(o, i)) && (r = se.contains(o.ownerDocument, o), a = g(h.appendChild(o), "script"), r && E(a), n)) for (s = 0; o = a[s++];) Ye.test(o.type || "") && n.push(o);
            return a = null,
            h
        },
        cleanData: function(t, e) {
            ...
            l = se.cache,
            c = ne.deleteExpando,
            u = se.event.special; null != (n = t[r]); r++) if ((e || se.acceptData(n)) && (s = n[a], o = s && l[s])) {
                if (o.events) for (i in o.events) u[i] ? se.event.remove(n, i) : se.removeEvent(n, i, o.handle);
    ...
    se.fn.extend({
        ...
        remove: function(t, e) {
            for (var n, i = t ? se.filter(t, this) : this, s = 0; null != (n = i[s]); s++) e || 1 !== n.nodeType || se.cleanData(g(n)),
            n.parentNode && (e && se.contains(n.ownerDocument, n) && E(g(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
        ...
        domManip: function(t, e) {
            ...
            if (c && (a = se.buildFragment(t, this[0].ownerDocument, !1, this), n = a.firstChild, 1 === a.childNodes.length && (a = n), n)) {
                for (o = se.map(g(a, "script"), b), s = o.length; c > l; l++) i = a,
                l !== d && (i = se.clone(i, !0, !0), s && se.merge(o, g(i, "script"))),
                e.call(this[l], i, l);
                if (s) for (r = o[o.length - 1].ownerDocument, se.map(o, S), l = 0; s > l; l++) i = o[l],
                Ye.test(i.type || "") && !se._data(i, "globalEval") && se.contains(r, i) && (i.src ? se._evalUrl && se._evalUrl(i.src) : se.globalEval((i.text || i.textContent || i.innerHTML || "").replace(qe, "")));
                a = n = null
            }
            return this
        }
    ...
    function(t, e) {
        se.fn[t] = function(t) {
            for (var n, i = 0,
            s = [], o = se(t), r = o.length - 1; r >= i; i++) n = i === r ? this: this.clone(!0),
            se(o[i])[e](n),
            K.apply(s, n.get());
    ...
    en = function(t, e, n) {
        ...
        n && ("" !== r || se.contains(t.ownerDocument, t) || (r = se.style(t, e)), sn.test(r) && nn.test(e) && (i = a.width, s = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = n.width, a.width = i, a.minWidth = s, a.maxWidth = o)),
        void 0 === r ? r: r + ""
    ...
    en = function(t, e, n) {
        ...
        r = n ? n[e] : void 0,
        null == r && a && a[e] && (r = a[e]),
        sn.test(r) && !on.test(e) && (i = a.left, s = t.runtimeStyle, o = s && s.left, o && (s.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em": r, r = a.pixelLeft + "px", a.left = i, o && (s.left = o)),
        void 0 === r ? r: r + "" || "auto"
    }),
    function() {
        function e() {
    ...
    se.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                l = t.style;
                if (e = se.cssProps[a] || (se.cssProps[a] = C(l, a)), r = se.cssHooks[e] || se.cssHooks[a], void 0 === n) return r && "get" in r && void 0 !== (s = r.get(t, !1, i)) ? s: l[e];
                if (o = typeof n, "string" === o && (s = un.exec(n)) && (n = (s[1] + 1) * s[2] + parseFloat(se.css(t, e)), o = "number"), null != n && n === n && ("number" !== o || se.cssNumber[a] || (n += "px"), ne.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(r && "set" in r && void 0 === (n = r.set(t, n, i))))) try {
                    l[e] = n
                } catch(c) {}
            }
        },
        css: function(t, e, n, i) {
            var s, o, r, a = se.camelCase(e);
            return e = se.cssProps[a] || (se.cssProps[a] = C(t.style, a)),
            r = se.cssHooks[e] || se.cssHooks[a],
            r && "get" in r && (o = r.get(t, !0, n)),
            void 0 === o && (o = en(t, e, i)),
            "normal" === o && e in hn && (o = hn[e]),
    ...
    function(t, e) {
        se.cssHooks[e] = {
            get: function(t, n, i) {
                return n ? ln.test(se.css(t, "display")) && 0 === t.offsetWidth ? se.swap(t, dn,
                function() {
                    return D(t, e, i)
                }) : D(t, e, i) : void 0
            },
    ...
    ne.opacity || (se.cssHooks.opacity = {
        ...
        set: function(t, e) {
            ...
            n.zoom = 1,
            (e >= 1 || "" === e) && "" === se.trim(o.replace(rn, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || i && !i.filter) || (n.filter = rn.test(o) ? o.replace(rn, s) : o + " " + s)
        }
    }),
    se.cssHooks.marginRight = L(ne.reliableMarginRight,
    function(t, e) {
        return e ? se.swap(t, {
    ...
    function(t, e) {
        se.cssHooks[t + e] = {
            expand: function(n) {
                for (var i = 0,
                s = {},
                o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) s[t + Ce[i] + e] = o[i] || o[i - 2] || o[0];
                return s
            }
        },
    ...
    Sn = {
        "*": [function(t, e) {
            ...
            r = (se.cssNumber[t] || "px" !== o && +i) && vn.exec(se.css(n.elem, t)),
            a = 1,
            l = 20;
            if (r && r[3] !== o) {
                o = o || r[3],
                ...
                do a = a || ".5",
                r /= a,
                se.style(n.elem, t, r + o);
                while (a !== (a = n.cur() / i) && 1 !== a && --l)
            }
            return s && (r = n.start = +r || +i || 0, n.unit = o, n.end = s[1] ? r + (s[1] + 1) * s[2] : +s[2]),
            n
        }]
    };
    ...
    se.fn.extend({
        ...
        stop: function(t, e, n) {
            ...
            this.each(function() {
                ...
                else for (s in r) r[s] && r[s].stop && yn.test(s) && i(r[s]);
                for (s = o.length; s--;) o[s].elem !== this || null != t && o[s].queue !== t || (o[s].anim.stop(n), e = !1, o.splice(s, 1)); (e || !n) && se.dequeue(this, t)
            })
        },
        finish: function(t) {
            return t !== !1 && (t = t || "fx"),
    ...
    se.fx.tick = function() {
        var t, e = se.timers,
        n = 0;
        for (fn = se.now(); n < e.length; n++) t = e[n],
        ...
        val: function(t) {
            var e, n, i, s = this[0]; {
                ...
                this.each(function(n) {
                    var s;
                    1 === this.nodeType && (s = i ? t.call(this, n, se(this).val()) : t, null == s ? s = "": "number" == typeof s ? s += "": se.isArray(s) && (s = se.map(s,
                    function(t) {
                        return null == t ? "": t + ""
                ...
                e && "get" in e && void 0 !== (n = e.get(s, "value")) ? n: (n = s.value, "string" == typeof n ? n.replace(En, "") : null == n ? "": n)
            }
        }
    }),
    se.extend({
        valHooks: {
            ...
            select: {
                get: function(t) {
                    ...
                    r = o ? null: [], a = o ? s + 1 : i.length, l = 0 > s ? a: o ? s: 0; a > l; l++) if (n = i[l], !(!n.selected && l !== s || (ne.optDisabled ? n.disabled: null !== n.getAttribute("disabled")) || n.parentNode.disabled && se.nodeName(n.parentNode, "optgroup"))) {
                ...
                set: function(t, e) {
                    ...
                    o = se.makeArray(e), r = s.length; r--;) if (i = s[r], se.inArray(se.valHooks.option.get(i), o) >= 0) try {
                        i.selected = n = !0
                    } catch(a) {
                        i.scrollHeight
                    } else i.selected = !1;
    ...
    var Tn, wn, _n = se.expr.attrHandle,
    ...
    se.extend({
        attr: function(t, e, n) {
            var i, s, o = t.nodeType;
            if (t && 3 !== o && 8 !== o && 2 !== o) return typeof t.getAttribute === we ? se.prop(t, e, n) : (1 === o && se.isXMLDoc(t) || (e = e.toLowerCase(), i = se.attrHooks[e] || (se.expr.match.bool.test(e) ? wn: Tn)), void 0 === n ? i && "get" in i && null !== (s = i.get(t, e)) ? s: (s = se.find.attr(t, e), null == s ? void 0 : s) : null !== n ? i && "set" in i && void 0 !== (s = i.set(t, n, e)) ? s: (t.setAttribute(e, n + ""), n) : void se.removeAttr(t, e))
        },
        removeAttr: function(t, e) {
            var n, i, s = 0,
            o = e && e.match(be);
            if (o && 1 === t.nodeType) for (; n = o[s++];) i = se.propFix[n] || n,
            se.expr.match.bool.test(n) ? Cn && Ln || !kn.test(n) ? t[i] = !1 : t[se.camelCase("default-" + n)] = t[i] = !1 : se.attr(t, n, ""),
            t.removeAttribute(Ln ? n: i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    wn = {
        set: function(t, e, n) {
            return e === !1 ? se.removeAttr(t, n) : Cn && Ln || !kn.test(n) ? t.setAttribute(!Ln && se.propFix[n] || n, n) : t[se.camelCase("default-" + n)] = t[n] = !0,
            n
        }
    },
    ...
    function(t, e) {
        ...
        _n[e] = Cn && Ln || !kn.test(e) ?
        function(t, e, i) {
            var s, o;
            return i || (o = _n[e], _n[e] = s, s = null != n(t, e, i) ? e.toLowerCase() : null, _n[e] = o),
            s
        }: function(t, e, n) {
    ...
    var xn = /^(?:input|select|textarea|button|object)$/i,
    An = /^(?:a|area)$/i;
    se.fn.extend({
        prop: function(t, e) {
    ...
    se.fn.extend({
        addClass: function(t) {
            ...
            if (c) for (e = (t || "").match(be) || []; l > a; a++) if (n = this[a], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(In, " ") : " ")) {
        ...
        toggleClass: function(t, e) {
            ...
            function(n) {
                ...
                s = se(this), o = t.match(be) || []; e = o[i++];) s.hasClass(e) ? s.removeClass(e) : s.addClass(e);
        ...
        hasClass: function(t) {
            for (var e = " " + t + " ",
            n = 0,
            i = this.length; i > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(In, " ").indexOf(e) >= 0) return ! 0;
            return ! 1
        }
    }),
    ...
    try {
        ...
        On = fe.createElement("a"),
        On.href = "",
        On = On.href
    }
    Nn = Fn.exec(On.toLowerCase()) || [],
    se.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function(t, e) {
            ...
            e = e || {};
            var i, s, o, r, a, l, c, u, d = se.ajaxSetup({},
            e),
            h = d.context || d,
            ...
            E = {
                ...
                getResponseHeader: function(t) {
                    var e;
                    if (2 === b) {
                        if (!u) for (u = {}; e = jn.exec(r);) u[e[1].toLowerCase()] = e[2];
                        e = u[t.toLowerCase()]
                    }
            ...
            if (f.promise(E).complete = m.add, E.success = E.done, E.error = E.fail, d.url = ((t || d.url || On) + "").replace(Pn, "").replace(Bn, Nn[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = se.trim(d.dataType || "*").toLowerCase().match(be) || [""], null == d.crossDomain && (i = Fn.exec(d.url.toLowerCase()), d.crossDomain = !(!i || i[1] === Nn[1] && i[2] === Nn[2] && (i[3] || ("http:" === i[1] ? "80": "443")) === (Nn[3] || ("http:" === Nn[1] ? "80": "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = se.param(d.data, d.traditional)), H(zn, d, e, E), 2 === b) return E;
            l = d.global,
            l && 0 === se.active++&&se.event.trigger("ajaxStart"),
            d.type = d.type.toUpperCase(),
            d.hasContent = !Hn.test(d.type),
            o = d.url,
            d.hasContent || (d.data && (o = d.url += (Mn.test(o) ? "&": "?") + d.data, delete d.data), d.cache === !1 && (d.url = $n.test(o) ? o.replace($n, "$1_=" + Dn++) : o + (Mn.test(o) ? "&": "?") + "_=" + Dn++)),
            d.ifModified && (se.lastModified[o] && E.setRequestHeader("If-Modified-Since", se.lastModified[o]), se.etag[o] && E.setRequestHeader("If-None-Match", se.etag[o])),
            (d.data && d.hasContent && d.contentType !== !1 || e.contentType) && E.setRequestHeader("Content-Type", d.contentType),
            E.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Wn + "; q=0.01": "") : d.accepts["*"]);
            for (s in d.headers) E.setRequestHeader(s, d.headers[s]);
            if (d.beforeSend && (d.beforeSend.call(h, E, d) === !1 || 2 === b)) return E.abort();
            S = "abort";
            for (s in {
                success: 1,
                error: 1,
    ...
    ti = ne.ajax = !!ti,
    ti && se.ajaxTransport(function(t) {
        if (!t.crossDomain || ne.cors) {
            ...
            return {
                send: function(n, i) {
                    ...
                    e = function(n, s) {
                        var a, l, c;
                        if (e && (s || 4 === o.readyState)) if (delete Qn[r], e = void 0, o.onreadystatechange = se.noop, s) 4 !== o.readyState && o.abort();
                        else {
                            c = {},
                            a = o.status,
        ...
        if (t.crossDomain) {
            ...
            return {
                send: function(i, s) {
                    ...
                    e.src = t.url,
                    e.onload = e.onreadystatechange = function(t, n) { (n || !e.readyState || /loaded|complete/.test(e.readyState)) && (e.onload = e.onreadystatechange = null, e.parentNode && e.parentNode.removeChild(e), e = null, n || s(200, "success"))
                    },
    ...
    function(e, n, i) {
        ...
        i.always(function() {
            t[s] = o,
            e[s] && (e.jsonpCallback = n.jsonpCallback, ei.push(s)),
    ...
    se.fn.load = function(t, e, n) {
        ...
        var i, s, o, r = this,
        a = t.indexOf(" ");
        return a >= 0 && (i = se.trim(t.slice(a, t.length)), t = t.slice(0, a)),
        se.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"),
        r.length > 0 && se.ajax({
            url: t,
            type: o,
            dataType: "html",
            ...
            s = arguments,
            r.html(i ? se("<div>").append(se.parseHTML(t)).find(i) : t)
        }).complete(n &&
        function(t, e) {
    ...
    se.offset = {
        setOffset: function(t, e, n) {
            var i, s, o, r, a, l, c, u = se.css(t, "position"),
            d = se(t),
            h = {};
            ...
            o = se.css(t, "top"),
            l = se.css(t, "left"),
            c = ("absolute" === u || "fixed" === u) && se.inArray("auto", [o, l]) > -1,
            c ? (i = d.position(), r = i.top, s = i.left) : (r = parseFloat(o) || 0, s = parseFloat(l) || 0),
            se.isFunction(e) && (e = e.call(t, n, a)),
    ...
    se.fn.extend({
        offset: function(t) {
            ...
            se.contains(e, s) ? (typeof s.getBoundingClientRect !== we && (i = s.getBoundingClientRect()), n = X(o), {
    ...
    se.each(["top", "left"],
    function(t, e) {
        se.cssHooks[e] = L(ne.pixelPosition,
        function(t, n) {
    ...
    return se.noConflict = function(e) {
        return t.$ === se && (t.$ = ri),
        e && t.jQuery === se && (t.jQuery = oi),
        se
    },
    typeof e === we && (t.jQuery = t.$ = se),
    se
}),
function(t, e) {
    ...
    t.rails = n = {
            ...
            if (n.fire(i, "ajax:before")) {
                ...
                return d = {
                    ...
                    beforeSend: function(t, s) {
                        ...
                        n.fire(i, "ajax:beforeSend", [t, s]) ? void i.trigger("ajax:send", t) : !1
                    },
        ...
        handleMethod: function(i) {
            ...
            l !== e && a !== e && (u += '<input name="' + l + '" value="' + a + '" type="hidden" />'),
            r && c.attr("target", r),
...
jQuery.extend(jQuery.easing, {
    ...
    easeOutBack: function(t, e, n, i, s, o) {
        return void 0 == o && (o = 1.70158),
        i * ((e = e / s - 1) * e * ((o + 1) * e + o) + 1) + n
    },
    easeInOutBack: function(t, e, n, i, s, o) {
        return void 0 == o && (o = 1.70158),
        (e /= s / 2) < 1 ? i / 2 * e * e * (((o *= 1.525) + 1) * e - o) + n: i / 2 * ((e -= 2) * e * (((o *= 1.525) + 1) * e + o) + 2) + n
    },
...
function() {
    var t, e, n, i, s, o, r, a, l, c, u, d, h, p, f, m, g, v, y, b = [].slice,
    S = [].indexOf ||
    function(t) {
        for (var e = 0,
    ...
    e = function(t) {
        var e, n, s;
        for (t = (t + "").replace(/\D/g, ""), n = 0, s = i.length; s > n; n++) if (e = i[n], e.pattern.test(t)) return e
    },
    n = function(t) {
        var e, n, s;
        for (n = 0, s = i.length; s > n; n++) if (e = i[n], e.type === t) return e
    },
    h = function(t) {
        var e, n, i, s, o, r;
        for (i = !0, s = 0, n = (t + "").split("").reverse(), o = 0, r = n.length; r > o; o++) e = n[o],
        e = parseInt(e, 10),
        (i = !i) && (e *= 2),
        e > 9 && (e -= 9),
        s += e;
    ...
    p = function(e) {
        return setTimeout(function() {
            ...
            i = n.val(),
            i = t.payment.formatCardNumber(i),
            n.val(i)
        })
    },
    a = function(n) {
        ...
        !/^\d+$/.test(o) || (i = t(n.currentTarget), c = i.val(), s = e(c + o), r = (c.replace(/\D/g, "") + o).length, l = 16, s && (l = s.length[s.length.length - 1]), r >= l || null != i.prop("selectionStart") && i.prop("selectionStart") !== c.length) ? void 0 : (a = s && "amex" === s.type ? /^(\d{4}|\d{4}\s\d{6})$/: /(?:^|\s)(\d{4})$/, a.test(c) ? (n.preventDefault(), i.val(c + " " + o)) : a.test(c + o) ? (n.preventDefault(), i.val(c + o + " ")) : void 0)
    },
    o = function(e) {
        var n, i;
        return n = t(e.currentTarget),
        i = n.val(),
        e.meta || null != n.prop("selectionStart") && n.prop("selectionStart") !== i.length ? void 0 : 8 === e.which && /\s\d?$/.test(i) ? (e.preventDefault(), n.val(i.replace(/\s\d?$/, ""))) : void 0
    },
    l = function(e) {
        var n, i, s;
        return i = String.fromCharCode(e.which),
        /^\d+$/.test(i) ? (n = t(e.currentTarget), s = n.val() + i, /^\d$/.test(s) && "0" !== s && "1" !== s ? (e.preventDefault(), n.val("0" + s + " / ")) : /^\d\d$/.test(s) ? (e.preventDefault(), n.val("" + s + " / ")) : void 0) : void 0
    },
    c = function(e) {
        var n, i, s;
        return i = String.fromCharCode(e.which),
        /^\d+$/.test(i) ? (n = t(e.currentTarget), s = n.val(), /^\d\d$/.test(s) ? n.val("" + s + " / ") : void 0) : void 0
    },
    u = function(e) {
        var n, i, s;
        return i = String.fromCharCode(e.which),
        "/" === i ? (n = t(e.currentTarget), s = n.val(), /^\d$/.test(s) && "0" !== s ? n.val("0" + s + " / ") : void 0) : void 0
    },
    r = function(e) {
        var n, i;
    ...
    m = function(n) {
        var i, s, o, r;
        return i = t(n.currentTarget),
        o = String.fromCharCode(n.which),
        /^\d+$/.test(o) && !d(i) ? (r = (i.val() + o).replace(/\D/g, ""), s = e(r), s ? r.length <= s.length[s.length.length - 1] : r.length <= 16) : void 0
    },
    g = function(e) {
        var n, i, s;
        return n = t(e.currentTarget),
        i = String.fromCharCode(e.which),
        /^\d+$/.test(i) && !d(n) ? (s = n.val() + i, s = s.replace(/\D/g, ""), s.length > 6 ? !1 : void 0) : void 0
    },
    f = function(e) {
        var n, i, s;
        return n = t(e.currentTarget),
        i = String.fromCharCode(e.which),
        /^\d+$/.test(i) ? (s = n.val() + i, s.length <= 4) : void 0
    },
    y = function(e) {
        var n, s, o, r, a;
        return n = t(e.currentTarget),
        a = n.val(),
        r = t.payment.cardType(a) || "unknown",
        n.hasClass(r) ? void 0 : (s = function() {
            var t, e, n;
            for (n = [], t = 0, e = i.length; e > t; t++) o = i[t],
            n.push(o.type);
            return n
    ...
    t.payment.cardExpiryVal = function(t) {
        ...
        e = s[0],
        i = s[1],
        2 === (null != i ? i.length: void 0) && /^\d+$/.test(i) && (n = (new Date).getFullYear(), n = n.toString().slice(0, 2), i = n + i),
        e = parseInt(e, 10),
        i = parseInt(i, 10),
        {
            month: e,
    ...
    t.payment.validateCardNumber = function(t) {
        var n, i;
        return t = (t + "").replace(/\s+|-/g, ""),
        /^\d+$/.test(t) ? (n = e(t), n ? (i = t.length, S.call(n.length, i) >= 0 && (n.luhn === !1 || h(t))) : !1) : !1
    },
    t.payment.validateCardExpiry = function(e, n) {
        var i, s, o, r;
        return "object" == typeof e && "month" in e && (r = e, e = r.month, n = r.year),
        e && n ? (e = t.trim(e), n = t.trim(n), /^\d+$/.test(e) && /^\d+$/.test(n) && parseInt(e, 10) <= 12 ? (2 === n.length && (o = (new Date).getFullYear(), o = o.toString().slice(0, 2), n = o + n), s = new Date(n, e), i = new Date, s.setMonth(s.getMonth() - 1), s.setMonth(s.getMonth() + 1, 1), s > i) : !1) : !1
    },
    t.payment.validateCardCVC = function(e, i) {
        var s, o;
        return e = t.trim(e),
        /^\d+$/.test(e) ? i ? (s = e.length, S.call(null != (o = n(i)) ? o.cvcLength: void 0, s) >= 0) : e.length >= 3 && e.length <= 4 : !1
    },
...
function(t, e, n) { !
    function(t, e, n, i) {
        ...
        function o(e, n) {
            ...
            if (e = t.Event(e), e.type = n, o = e.originalEvent, r = t.event.props, f.search(/^(mouse|click)/) > -1 && (r = I), o) for (d = r.length, l; d;) l = r[--d],
            e[l] = o[l];
            if (f.search(/mouse(down|up)|click/) > -1 && !e.which && (e.which = 1), -1 !== f.search(/^touch/) && (a = s(o), f = a.touches, c = a.changedTouches, u = f && f.length ? f[0] : c && c.length ? c[0] : i)) for (h = 0, p = x.length; p > h; h++) l = x[h],
            e[l] = u[l];
            return e
        }
        function r(e) {
        ...
        function f(e, n, i) {
            var s;
            return (i && i[e] || !i && a(n.target, e)) && (s = o(n, e), t(n.target).trigger(s)),
            s
        }
        function m(e) {
        ...
        function y(e) {
            if (!j) {
                ...
                a = r(e.target);
                O = O || Math.abs(n.pageX - R) > o || Math.abs(n.pageY - N) > o,
                O && !i && f("vmousecancel", e, a),
                f("vmousemove", e, a),
                h()
            }
        }
        function b(t) {
            if (!j) {
                ...
                f("vmouseup", t, i),
                O || (e = f("vclick", t, i), e && e.isDefaultPrevented() && (n = s(t).changedTouches[0], P.push({
                    touchID: F,
                    x: n.clientX,
                    y: n.clientY
                }), $ = !0)),
        ...
        function T(e) {
            ...
            return {
                setup: function() {
                    ...
                    1 === D[e] && H.bind(n, m),
                    t(this).bind(n, E),
                    U && (D.touchstart = (D.touchstart || 0) + 1, 1 === D.touchstart && H.bind("touchstart", g).bind("touchend", b).bind("touchmove", y).bind("scroll", v))
                },
                teardown: function() {--D[e],
                    D[e] || H.unbind(n, m),
                    U && (--D.touchstart, D.touchstart || H.unbind("touchstart", g).unbind("touchmove", y).unbind("touchend", b).unbind("scroll", v));
                    var i = t(this),
                    s = t.data(this, k);
                    s && (s[e] = !1),
                    i.unbind(n, E),
                    S(this) || i.removeData(k)
                }
            }
        }
        ...
        U && n.addEventListener("click",
        function(e) {
            var n, i, s, o, r, a, l = P.length,
            c = e.target;
            if (l) for (n = e.clientX, i = e.clientY, w = t.vmouse.clickDistanceThreshold, s = c; s;) {
                for (o = 0; l > o; o++) if (r = P[o], a = 0, s === c && Math.abs(r.x - n) < w && Math.abs(r.y - i) < w || t.data(s, L) === r.touchID) return e.preventDefault(),
...
function() {
    ...
    Class.extend = function(n) {
        ...
        var o = new this;
        t = !1;
        for (var r in n) o[r] = "function" == typeof n[r] && "function" == typeof s[r] && e.test(n[r]) ?
        function(t, e) {
            return function() {
                var n = this._super;
                this._super = s[t];
...
function(t) {
        ...
        Function.prototype.bind = function() {
            function t() {
                if (this instanceof t) {
                    ...
                    return n.apply(s, i.concat(e.call(arguments))),
                    s
                }
            ...
            return t.length = "function" == typeof n ? Math.max(n.length - i.length, 0) : 0,
            t
        }
    }
    var n, i, s, o, r, a = Function.prototype.call,
    l = Object.prototype,
    c = a.bind(l.hasOwnProperty); (r = c(l, "__defineGetter__")) && (n = a.bind(l.__defineGetter__), i = a.bind(l.__defineSetter__), s = a.bind(l.__lookupGetter__), o = a.bind(l.__lookupSetter__)),
    Array.isArray || (Array.isArray = function(t) {
        return "[object Array]" === Object.prototype.toString.call(t)
    }),
    Array.prototype.forEach || (Array.prototype.forEach = function(t, e) {
        for (var n = +this.length,
        i = 0; n > i; i++) i in this && t.call(e, this[i], i, this)
    }),
    ...
    Array.prototype.every || (Array.prototype.every = function(t, e) {
        for (var n = 0; n < this.length; n++) if (!t.call(e, this[n])) return ! 1;
        return ! 0
    }),
    Array.prototype.some || (Array.prototype.some = function(t, e) {
        for (var n = 0; n < this.length; n++) if (t.call(e, this[n])) return ! 0;
        return ! 1
    }),
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function(t, e) {
        ...
        var i = e || 0;
        if (i >= n) return - 1;
        for (0 > i && (i += n); n > i; i++) if (i in this && t === this[i]) return i;
        return - 1
    }),
    Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function(t, e) {
        ...
        if (!n) return - 1;
        var i = e || n;
        for (0 > i && (i += n), i = Math.min(i, n - 1); i >= 0; i--) if (i in this && t === this[i]) return i;
        return - 1
    }),
    ...
    Object.getOwnPropertyDescriptor || (Object.getOwnPropertyDescriptor = function(e, n) {
        ...
        r) {
            var d = e.__proto__;
            if (e.__proto__ = l, a = s(e, n), u = o(e, n), e.__proto__ = d, a || u) return a && (i.get = a),
            u && (i.set = u),
            i
        }
        return i.value = e[n],
    ...
    Object.create || (Object.create = function(t, e) {
        ...
        return "undefined" != typeof e && Object.defineProperties(n, e),
        n
    }),
    Object.defineProperty || (Object.defineProperty = function(t, e, a) {
        ...
        if ("object" != typeof a || null === a) throw new TypeError("Property description must be an object: " + a);
        if (c(a, "value")) r && (s(t, e) || o(t, e)) && (t.__proto__ = l, delete t[e]),
        t[e] = a.value;
        else {
            if (!r) throw new TypeError("getters & setters can not be defined on this javascript engine");
            c(a, "get") && n(t, e, a.get),
            c(a, "set") && i(t, e, a.set)
        }
        return t
    ...
    if (Date.prototype.toISOString || (Date.prototype.toISOString = function() {
        ...
        i.parse = function(n) {
            ...
            if (i) {
                i.shift();
                for (var o = i[0] === t, r = 0; 10 > r; r++) 7 !== r && (i[r] = +(i[r] || (3 > r ? 1 : 0)), 1 === r && i[r]--);
...
function(t) {
    ...
    s.defineProperty) {
        ...
        } catch(p) { - 2146823252 === p.number && (h.enumerable = !1, s.defineProperty(i, e, h))
        }
    } else s[n].__defineGetter__ && i.__defineGetter__(e, d)
} (self),
function(t) {
    function e() {
        p || (p = !0, l(m,
    ...
    function n(e, n) {
        ...
        i.onreadystatechange = i.onload = function() {
            var t = i.readyState; ! n.done && (!t || /loaded|complete/.test(t)) && (n.done = !0, n())
        },
    ...
    function s(t) {
        void 0 === t.state && (t.state = w, t.onpreload = [], n({
            src: t.url,
            type: "cache"
        },
        function() {
    ...
    function c(t) {
        var e;
        if ("object" == typeof t) for (var n in t) t[n] && (e = {
            name: n,
            url: t[n]
        });
        else e = {
    ...
    function() {
        ...
        l(t,
        function(s, o) {
            s != e && (s = c(s), n[s.name] = s, i(s, e && o == t.length - 2 ?
            function() {
                r(n) && d(e)
            }: null))
        }),
    ...
    E.ready = function(e, n) {
        if (e == t) return p ? d(n) : m.push(n),
        E;
        if (a(e) && (n = e, e = "ALL"), "string" != typeof e || !a(n)) return E;
        var i = y[e];
        if (i && i.state == k || "ALL" == e && r() && p) return d(n),
        E;
        var s = v[e];
        return s ? s.push(n) : s = v[e] = [n],
        E
    },
    E.ready(t,
    function() {
    ...
    }), window.addEventListener) t.addEventListener("DOMContentLoaded", e, !1),
    window.addEventListener("load", e, !1);
        ...
        t.removeEventListener("DOMContentLoaded", handler, !1),
...
function(t) {
    ...
    e.prototype = {
        ...
        execute: function(t) {
            var e;
            return this.active && (e = this._listener.apply(this.context, t), this._isOnce && this.detach()),
            e
        },
        detach: function() {
    ...
    n.Signal.prototype = {
        ...
        _registerListener: function(t, n, i, s) {
            ...
            if ( - 1 !== r) {
                if (o = this._bindings[r], o.isOnce() !== n) throw new Error("You cannot add" + (n ? "": "Once") + "() then add" + (n ? "Once": "") + "() the same listener without removing the relationship first.")
            } else o = new e(this, t, n, i, s),
            this._addBinding(o);
            return o
        },
...
function() {
    ...
    function str(t, e) {
        ...
        case "object":
            ...
            if (rep && "object" == typeof rep) for (o = rep.length, n = 0; o > n; n += 1)"string" == typeof rep[n] && (i = rep[n], s = str(i, l), s && r.push(quote(i) + (gap ? ": ": ":") + s));
            else for (i in l) Object.prototype.hasOwnProperty.call(l, i) && (s = str(i, l), s && r.push(quote(i) + (gap ? ": ": ":") + s));
            return s = 0 === r.length ? "{}": gap ? "{\n" + gap + r.join(",\n" + gap) + "\n" + a + "}": "{" + r.join(",") + "}",
            gap = a,
            s
        }
...
function(t) {
    ...
    function o(t) {
        ...
        this._input = t,
        this._milliseconds = +l + 1e3 * a + 6e4 * r + 36e5 * o,
        this._days = +s + 7 * i,
        this._months = +n + 12 * e,
        this._data = {},
        this._bubble()
    ...
    function c(t, e, n, i) {
        var s, o, r = e._milliseconds,
        a = e._days,
        l = e._months;
        r && t._d.setTime( + t._d + r * n),
        (a || l) && (s = t.minute(), o = t.hour()),
        a && t.date(t.date() + a * n),
        l && t.month(t.month() + l * n),
        r && !i && $.updateOffset(t),
        (a || l) && (t.minute(s), t.hour(o))
    }
    function u(t) {
        return "[object Array]" === Object.prototype.toString.call(t)
    }
    ...
    function b(t, e) {
        ...
        for (var i = 5; i--&&(Y.lastIndex = 0, Y.test(t));) t = t.replace(Y, n);
        return t
    }
    function S(t, e) {
        switch (t) {
    ...
    function L(t) {
        var e, n, i, s = m(t._l),
        o = "" + t._i;
        for (i = b(t._f, s).match(W), t._a = [], e = 0; e < i.length; e++) n = (S(i[e], t).exec(o) || [])[0],
        n && (o = o.slice(o.indexOf(n) + n.length)),
        he[i[e]] && T(i[e], n, t);
        o && (t._il = o),
    ...
    function C(t) {
        var e, n, i, o, a, l = 99;
        for (o = 0; o < t._f.length; o++) e = r({},
        t),
        e._f = t._f[o],
        L(e),
        n = new s(e),
        a = d(e._a, n.toArray()),
        n._il && (a += n._il.length),
        l > a && (l = a, i = n);
        r(t, i)
    }
    function x(t) {
    ...
    function D(t, e, n) {
        var i = H(Math.abs(t) / 1e3),
        s = H(i / 60),
        o = H(s / 60),
        r = H(o / 24),
        a = H(r / 365),
        l = 45 > i && ["s", i] || 1 === s && ["m"] || 45 > s && ["mm", s] || 1 === o && ["h"] || 22 > o && ["hh", o] || 1 === r && ["d"] || 25 >= r && ["dd", r] || 45 >= r && ["M"] || 345 > r && ["MM", H(r / 30)] || 1 === a && ["y"] || ["yy", a];
        return l[2] = e,
        l[3] = t > 0,
        l[4] = n,
        I.apply({},
    ...
    function R(t) {
        var e = t._i,
        n = t._f;
        return null === e || "" === e ? null: ("string" == typeof e && (t._i = e = m().preparse(e)), $.isMoment(e) ? (t = r({},
        e), t._d = new Date( + e._d)) : n ? u(n) ? C(t) : L(t) : A(t), new s(t))
    }
    function N(t, e) {
    ...
    z = /^\/?Date\((\-?\d+)/i,
    V = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)\:(\d+)\.?(\d{3})?/,
    W = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g,
    Y = /(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g,
    X = /\d\d?/,
    q = /\d{1,3}/,
    G = /\d{3}/,
    ...
    te = /T/i,
    ee = /[\+\-]?\d+(\.\d{1,3})?/,
    ne = /^\s*\d{4}-\d\d-\d\d((T| )(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/,
    ie = "YYYY-MM-DDTHH:mm:ssZ",
    se = [["HH:mm:ss.S", /(T| )\d\d:\d\d:\d\d\.\d{1,3}/], ["HH:mm:ss", /(T| )\d\d:\d\d:\d\d/], ["HH:mm", /(T| )\d\d:\d\d/], ["HH", /(T| )\d\d/]], oe = /([\+\-]|\d\d)/gi, re = "Date|Hours|Minutes|Seconds|Milliseconds".split("|"), ae = {
        Milliseconds: 1,
        Seconds: 1e3,
        Minutes: 6e4,
        Hours: 36e5,
    ...
    ce = {},
    ue = "DDD w W M D d".split(" "), de = "M D H h m s w W".split(" "), he = {
        M: function() {
            return this.month() + 1
        },
        MMM: function(t) {
    ...
    he[j + "o"] = n(he[j], j);
    for (; de.length;) j = de.pop(),
    he[j + j] = e(he[j], 2);
    for (he.DDDD = e(he.DDD, 3), r(i.prototype, {
        set: function(t) {
            var e, n;
            for (n in t) e = t[n],
        ...
        monthsParse: function(t) {
            var e, n, i;
            for (this._monthsParse || (this._monthsParse = []), e = 0; 12 > e; e++) if (this._monthsParse[e] || (n = $.utc([2e3, e]), i = "^" + this.months(n, "") + "|^" + this.monthsShort(n, ""), this._monthsParse[e] = new RegExp(i.replace(".", ""), "i")), this._monthsParse[e].test(t)) return e
        },
        ...
        weekdaysParse: function(t) {
            var e, n, i;
            for (this._weekdaysParse || (this._weekdaysParse = []), e = 0; 7 > e; e++) if (this._weekdaysParse[e] || (n = $([2e3, 1]).day(e), i = "^" + this.weekdays(n, "") + "|^" + this.weekdaysShort(n, "") + "|^" + this.weekdaysMin(n, ""), this._weekdaysParse[e] = new RegExp(i.replace(".", ""), "i")), this._weekdaysParse[e].test(t)) return e
        },
        _longDateFormat: {
            LT: "h:mm A",
            L: "MM/DD/YYYY",
    ...
    $.duration = function(t, e) {
        ...
        a = s ? t._input: r ? {}: t,
        l = V.exec(t);
        return r ? e ? a[e] = t: a.milliseconds = t: l && (n = "-" === l[1] ? -1 : 1, a = {
            y: 0,
            d: ~~l[2] * n,
            h: ~~l[3] * n,
            m: ~~l[4] * n,
        ...
        i = new o(a),
        s && t.hasOwnProperty("_lang") && (i._lang = t._lang),
        i
    },
    ...
    r($.fn = s.prototype, {
        ...
        add: function(t, e) {
            var n;
            return n = "string" == typeof t ? $.duration( + e, t) : $.duration(t, e),
            c(this, n, 1),
            this
        },
        ...
        diff: function(t, e, n) {
            ...
            return e = h(e),
            "year" === e || "month" === e ? (i = 432e5 * (this.daysInMonth() + o.daysInMonth()), s = 12 * (this.year() - o.year()) + (this.month() - o.month()), s += (this - $(this).startOf("month") - (o - $(o).startOf("month"))) / i, s -= 6e4 * (this.zone() - $(this).startOf("month").zone() - (o.zone() - $(o).startOf("month").zone())) / i, "year" === e && (s /= 12)) : (i = this - o, s = "second" === e ? i / 1e3: "minute" === e ? i / 6e4: "hour" === e ? i / 36e5: "day" === e ? (i - r) / 864e5: "week" === e ? (i - r) / 6048e5: i),
            n ? s: a(s)
        },
        from: function(t, e) {
    ...
    }), j = 0; j < re.length; j++) N(re[j].toLowerCase().replace(/s$/, ""), re[j]);
    N("year", "FullYear"),
    $.fn.days = $.fn.day,
    $.fn.months = $.fn.month,
    $.fn.weeks = $.fn.week,
    ...
    for (j in ae) ae.hasOwnProperty(j) && (P(j, ae[j]), O(j.toLowerCase()));
    P("Weeks", 6048e5),
...
function() {
    ...
    function n(t, e, n, i) {
        ...
        l = a && "-" + a + "-" || "";
        return d[s] || (h.insertRule("@" + l + "keyframes " + s + "{0%{opacity:" + r + "}" + o + "%{opacity:" + t + "}" + (o + .01) + "%{opacity:1}" + (o + e) % 100 + "%{opacity:" + t + "}100%{opacity:" + r + "}}", h.cssRules.length), d[s] = 1),
        s
    }
    function i(t, e) {
        var n, i, s = t.style;
        if (void 0 !== s[e]) return e;
        for (e = e.charAt(0).toUpperCase() + e.slice(1), i = 0; i < u.length; i++) if (n = u[i] + e, void 0 !== s[n]) return n
    }
    function s(t, e) {
    ...
    function a(t) {
        return "undefined" == typeof this ? new a(t) : void(this.opts = o(t || {},
        a.defaults, p))
    }
    function l() {
        function n(e, n) {
        ...
        a.prototype.lines = function(t, i) {
            ...
            if (i.shadow) for (a = 1; a <= i.lines; a++) r(a, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
            for (a = 1; a <= i.lines; a++) r(a);
            return e(t, d)
        },
        a.prototype.opacity = function(t, e, n, i) {
            var s = t.firstChild;
            i = i.shadow && i.lines || 0,
            s && e + i < s.childNodes.length && (s = s.childNodes[e + i], s = s && s.firstChild, s = s && s.firstChild, s && (s.opacity = n))
        }
    }
    ...
    o(a.prototype, {
        spin: function(e) {
            ...
            if (e && (e.insertBefore(l, e.firstChild || null), i = r(e), n = r(l), s(l, {
                left: ("auto" == a.left ? i.x - n.x + (e.offsetWidth >> 1) : parseInt(a.left, 10) + u) + "px",
                top: ("auto" == a.top ? i.y - n.y + (e.offsetHeight >> 1) : parseInt(a.top, 10) + u) + "px"
                ...
                function y() {
                    h++;
                    for (var t = 0; t < a.lines; t++) d = Math.max(1 - (h + (a.lines - t) * v) % m * g, a.opacity),
                    o.opacity(l, t * a.direction + p, d, a);
        ...
        lines: function(i, o) {
            ...
            for (var a, l = 0,
            u = (o.lines - 1) * (1 - o.direction) / 2; l < o.lines; l++) a = s(t(), {
                position: "absolute",
                top: 1 + ~ (o.width / 2) + "px",
                transform: o.hwaccel ? "translate3d(0,0,0)": "",
                opacity: o.opacity,
                animation: c && n(o.opacity, o.trail, u + l * o.direction, o.lines) + " " + 1 / o.speed + "s linear infinite"
            }),
            o.shadow && e(a, s(r("#000", "0 0 4px #000"), {
                top: "2px"
            })),
            e(i, e(a, r(o.color, "0 0 1px rgba(0,0,0,.1)")));
            return i
        },
    ...
    return ! i(f, "transform") && f.adj ? l() : c = i(f, "animation"),
    a
}),
function(t, e) {
...
function(t) {
    ...
    function n(t, n) {
        ...
        function() {
            ...
            if ("function" == typeof t.addEventListener) {
                ...
                function() {
                    o.startAfter(1),
                    "number" == typeof n.timeout && (clearTimeout(r), r = setTimeout(o.stop, n.timeout)),
                    "function" == typeof n.callback && n.callback.apply(null, [o])
                },
                !1)
            }
        } ()
    ...
    function i() {
        for (var t = 0,
        e = r.length; e > t; t++) r[t].stop()
    }
    function s(e) {
        var n, i = e.offsetHeight;
        i > 32 && (i *= .8),
        e.hasAttribute("data-spinner-size") && (i = parseInt(e.getAttribute("data-spinner-size"), 10)),
...
function(t, e) {
    ...
    function r(t, e, n, i, o, r) {
        ...
        u = n.type;
        if (!x[t]) return [];
        for ("keyup" == u && p(t) && (e = [t]), a = 0; a < x[t].length; ++a) if (l = x[t][a], (i || !l.seq || I[l.seq] == l.level) && u == l.action && ("keypress" == u && !n.metaKey && !n.ctrlKey || s(e, l.modifiers))) {
            var d = !i && l.combo == o,
            h = i && l.seq == i && l.level == r; (d || h) && x[t].splice(a, 1),
            c.push(l)
        }
        return c
    }
    ...
    function d(t, e, n) {
        ...
        for (i = 0; i < s.length; ++i) if (s[i].seq) {
            ...
            c = !0,
            a[s[i].seq] = 1,
            u(s[i].callback, n, s[i].combo, s[i].seq)
        } else c || u(s[i].callback, n, s[i].combo);
    ...
    function h(t) {
        ...
        var e = i(t);
        if (e) return "keyup" == t.type && D === e ? void(D = !1) : void O.handleKey(e, a(t), t)
    }
    function p(t) {
    ...
    function g(t, e, n) {
        return n || (n = m()[t] ? "keydown": "keypress"),
    ...
    function b(t, e) {
        var n, i, s, o = [];
        for (n = y(t), s = 0; s < n.length; ++s) i = n[s],
        C[i] && (i = C[i]),
        e && "keypress" != e && L[i] && (i = L[i], o.push("shift")),
        p(i) && o.push(i);
        return e = g(i, o, e),
        {
            key: i,
    ...
    function S(t, e, n, i, s) {
        ...
        t = t.replace(/\s+/g, " ");
        var o, a = t.split(" ");
        return a.length > 1 ? void v(t, a, e, n) : (o = b(t, n), x[o.key] = x[o.key] || [], r(o.key, o.modifiers, {
            type: o.action
        },
        i, t, s), void x[o.key][i ? "unshift": "push"]({
            callback: e,
    ...
    A = {},
    I = {},
    D = !1, M = !1, R = !1, N = 1; 20 > N; ++N) _[111 + N] = "f" + N;
    for (N = 0; 9 >= N; ++N) _[N + 96] = N;
    n(e, "keypress", h),
    n(e, "keydown", h),
    n(e, "keyup", h);
    var O = {
...
function(t, e, n, i) {
    ...
    function r(t, e, n) {
        ...
        else if (t.length !== i) for (s = 0; s < t.length;) e.call(n, t[s], s, t),
        s++;
        else for (s in t) t.hasOwnProperty(s) && e.call(n, t[s], s, t)
    }
    function a(t, e, n) {
        for (var s = Object.keys(e), o = 0; o < s.length;)(!n || n && t[s[o]] === i) && (t[s[o]] = e[s[o]]),
        o++;
        return t
    }
    function l(t, e) {
    ...
    function E(t, e) {
        for (var n, s, o = e[0].toUpperCase() + e.slice(1), r = 0; r < le.length;) {
            if (n = le[r], s = n ? n + o: e, s in t) return s;
            r++
        }
        return i
    }
    ...
    function C(t, e) {
        ...
        s > 1 && !n.firstMultiple ? n.firstMultiple = I(e) : 1 === s && (n.firstMultiple = !1);
        var o = n.firstInput,
        r = n.firstMultiple,
        ...
        e.scale = r ? $(r.pointers, i) : 1,
        e.rotation = r ? P(r.pointers, i) : 0,
        A(n, e);
        var c = t.element;
    ...
    function x(t, e) {
        ...
        i = t.offsetDelta || {},
        s = t.prevDelta || {},
        o = t.prevInput || {}; (e.eventType === _e || o.eventType === Le) && (s = t.prevDelta = {
            x: o.deltaX || 0,
            y: o.deltaY || 0
        },
        i = t.offsetDelta = {
    ...
    function B(t, e) {
        ...
        return e & (Le | Ce) && (n = S(n.concat(i), "identifier", !0)),
        [n, i]
    }
    function F() {
        this.evTarget = Ge,
    ...
    function z(t, e) {
        var n = b(t.touches),
        i = this.targetIds;
        if (e & (_e | ke) && 1 === n.length) return i[n[0].identifier] = !0,
        [n, n];
        var s, o, r = b(t.changedTouches),
        a = [],
        l = this.target;
        if (o = n.filter(function(t) {
            return m(t.target, l)
        }), e === _e) for (s = 0; s < o.length;) i[o[s].identifier] = !0,
        s++;
        for (s = 0; s < r.length;) i[r[s].identifier] && a.push(r[s]),
        e & (Le | Ce) && delete i[r[s].identifier],
        s++;
    ...
    function se(t, e) {
        return e = e || {},
        e.recognizers = h(e.recognizers, se.defaults.preset),
        new oe(t, e)
    }
    function oe(t, e) {
        e = e || {},
    ...
    c(j, _, {
        handler: function(t) {
            var e = je[t.type];
            e & _e && 0 === t.button && (this.pressed = !0),
            e & ke && 1 !== t.which && (e = Le),
            this.pressed && this.allow && (e & Le && (this.pressed = !1), this.callback(this.manager, e, {
                pointers: [t],
                changedPointers: [t],
                pointerType: Ee,
                srcEvent: t
    ...
    c(U, _, {
        handler: function(t) {
            ...
            s = Be[i],
            o = Fe[t.pointerType] || t.pointerType,
            r = o == be,
            a = y(e, t.pointerId, "pointerId");
            s & _e && (0 === t.button || r) ? 0 > a && (e.push(t), a = e.length - 1) : s & (Le | Ce) && (n = !0),
    ...
    c(H, _, {
        handler: function(t) {
            ...
            if (e === _e && (this.started = !0), this.started) {
                ...
                e & (Le | Ce) && n[0].length - n[1].length === 0 && (this.started = !1),
    ...
    W.prototype = {
        ...
        compute: function() {
            var t = [];
            return r(this.manager.recognizers,
            function(e) {
    ...
    X.prototype = {
        ...
        canEmit: function() {
            for (var t = 0; t < this.requireFail.length;) {
                if (! (this.requireFail[t].state & (dn | on))) return ! 1;
                t++
            }
            return ! 0
        },
    ...
    c(Z, K, {
        ...
        directionTest: function(t) {
            ...
            o = t.deltaX,
            r = t.deltaY;
            return s & e.direction || (e.direction & Re ? (s = 0 === o ? xe: 0 > o ? Ae: Ie, n = o != this.pX, i = Math.abs(t.deltaX)) : (s = 0 === r ? xe: 0 > r ? De: Me, n = r != this.pY, i = Math.abs(t.deltaY))),
            t.direction = s,
    ...
    c(ne, K, {
        ...
        attrTest: function(t) {
            ...
            return n & (Re | Ne) ? e = t.velocity: n & Re ? e = t.velocityX: n & Ne && (e = t.velocityY),
            this._super.attrTest.call(this, t) && n & t.direction && t.distance > this.options.threshold && he(e) > this.options.velocity && t.eventType & Le
        },
        emit: function(t) {
            var e = G(t.direction);
            e && this.manager.emit(this.options.event + e, t),
    ...
    oe.prototype = {
        ...
        recognize: function(t) {
            ...
            if (!e.stopped) {
                ...
                s = e.curRecognizer; (!s || s && s.state & cn) && (s = e.curRecognizer = null);
                for (var o = 0; o < i.length;) n = i[o],
                e.stopped === pn || s && n != s && !n.canRecognizeWith(s) ? n.reset() : n.recognize(t),
                !s && n.state & (rn | an | ln) && (s = e.curRecognizer = n),
                o++
            }
        },
        get: function(t) {
...
function() {
    if (function(t, e) {
        ...
        n.j = [],
        n.sockets = {},
        n.connect = function(t, i) {
            var s, o, r = n.util.parseUri(t);
            e && e.location && (r.protocol = r.protocol || e.location.protocol.slice(0, -1), r.host = r.host || (e.document ? e.document.domain: e.location.hostname), r.port = r.port || e.location.port),
            s = n.util.uniqueUri(r);
            var a = {
                host: r.host,
    ...
    function(t, e) {
        ...
        n.uniqueUri = function(t) {
            ...
            i = t.host,
            s = t.port;
            return "document" in e ? (i = i || document.domain, s = s || ("https" == n && "https:" !== document.location.protocol ? 443 : document.location.port)) : (i = i || "localhost", !s && "https" == n && (s = 443)),
            (n || "http") + "://" + i + ":" + (s || 80)
        },
        ...
        n.chunkQuery = function(t) {
            for (var e, n = {},
            i = t.split("&"), s = 0, o = i.length; o > s; ++s) e = i[s].split("="),
            e[0] && (n[e[0]] = e[1]);
            return n
        };
        var o = !1;
        ...
        n.merge = function(t, e, i, s) {
            ...
            for (o in e) e.hasOwnProperty(o) && n.indexOf(r, o) < 0 && ("object" == typeof t[o] && a ? n.merge(t[o], e[o], a - 1, r) : (t[o] = e[o], r.push(e[o])));
            return t
        },
        ...
        n.intersect = function(t, e) {
            for (var i = [], s = t.length > e.length ? t: e, o = t.length > e.length ? e: t, r = 0, a = o.length; a > r; r++)~n.indexOf(s, o[r]) && i.push(o[r]);
            return i
        },
        n.indexOf = function(t, e, n) {
            for (var i = t.length,
            n = 0 > n ? 0 > n + i ? 0 : n + i: n || 0; i > n && t[n] !== e; n++);
            return n >= i ? -1 : n
        },
    ...
    function(t, e) {
        ...
        n.prototype.on = function(t, n) {
            ...
            this.$events[t] ? e.util.isArray(this.$events[t]) ? this.$events[t].push(n) : this.$events[t] = [this.$events[t], n] : this.$events[t] = n,
            this
        },
        ...
        n.prototype.removeListener = function(t, n) {
            if (this.$events && this.$events[t]) {
                ...
                if (e.util.isArray(i)) {
                    for (var s = -1,
                    o = 0,
                    r = i.length; r > o; o++) if (i[o] === n || i[o].listener && i[o].listener === n) {
                        s = o;
                        break
                    }
                    if (0 > s) return this;
                    i.splice(s, 1),
                    i.length || delete this.$events[t]
                } else(i === n || i.listener && i.listener === n) && delete this.$events[t]
            }
            return this
        },
        n.prototype.removeAllListeners = function(t) {
            return void 0 === t ? (this.$events = {},
            this) : (this.$events && this.$events[t] && (this.$events[t] = null), this)
        },
        n.prototype.listeners = function(t) {
            return this.$events || (this.$events = {}),
            this.$events[t] || (this.$events[t] = []),
            e.util.isArray(this.$events[t]) || (this.$events[t] = [this.$events[t]]),
            this.$events[t]
        },
        n.prototype.emit = function(t) {
            ...
            if ("function" == typeof n) n.apply(this, i);
                ...
                for (var s = n.slice(), o = 0, r = s.length; r > o; o++) s[o].apply(this, i)
            }
            return ! 0
        }
    ...
    function(t, e) {
        ...
        n.encodePacket = function(t) {
            ...
            switch (t.type) {
            case "error":
                var d = t.reason ? a(s, t.reason) : "",
                h = t.advice ? a(o, t.advice) : ""; ("" !== d || "" !== h) && (u = d + ("" !== h ? "+" + h: ""));
                break;
            case "message":
                "" !== t.data && (u = t.data);
                break;
            case "event":
                ...
                t.args && t.args.length && (p.args = t.args),
                u = r.stringify(p);
                break;
            case "json":
    ...
    function(t, e) {
        ...
        n.prototype.onData = function(t) {
            if (this.clearCloseTimeout(), (this.socket.connected || this.socket.connecting || this.socket.reconnecting) && this.setCloseTimeout(), "" !== t) {
                ...
                if (n && n.length) for (var i = 0,
                s = n.length; s > i; i++) this.onPacket(n[i])
            }
            return this
        },
        n.prototype.onPacket = function(t) {
            return this.socket.setHeartbeatTimeout(),
            "heartbeat" == t.type ? this.onHeartbeat() : ("connect" == t.type && "" == t.endpoint && this.onConnect(), "error" == t.type && "reconnect" == t.advice && (this.isOpen = !1), this.socket.onPacket(t), this)
        },
    ...
    function(t, e, n) {
        function i(t) {
            ...
            e.util.merge(this.options, t), this.connected = !1, this.open = !1, this.connecting = !1, this.reconnecting = !1, this.namespaces = {},
            this.buffer = [], this.doBuffer = !1, this.options["sync disconnect on unload"] && (!this.isXDomain() || e.util.ua.hasCORS)) {
                var i = this;
                e.util.on(n, "beforeunload",
                function() {
                    i.disconnectSync()
                },
                !1)
        ...
        i.prototype.handshake = function(t) {
            ...
            var i = this,
            o = this.options,
            r = ["http" + (o.secure ? "s": "") + ":/", o.host + ":" + o.port, o.resource, e.protocol, e.util.query(this.options.query, "t=" + +new Date)].join("/");
            if (this.isXDomain() && !e.util.ua.hasCORS) {
                var a = document.getElementsByTagName("script")[0],
                l = document.createElement("script");
                l.src = r + "&jsonp=" + e.j.length,
                ...
                c.open("GET", r, !0),
                this.isXDomain() && (c.withCredentials = !0),
        ...
        i.prototype.getTransport = function(t) {
            for (var n, i = t || this.transports,
            s = 0; n = i[s]; s++) if (e.Transport[n] && e.Transport[n].check(this) && (!this.isXDomain() || e.Transport[n].xdomainCheck(this))) return new e.Transport[n](this, this.sessionid);
            return null
        },
        i.prototype.connect = function(t) {
            ...
            this.handshake(function(i, s, o, r) {
                function a(t) {
                    return n.transport && n.transport.clearTimeouts(),
                    n.transport = n.getTransport(t),
                    n.transport ? void n.transport.ready(n,
                    function() {
                        n.connecting = !0,
                ...
                n.transports || (n.transports = n.origTransports = r ? e.util.intersect(r.split(","), n.options.transports) : n.options.transports),
        ...
        i.prototype.setBuffer = function(t) {
            this.doBuffer = t,
            !t && this.connected && this.buffer.length && (this.options.manualFlush || this.flushBuffer())
        },
        ...
        i.prototype.onError = function(t) {
            t && t.advice && "reconnect" === t.advice && (this.connected || this.connecting) && (this.disconnect(), this.options.reconnect && this.reconnect()),
        ...
        i.prototype.onDisconnect = function(t) {
            ...
            this.connecting = !1,
            this.open = !1,
            (e || n) && (this.transport.close(), this.transport.clearTimeouts(), e && (this.publish("disconnect", t), "booted" != t && this.options.reconnect && !this.reconnecting && this.reconnect()))
        },
        i.prototype.reconnect = function() {
            function t() {
                ...
                n.removeListener("connect_failed", e),
            ...
            this.reconnectionTimer = setTimeout(e, this.reconnectionDelay),
            this.on("connect", e)
        }
    ...
    function(t, e) {
        ...
        t.SocketNamespace = n,
        e.util.mixin(n, e.EventEmitter),
        n.prototype.$emit = e.EventEmitter.prototype.emit,
        n.prototype.of = function() {
            return this.socket.of.apply(this.socket, arguments)
        },
        n.prototype.packet = function(t) {
            return t.endpoint = this.name,
        ...
        n.prototype.emit = function(t) {
            ...
            return "function" == typeof n && (i.id = ++this.ackPackets, i.ack = "data", this.acks[i.id] = n, e = e.slice(0, e.length - 1)),
            i.args = e,
            this.packet(i)
        },
    ...
    function(t, e, n) {
        ...
        t.websocket = i,
        e.util.inherit(i, e.Transport),
        i.prototype.name = "websocket",
        i.prototype.open = function() {
            var t, i = e.util.query(this.socket.options.query),
            s = this;
            return t || (t = n.MozWebSocket || n.WebSocket),
            this.websocket = new t(this.prepareUrl() + i),
        ...
        i.prototype.send = e.util.ua.iDevice ?
        function(t) {
            var e = this;
            return setTimeout(function() {
                e.websocket.send(t)
            ...
            return this.websocket.send(t),
            this
        },
        i.prototype.payload = function(t) {
            for (var e = 0,
            n = t.length; n > e; e++) this.packet(t[e]);
            return this
        },
    ...
    function(t, e) {
        ...
        t.flashsocket = n,
        e.util.inherit(n, e.Transport.websocket),
        ...
        n.prototype.ready = function(t, i) {
            function s() {
                ...
                r = ["http" + (e.secure ? "s": "") + ":/", e.host + ":" + e.port, e.resource, "static/flashsocket", "WebSocketMain" + (t.isXDomain() ? "Insecure": "") + ".swf"];
                n.loaded || ("undefined" == typeof WEB_SOCKET_SWF_LOCATION && (WEB_SOCKET_SWF_LOCATION = r.join("/")), 843 !== s && WebSocket.loadFlashPolicyFile("xmlsocket://" + e.host + ":" + s), WebSocket.__initialize(), n.loaded = !0),
                i.call(o)
            }
            var o = this;
        ...
        function n(t) {
            if (typeof O.addEventListener != x) O.addEventListener("load", t, !1);
            else if (typeof P.addEventListener != x) P.addEventListener("load", t, !1);
            else if (typeof O.attachEvent != x) v(O, "onload", t);
        ...
        function o() {
            ...
            if (t > 0) for (var e = 0; t > e; e++) {
                ...
                if (Y.pv[0] > 0) {
                    var o = m(n);
                    if (o) if (!y(H[e].swfVersion) || Y.wk && Y.wk < 312) if (H[e].expressInstall && a()) {
                        var u = {};
                        ...
                        for (var d = {},
                        h = o.getElementsByTagName("param"), p = h.length, f = 0; p > f; f++)"movie" != h[f].getAttribute("name").toLowerCase() && (d[h[f].getAttribute("name")] = h[f].getAttribute("value"));
                        l(u, d, n, i)
                    } else c(o),
                    i && i(s);
                    else S(n, !0),
                    i && (s.success = !0, s.ref = r(n), i(s))
                } else if (S(n, !0), i) {
                    var g = r(n);
                    g && typeof g.SetVariable != x && (s.success = !0, s.ref = g),
                    i(s)
                }
            }
        }
        function r(t) {
            var e = null,
            n = m(t);
            if (n && "OBJECT" == n.nodeName) if (typeof n.SetVariable != x) e = n;
            else {
        ...
        function l(t, e, n, i) {
            ...
            var s = m(n);
            if (s) {
                "OBJECT" == s.nodeName ? (T = u(s), w = null) : (T = s, w = n),
                t.id = R,
                (typeof t.width == x || !/%$/.test(t.width) && parseInt(t.width, 10) < 310) && (t.width = "310"),
                (typeof t.height == x || !/%$/.test(t.height) && parseInt(t.height, 10) < 137) && (t.height = "137"),
                P.title = P.title.slice(0, 47) + " - Flash Player Installation";
                var o = Y.ie && Y.win ? ["Active"].concat("").join("X") : "PlugIn",
                r = "MMredirectURL=" + O.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + o + "&MMdoctitle=" + P.title;
        ...
        function u(t) {
            var e = g("div");
            if (Y.win && Y.ie) e.innerHTML = t.innerHTML;
            else {
                var n = t.getElementsByTagName(A)[0];
                if (n) {
                    var i = n.childNodes;
                    if (i) for (var s = i.length,
                    o = 0; s > o; o++)(1 != i[o].nodeType || "PARAM" != i[o].nodeName) && 8 != i[o].nodeType && e.appendChild(i[o].cloneNode(!0))
                }
            }
            return e
        }
        function d(t, e, n) {
            var i, s = m(n);
            if (Y.wk && Y.wk < 312) return i;
            if (s) if (typeof t.id == x && (t.id = n), Y.ie && Y.win) {
                var o = "";
        ...
        function p(t) {
            var e = m(t);
            e && "OBJECT" == e.nodeName && (Y.ie && Y.win ? (e.style.display = "none",
            function() {
            ...
            if (!Y.ie || !Y.mac) {
                ...
                if (s) {
                    ...
                    if (i && (L = null, C = null), !L || C != o) {
                        ...
                        L = s.appendChild(r),
                        Y.ie && Y.win && typeof P.styleSheets != x && P.styleSheets.length > 0 && (L = P.styleSheets[P.styleSheets.length - 1]),
                        C = o
                    }
        ...
        function E(t) {
            ...
            W = !0,
            Y = function() {
                var t = typeof P.getElementById != x && typeof P.getElementsByTagName != x && typeof P.createElement != x,
                ...
                a = [0, 0, 0],
                l = null;
                if (typeof $.plugins != x && typeof $.plugins[I] == A) l = $.plugins[I].description,
                l && (typeof $.mimeTypes == x || !$.mimeTypes[M] || !!$.mimeTypes[M].enabledPlugin) && (j = !0, r = !1, l = l.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), a[0] = parseInt(l.replace(/^(.*)\..*$/, "$1"), 10), a[1] = parseInt(l.replace(/^.*\.(.*)\s.*$/, "$1"), 10), a[2] = /[a-zA-Z]/.test(l) ? parseInt(l.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
                else if (typeof O[["Active"].concat("Object").join("X")] != x) try {
            ...
            function() {
                Y.w3 && ((typeof P.readyState != x && "complete" == P.readyState || typeof P.readyState == x && (P.getElementsByTagName("body")[0] || P.body)) && t(), z || (typeof P.addEventListener != x && P.addEventListener("DOMContentLoaded", t, !1), Y.ie && Y.win && (P.attachEvent(N,
                function() {
            ...
            function() {
                ...
                function() {
                    for (var t = F.length,
                    e = 0; t > e; e++) F[e][0].detachEvent(F[e][1], F[e][2]);
                    for (var n = B.length,
                    i = 0; n > i; i++) p(B[i]);
                    for (var s in Y) Y[s] = null;
                    Y = null;
        ...
        return {
            ...
            embedSWF: function(t, n, i, s, o, r, c, u, h, p) {
                ...
                Y.w3 && !(Y.wk && Y.wk < 312) && t && n && i && s && o ? (S(n, !1), e(function() {
                    ...
                    s += "";
                    var e = {};
                    if (h && typeof h === A) for (var m in h) e[m] = h[m];
                    e.data = t,
                    e.width = i,
                    e.height = s;
                    var g = {};
                    if (u && typeof u === A) for (var v in u) g[v] = u[v];
                    if (c && typeof c === A) for (var b in c) typeof g.flashvars != x ? g.flashvars += "&" + b + "=" + c[b] : g.flashvars = b + "=" + c[b];
                    if (y(o)) {
                        var E = d(e, g, n);
                        e.id == n && S(n, !0),
                        f.success = !0,
            ...
            getQueryParamValue: function(t) {
                ...
                if (e) {
                    ...
                    for (var n = e.split("&"), i = 0; i < n.length; i++) if (n[i].substring(0, n[i].indexOf("=")) == t) return E(n[i].substring(n[i].indexOf("=") + 1))
                }
                return ""
            },
            expressInstallCallback: function() {
                if (V) {
                    var t = m(R);
                    t && T && (t.parentNode.replaceChild(T, t), w && (S(w, !0), Y.ie && Y.win && (T.style.display = "block")), _ && _(k)),
                    V = !1
                }
            }
        }
    ...
    function() {
        if ("undefined" != typeof window && !window.WebSocket) {
            ...
            WebSocket.prototype.addEventListener = function(t, e) {
                t in this.__events || (this.__events[t] = []),
                this.__events[t].push(e)
            },
            WebSocket.prototype.removeEventListener = function(t, e) {
                if (t in this.__events) for (var n = this.__events[t], i = n.length - 1; i >= 0; --i) if (n[i] === e) {
                    n.splice(i, 1);
                    break
                }
            },
            ...
            WebSocket.prototype.__handleEvent = function(t) {
                "readyState" in t && (this.readyState = t.readyState),
                "protocol" in t && (this.protocol = t.protocol);
                var e;
            ...
            WebSocket.prototype.__createMessageEvent = function(t, e) {
                if (document.createEvent && window.MessageEvent && !window.opera) {
                    ...
                    return n.initMessageEvent("message", !1, !1, e, null, null, window, null),
                    n
                }
                return {
                    type: t,
            ...
            WebSocket.__tasks = [], WebSocket.__nextId = 0, WebSocket.loadFlashPolicyFile = function(t) {
                WebSocket.__addTask(function() {
            ...
            WebSocket.__initialize = function() {
                if (!WebSocket.__flash) {
                    ...
                    WebSocket.__isFlashLite() ? (e.style.left = "0px", e.style.top = "0px") : (e.style.left = "-100px", e.style.top = "-100px");
    ...
    function(t, e, n) {
        ...
        i.prototype.post = function(t) {
            ...
            n.XDomainRequest && this.sendXHR instanceof XDomainRequest ? this.sendXHR.onload = this.sendXHR.onerror = i: this.sendXHR.onreadystatechange = e,
            this.sendXHR.send(t)
        },
        i.prototype.close = function() {
            return this.onClose(),
        ...
        i.check = function(t, i) {
            try {
                ...
                r = t && t.options && t.options.secure ? "https:": "http:",
    ...
    function(t, e) {
        ...
        t.htmlfile = n,
        e.util.inherit(n, e.Transport.XHR),
        ...
        n.prototype.close = function() {
            return this.destroy(),
            e.Transport.XHR.prototype.close.call(this)
        },
        n.check = function(t) {
    ...
    function(t, e, n) {
        ...
        e.util.merge(i, e.Transport.XHR),
        i.prototype.name = "xhr-polling",
        i.prototype.heartbeats = function() {
            return ! 1
        },
        i.prototype.open = function() {
            var t = this;
            return e.Transport.XHR.prototype.open.call(t),
            !1
        },
        i.prototype.get = function() {
            ...
            if (this.isOpen) {
                ...
                n.XDomainRequest && this.xhr instanceof XDomainRequest ? (this.xhr.onload = e, this.xhr.onerror = i) : this.xhr.onreadystatechange = t,
                this.xhr.send(null)
            }
        },
        i.prototype.onClose = function() {
    ...
    function(t, e, n) {
        ...
        t["jsonp-polling"] = i,
        e.util.inherit(i, e.Transport["xhr-polling"]),
...
function(t, e) {
    ...
    r = i.WordArray = o.extend({
        ...
        concat: function(t) {
            ...
            n = t.words,
            i = this.sigBytes;
            if (t = t.sigBytes, this.clamp(), i % 4) for (var s = 0; t > s; s++) e[i + s >>> 2] |= (n[s >>> 2] >>> 24 - 8 * (s % 4) & 255) << 24 - 8 * ((i + s) % 4);
            else if (65535 < n.length) for (s = 0; t > s; s += 4) e[i + s >>> 2] = n[s >>> 2];
    ...
    l = a.Hex = {
        ...
        parse: function(t) {
            for (var e = t.length,
            n = [], i = 0; e > i; i += 2) n[i >>> 3] |= parseInt(t.substr(i, 2), 16) << 24 - 4 * (i % 8);
    ...
    c = a.Latin1 = {
        ...
        parse: function(t) {
            for (var e = t.length,
            n = [], i = 0; e > i; i++) n[i >>> 2] |= (255 & t.charCodeAt(i)) << 24 - 8 * (i % 4);
            return new r.init(n, e)
        }
    },
    u = a.Utf8 = {
...
function(t) {
    function e(t, e, n, i, s, o, r) {
        return t = t + (e & n | ~e & i) + s + r,
        (t << o | t >>> 32 - o) + e
    }
    function n(t, e, n, i, s, o, r) {
        return t = t + (e & i | n & ~i) + s + r,
        (t << o | t >>> 32 - o) + e
    }
    function i(t, e, n, i, s, o, r) {
        return t = t + (e ^ n ^ i) + s + r,
        (t << o | t >>> 32 - o) + e
    }
    function s(t, e, n, i, s, o, r) {
        return t = t + (n ^ (e | ~i)) + s + r,
        (t << o | t >>> 32 - o) + e
    }
    for (var o = CryptoJS,
    r = o.lib,
    ...
    l = r.Hasher,
    r = o.algo,
    c = [], u = 0; 64 > u; u++) c[u] = 4294967296 * t.abs(t.sin(u + 1)) | 0;
    r = r.MD5 = l.extend({
        _doReset: function() {
        ...
        _doProcessBlock: function(t, o) {
            ...
            C = r[3],
            _ = e(_, k, L, C, a, 7, c[0]),
            C = e(C, _, k, L, l, 12, c[1]),
            L = e(L, C, _, k, u, 17, c[2]),
            k = e(k, L, C, _, d, 22, c[3]),
            _ = e(_, k, L, C, h, 7, c[4]),
            C = e(C, _, k, L, p, 12, c[5]),
            L = e(L, C, _, k, f, 17, c[6]),
            k = e(k, L, C, _, m, 22, c[7]),
            _ = e(_, k, L, C, g, 7, c[8]),
            C = e(C, _, k, L, v, 12, c[9]),
            L = e(L, C, _, k, y, 17, c[10]),
            k = e(k, L, C, _, b, 22, c[11]),
            _ = e(_, k, L, C, S, 7, c[12]),
            C = e(C, _, k, L, E, 12, c[13]),
            L = e(L, C, _, k, T, 17, c[14]),
            k = e(k, L, C, _, w, 22, c[15]),
            _ = n(_, k, L, C, l, 5, c[16]),
            C = n(C, _, k, L, f, 9, c[17]),
            L = n(L, C, _, k, b, 14, c[18]),
            k = n(k, L, C, _, a, 20, c[19]),
            _ = n(_, k, L, C, p, 5, c[20]),
            C = n(C, _, k, L, y, 9, c[21]),
            L = n(L, C, _, k, w, 14, c[22]),
            k = n(k, L, C, _, h, 20, c[23]),
            _ = n(_, k, L, C, v, 5, c[24]),
            C = n(C, _, k, L, T, 9, c[25]),
            L = n(L, C, _, k, d, 14, c[26]),
            k = n(k, L, C, _, g, 20, c[27]),
            _ = n(_, k, L, C, E, 5, c[28]),
            C = n(C, _, k, L, u, 9, c[29]),
            L = n(L, C, _, k, m, 14, c[30]),
            k = n(k, L, C, _, S, 20, c[31]),
            _ = i(_, k, L, C, p, 4, c[32]),
            C = i(C, _, k, L, g, 11, c[33]),
            L = i(L, C, _, k, b, 16, c[34]),
            k = i(k, L, C, _, T, 23, c[35]),
            _ = i(_, k, L, C, l, 4, c[36]),
            C = i(C, _, k, L, h, 11, c[37]),
            L = i(L, C, _, k, m, 16, c[38]),
            k = i(k, L, C, _, y, 23, c[39]),
            _ = i(_, k, L, C, E, 4, c[40]),
            C = i(C, _, k, L, a, 11, c[41]),
            L = i(L, C, _, k, d, 16, c[42]),
            k = i(k, L, C, _, f, 23, c[43]),
            _ = i(_, k, L, C, v, 4, c[44]),
            C = i(C, _, k, L, S, 11, c[45]),
            L = i(L, C, _, k, w, 16, c[46]),
            k = i(k, L, C, _, u, 23, c[47]),
            _ = s(_, k, L, C, a, 6, c[48]),
            C = s(C, _, k, L, m, 10, c[49]),
            L = s(L, C, _, k, T, 15, c[50]),
            k = s(k, L, C, _, p, 21, c[51]),
            _ = s(_, k, L, C, S, 6, c[52]),
            C = s(C, _, k, L, d, 10, c[53]),
            L = s(L, C, _, k, y, 15, c[54]),
            k = s(k, L, C, _, l, 21, c[55]),
            _ = s(_, k, L, C, g, 6, c[56]),
            C = s(C, _, k, L, w, 10, c[57]),
            L = s(L, C, _, k, f, 15, c[58]),
            k = s(k, L, C, _, E, 21, c[59]),
            _ = s(_, k, L, C, h, 6, c[60]),
            C = s(C, _, k, L, b, 10, c[61]),
            L = s(L, C, _, k, u, 15, c[62]),
        ...
        _doFinalize: function() {
            ...
            for (n[(s + 64 >>> 9 << 4) + 15] = 16711935 & (o << 8 | o >>> 24) | 4278255360 & (o << 24 | o >>> 8), n[(s + 64 >>> 9 << 4) + 14] = 16711935 & (i << 8 | i >>> 24) | 4278255360 & (i << 24 | i >>> 8), e.sigBytes = 4 * (n.length + 1), this._process(), e = this._hash, n = e.words, i = 0; 4 > i; i++) s = n[i],
...
function() {
    function t(t) {
        ...
        "object" == typeof t && (t.hasOwnProperty("r") && t.hasOwnProperty("g") && t.hasOwnProperty("b") ? (n = e(t.r, t.g, t.b), r = !0, a = "%" === String(t.r).substr( - 1) ? "prgb": "rgb") : t.hasOwnProperty("h") && t.hasOwnProperty("s") && t.hasOwnProperty("v") ? (t.s = A(t.s), t.v = A(t.v), n = o(t.h, t.s, t.v), r = !0, a = "hsv") : t.hasOwnProperty("h") && t.hasOwnProperty("s") && t.hasOwnProperty("l") && (t.s = A(t.s), t.l = A(t.l), n = i(t.h, t.s, t.l), r = !0, a = "hsl"), t.hasOwnProperty("a") && (s = t.a)),
        s = T(s),
        {
            ok: r,
            format: t.format || a,
    ...
    function i(t, e, n) {
        ...
        var s, o, r;
        if (t = w(t, 360), e = w(e, 100), n = w(n, 100), 0 === e) s = o = r = n;
        else {
    ...
    function h(t, e) {
        e = 0 === e ? 0 : e || 10;
        var n = B(t).toRgb();
        return n.r = U(0, j(255, n.r - $(255 * -(e / 100)))),
        n.g = U(0, j(255, n.g - $(255 * -(e / 100)))),
        n.b = U(0, j(255, n.b - $(255 * -(e / 100)))),
        B(n)
    }
    function p(t, e) {
        e = 0 === e ? 0 : e || 10;
    ...
    function b(t, e, n) {
        ...
        s = 360 / n,
        o = [B(t)];
        for (i.h = (i.h - (s * e >> 1) + 720) % 360; --e;) i.h = (i.h + s) % 360,
        o.push(B(i));
        return o
    }
    function S(t, e) {
        e = e || 6;
        for (var n = B(t).toHsv(), i = n.h, s = n.s, o = n.v, r = [], a = 1 / e; e--;) r.push(B({
            h: i,
            s: s,
            v: o
        })),
    ...
    function w(t, e) {
        L(t) && (t = "100%");
        var n = C(t);
        return t = j(e, U(0, parseFloat(t))),
        n && (t = parseInt(t * e, 10) / 100),
        P.abs(t - e) < 1e-6 ? 1 : t % e / parseFloat(e)
    }
    function _(t) {
        return j(1, U(0, t))
    }
    ...
    B.mostReadable = function(t, e) {
        ...
        s = !1,
        o = 0; o < e.length; o++) {
            var r = B.readability(t, e[o]),
            a = r.brightness > 125 && r.color > 500,
            l = 3 * (r.brightness / 125) + r.color / 500; (a && !s || a && s && l > i || !a && !s && l > i) && (s = a, i = l, n = B(e[o]))
        }
        return n
    };
    var F = B.names = {
...
function() {
    ...
    e.prototype.xml = function(e, n) {
        ...
        l = 0,
        c = n ? t(n) : this.shift;
        for (l = 0; s > l; l++) i[l].search(/<!/) > -1 ? (a += c[r] + i[l], o = !0, (i[l].search(/-->/) > -1 || i[l].search(/\]>/) > -1 || i[l].search(/!DOCTYPE/) > -1) && (o = !1)) : i[l].search(/-->/) > -1 || i[l].search(/\]>/) > -1 ? (a += i[l], o = !1) : /^<\w/.exec(i[l - 1]) && /^<\/\w/.exec(i[l]) && /^<[\w:\-\.\,]+/.exec(i[l - 1]) == /^<\/[\w:\-\.\,]+/.exec(i[l])[0].replace("/", "") ? (a += i[l], o || r--) : i[l].search(/<\w/) > -1 && -1 == i[l].search(/<\//) && -1 == i[l].search(/\/>/) ? a = a += o ? i[l] : c[r++] + i[l] : i[l].search(/<\w/) > -1 && i[l].search(/<\//) > -1 ? a = a += o ? i[l] : c[r] + i[l] : i[l].search(/<\//) > -1 ? a = a += o ? i[l] : c[--r] + i[l] : i[l].search(/\/>/) > -1 ? a = a += o ? i[l] : c[r] + i[l] : a += i[l].search(/<\?/) > -1 ? c[r] + i[l] : i[l].search(/xmlns\:/) > -1 || i[l].search(/xmlns\=/) > -1 ? c[r] + i[l] : i[l];
        return "\n" == a[0] ? a.slice(1) : a
    },
    ...
    e.prototype.css = function(e, n) {
        ...
        a = 0,
        l = n ? t(n) : this.shift;
        for (a = 0; s > a; a++) r += /\{/.exec(i[a]) ? l[o++] + i[a] : /\}/.exec(i[a]) ? l[--o] + i[a] : /\*\\/.exec(i[a]) ? l[o] + i[a] : l[o] + i[a];
        return r.replace(/^\n{1,}/, "")
    },
    e.prototype.sql = function(e, s) {
        ...
        h = 0,
        p = s ? t(s) : this.shift;
        for (h = 0; r > h; h++) a = a.concat(h % 2 ? o[h] : i(o[h], c));
        for (r = a.length, h = 0; r > h; h++) {
            u = n(a[h], u),
            /\s{0,}\s{0,}SELECT\s{0,}/.exec(a[h]) && (a[h] = a[h].replace(/\,/g, ",\n" + c + c)),
            /\s{0,}\s{0,}SET\s{0,}/.exec(a[h]) && (a[h] = a[h].replace(/\,/g, ",\n" + c + c)),
            /\s{0,}\(\s{0,}SELECT\s{0,}/.exec(a[h]) ? (l++, d += p[l] + a[h]) : /\'/.exec(a[h]) ? (1 > u && l && l--, d += a[h]) : (d += p[l] + a[h], 1 > u && l && l--)
        }
        return d = d.replace(/^\n{1,}/, "").replace(/\n{1,}/g, "\n")
    },
    ...
    remove: function(t) {
        for (var e, n = 0; n < this.data.length; n++) this.data[n] === t && (e = this.data.splice(n, 1), n--);
        e && this.changed.dispatch()
    },
    removeByProperties: function(t) {
        for (var e, n = this.findByProperties(t), i = 0; - 1 !== n && i++<1e3;) e = this.data.splice(n, 1),
        n = this.findByProperties(t);
        e && this.changed.dispatch()
    },
    ...
    create: function(t, e) {
        ...
        e), "function" == typeof this.factory) {
            ...
            return e.prepend ? this.unshift(n) : this.push(n),
    ...
    get: function(t) {
        if ("string" == typeof t && /\./.test(t)) {
            for (var e = t.split("."), n = this.data; e.length && n;) t = e.shift(),
            n = n[t];
            return n
        }
        return this.data[t]
    ...
    getTokenedAbsoluteURL: function(t) {
        ...
        return this.isPrivate() && (e += "?token=" + this.get("access_token")),
        e
    },
    clone: function() {
        return new SL.models.Deck(JSON.parse(JSON.stringify(this.data)))
    }
}), SL("models").Deck.VISIBILITY_SELF = "self", SL("models").Deck.VISIBILITY_TEAM = "team", SL("models").Deck.VISIBILITY_ALL = "all", SL("models").Team = SL.models.Model.extend({
    init: function(t) {
        if (this._super(t), "object" == typeof this.data.themes) for (var e = 0,
        n = this.data.themes.length; n > e; e++) this.data.themes[e] = new SL.models.Theme(this.data.themes[e]);
    ...
    getTemplateVariables: function() {
        ...
        if (t) {
            ...
            if (e) return e = e.map(function(t) {
                ...
                n.defaultValue = n.defaultValue.trim(),
                n.label = n.label.replace(SL.models.ThemeSnippet.TEMPLATE_VARIABLE_OPENER, ""),
                n.label = n.label.replace(SL.models.ThemeSnippet.TEMPLATE_VARIABLE_CLOSER, ""),
                n.defaultValue = n.defaultValue.replace(SL.models.ThemeSnippet.TEMPLATE_VARIABLE_OPENER, ""),
                n.defaultValue = n.defaultValue.replace(SL.models.ThemeSnippet.TEMPLATE_VARIABLE_CLOSER, ""),
                n
            })
        }
        return []
    ...
    init: function(t) {
        ...
        this.set("snippets", new SL.models.Collection(this.data.snippets, SL.models.ThemeSnippet)),
        "string" == typeof this.data.palette && this.data.palette.length > 0 ? (this.data.palette = this.data.palette.split(","), this.data.palette = this.data.palette.map(function(t) {
            return t.trim()
        })) : this.data.palette = []
    },
    ...
    toJSON: function() {
        return {
            ...
            css: this.get("css"),
            js: this.get("js"),
            snippets: JSON.stringify(this.get("snippets").toJSON()),
            palette: this.get("palette").join(",")
        }
    }
...
SL("models").UserSettings = SL.models.Model.extend({
    init: function(t) {
        this._super(t),
        this.has("present_controls") || this.set("present_controls", SL.config.PRESENT_CONTROLS_DEFAULT),
        this.has("present_upsizing") || this.set("present_upsizing", SL.config.PRESENT_UPSIZING_DEFAULT)
    },
    save: function(t) {
        var e = {
            user_settings: {}
        ...
        }.bind(this)) : e.user_settings = this.toJSON(),
        $.ajax({
    ...
    skipCSSTransitions: function(t, e) {
        t = $(t ? t: "html");
        var n = typeof t.get(0); ("undefined" === n || "number" === n) && console.warn("Bad target for skipCSSTransitions."),
    ...
    setupReveal: function(t) {
        if ("undefined" != typeof Reveal) {
            ...
            function() {
                ...
                window.STATUS.REVEAL_IS_READY = !0,
                ...
                function() {
                    ...
                    t >= .5 && !n[0] && (n[0] = !0, SL.analytics.trackPresenting("Presentation progress: 50%")),
                    t >= 1 && !n[1] && (n[1] = !0, SL.analytics.trackPresenting("Presentation progress: 100%"))
                })
            }
    ...
    layoutReveal: function(t, e) {
        if (clearInterval(this.revealLayoutInterval), clearTimeout(this.revealLayoutTimeout), 1 === arguments.length) this.revealLayoutTimeout = setTimeout(Reveal.layout, t);
            ...
            this.revealLayoutInterval = setInterval(Reveal.layout, e),
    ...
    getRevealElementOffset: function(t, e) {
        ...
        if (t.parents("section").length) for (; t.length && !t.is("section");) n.x += t.get(0).offsetLeft,
        n.y += t.get(0).offsetTop,
        e && (n.x -= parseInt(t.css("margin-left"), 10), n.y -= parseInt(t.css("margin-top"), 10)),
        t = $(t.get(0).offsetParent);
        return n
    },
    ...
    getPlaceholderImage: function(t) {
        var e = "";
        return t && "function" == typeof window.btoa && (e = window.btoa(Math.random().toString()).replace(/=/g, "")),
        "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" + e
    },
...
SL.util.string = {
    ...
    uniqueIDCount: 0,
    uniqueID: function(t) {
        return SL.util.string.uniqueIDCount += 1,
        (t || "") + SL.util.string.uniqueIDCount + "-" + Date.now()
    },
    slug: function(t) {
    ...
    linkify: function(t) {
        return t && (t = t.replace(/((https?\:\/\/)|(www\.))(\S+)(\w{2,4})(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/gi,
        function(t) {
            var e = t;
...
SL.util.validate = {
    ...
    slug: function(t) {
        t = t || "";
        var e = [];
        return t.length < 2 && e.push("At least 2 characters"),
        /\s/gi.test(t) && e.push("No spaces please"),
        /^[\w-_]+$/gi.test(t) || e.push("Can only contain: A-Z, 0-9, - and _"),
        e
    },
    username: function(t) {
    ...
    password: function(t) {
        t = t || "";
        var e = [];
        return t.length < 6 && e.push("At least 6 characters"),
        e
    },
    email: function(t) {
        t = t || "";
        var e = [];
        return /^[A-Z0-9._%+\-]+@[A-Z0-9.\-]+\.[A-Z]{2,}$/gi.test(t) || e.push("Please enter a valid email"),
        e
    },
    twitterhandle: function(t) {
        t = t || "";
        var e = [];
        return t.length > 15 && e.push("15 characters max"),
        /\s/gi.test(t) && e.push("No spaces please"),
        /^[\w-_]+$/gi.test(t) || e.push("Can only contain: A-Z, 0-9 and _"),
        e
    },
    url: function(t) {
        t = t || "";
        var e = [];
        return t.length < 4 && e.push("Please enter a valid URL"),
        /\s/gi.test(t) && e.push("No spaces please"),
        e
    },
    decktitle: function(t) {
        t = t || "";
        var e = [];
        return 0 === t.length && e.push("Can not be empty"),
        e
    },
    deckslug: function(t) {
        t = t || "";
    ...
    google_analytics_id: function(t) {
        t = t || "";
        var e = [];
        return /\bUA-\d{4,20}-\d{1,10}\b/gi.test(t) || e.push("Please enter a valid ID"),
        e
    },
    none: function() {
        return []
...
SL.util.dom = {
    ...
    insertCSRF: function(t, e) {
        "undefined" == typeof e && (e = $('meta[name="csrf-token"]').attr("content")),
        e && (t.find('input[name="authenticity_token"]').remove(), t.append('<input name="authenticity_token" type="hidden" value="' + e + '" />'))
    }
},
SL.util.html = {
    indent: function(t) {
    ...
    removeAttributes: function(t, e) {
        t = $(t);
        var n = $.map(t.get(0).attributes,
        function(t) {
            return t.name
        });
        "function" == typeof e && (n = n.filter(e)),
        $.each(n,
        function(e, n) {
            t.removeAttr(n)
        })
    ...
    generateSpinners: function() {
        $(".spinner").each(function(t, e) {
            if (e.hasAttribute("data-spinner-state") === !1) {
                ...
                var n = {};
                e.hasAttribute("data-spinner-color") && (n.color = e.getAttribute("data-spinner-color")),
                e.hasAttribute("data-spinner-lines") && (n.lines = parseInt(e.getAttribute("data-spinner-lines"), 10)),
                e.hasAttribute("data-spinner-width") && (n.width = parseInt(e.getAttribute("data-spinner-width"), 10)),
                e.hasAttribute("data-spinner-radius") && (n.radius = parseInt(e.getAttribute("data-spinner-radius"), 10)),
                e.hasAttribute("data-spinner-length") && (n.length = parseInt(e.getAttribute("data-spinner-length"), 10));
...
SL.util.deck = {
    ...
    sortInjectedStyles: function() {
        var t = $("head");
        $("#theme-css-output").appendTo(t),
        $("#user-css-output").appendTo(t)
    },
    generateIdentifiers: function() {
        $(".reveal .slides section").each(function() { (this.hasAttribute("data-id") === !1 || 0 === this.getAttribute("data-id").length) && this.setAttribute("data-id", CryptoJS.MD5(["slide", SL.current_user.get("id"), SL.current_deck.get("id"), Date.now(), SL.util.deck.idCounter++].join("-")).toString())
        })
    },
    injectNotes: function() {
        SLConfig.deck && SLConfig.deck.notes && [].forEach.call(document.querySelectorAll(".reveal .slides section"),
        function(t) {
...
SL.util.selection = {
    ...
    getSelectedTags: function() {
        ...
        e = [];
        if (t) for (; t;) e.push(t.nodeName.toLowerCase()),
        t = t.parentNode;
        return e
    },
    getSelectedHTML: function() {
        var t;
        if (document.selection && document.selection.createRange) return t = document.selection.createRange(),
        t.htmlText;
...
SL.config = {
    ...
    BLOCKS: new SL.models.Collection([{
        type: "text",
        factory: "Text",
        label: "Text",
        icon: "type"
    ...
    ASSET_URLS: {
        "offline-v2.css": "//slides.com/assets/offline-v2-ba8896a9fd13191bb63b211224367f78.css",
        "homepage-background.jpg": "//slides.com/assets/homepage-background-472c36922863393667a139ac752793fa.jpg",
        "reveal-plugins/markdown/marked.js": "//slides.com/assets/reveal-plugins/markdown/marked-e85be48162f9adcf7419e4c1230f15ef.js",
        "reveal-plugins/markdown/markdown.js": "//slides.com/assets/reveal-plugins/markdown/markdown-02f7d760fc1468526375709117f72d9f.js",
        "reveal-plugins/highlight/highlight.js": "//slides.com/assets/reveal-plugins/highlight/highlight-c45dd11db498638a5f901bf336979f9a.js"
    }
},
SL.config.V1 = {
...
SL.keyboard = {
    init: function() {
        this.keyupConsumers = new SL.models.Collection,
        this.keydownConsumers = new SL.models.Collection,
    ...
    release: function(t) {
        this.keydownConsumers.remove(t),
        this.keyupConsumers.remove(t)
    },
...
SL.locale = {
    ...
    DECKSHARER_PRIVATE_URL_NOTICE: 'This deck is private but can be shared using the secret link above. To publicly share or embed your deck, please publish it first. <a href="http://help.slides.com/knowledgebase/articles/405987-privacy" target="_blank">More info.</a>',
    ...
    get: function(t, e) {
        var n = SL.locale[t];
        if ("object" == typeof n && n.length && (this.counter[t] = "number" == typeof this.counter[t] ? (this.counter[t] + 1) % n.length: 0, n = n[this.counter[t]]), "object" == typeof e) for (var i in e) n = n.replace("{#" + i + "}", e[i]);
...
SL.settings = {
    ...
    setDefaults: function() {
        "undefined" == typeof this.settings[this.EDITOR_AUTO_HIDE] && (this.settings[this.EDITOR_AUTO_HIDE] = !1),
        "undefined" == typeof this.settings[this.EDITOR_AUTO_SAVE] && (this.settings[this.EDITOR_AUTO_SAVE] = !0)
    },
    setValue: function(t, e) {
        "object" == typeof t ? $.extend(this.settings, t) : this.settings[t] = e,
        this.save(),
    ...
    removeValue: function(t) {
        ...
        }.bind(this)) : delete this.settings[t],
        this.save(),
        this.changed.dispatch([t])
    },
    restore: function() {
...
SL.templates = {
    ...
    getUserTemplates: function(t) {
        t = t ||
        function() {},
        SL.templates.userTemplatesLoading === !1 && SL.templates.userTemplatesLoaded === !1 ? (SL.templates.userTemplatesLoading = !0, SL.templates.userTemplatesCallbacks.push(t), $.ajax({
            type: "GET",
    ...
    getTeamTemplates: function(t) {
        ...
        function() {},
        SL.templates.teamTemplatesLoading === !1 && SL.templates.teamTemplatesLoaded === !1 ? (SL.templates.teamTemplatesLoading = !0, SL.templates.teamTemplatesCallbacks.push(t), $.ajax({
            type: "GET",
            url: SL.config.AJAX_TEAM_SLIDE_TEMPLATES_LIST,
            context: this
        }).done(function(t) {
            SL.templates.teamTemplates = new SL.models.Collection(t.results, SL.models.Template),
            SL.templates.teamTemplatesLoaded = !0,
            SL.templates.teamTemplatesLoading = !1,
            SL.templates.teamTemplatesCallbacks.forEach(function(t) {
...
SL.util.svg = {
    ...
    boundingBox: function(t) {
        ...
        if ($(t).parents("body").length) e = t.getBBox();
            ...
            i.setAttribute("style", "visibility: hidden; position: absolute; left: 0; top: 0;"),
            i.appendChild(t),
            document.body.appendChild(i),
            e = t.getBBox(),
            n ? n.appendChild(t) : i.removeChild(t),
    ...
    rect: function(t, e) {
        ...
        return n.setAttribute("width", t),
        n.setAttribute("height", e),
        n
    },
    ellipse: function(t, e) {
        var n = document.createElementNS(SL.util.svg.NAMESPACE, "ellipse");
        return n.setAttribute("rx", t / 2),
        n.setAttribute("ry", e / 2),
        n.setAttribute("cx", t / 2),
        n.setAttribute("cy", e / 2),
        n
    },
    triangleUp: function(t, e) {
        var n = document.createElementNS(SL.util.svg.NAMESPACE, "polygon");
        return n.setAttribute("points", SL.util.svg.pointsToPolygon([t / 2, 0, t, e, 0, e])),
        n
    },
    triangleDown: function(t, e) {
        var n = document.createElementNS(SL.util.svg.NAMESPACE, "polygon");
        return n.setAttribute("points", SL.util.svg.pointsToPolygon([0, 0, t, 0, t / 2, e])),
        n
    },
    triangleLeft: function(t, e) {
        var n = document.createElementNS(SL.util.svg.NAMESPACE, "polygon");
        return n.setAttribute("points", SL.util.svg.pointsToPolygon([0, e / 2, t, 0, t, e])),
        n
    },
    triangleRight: function(t, e) {
        var n = document.createElementNS(SL.util.svg.NAMESPACE, "polygon");
        return n.setAttribute("points", SL.util.svg.pointsToPolygon([t, e / 2, 0, e, 0, 0])),
        n
    },
    arrowUp: function(t, e) {
        var n = document.createElementNS(SL.util.svg.NAMESPACE, "polygon");
        return n.setAttribute("points", SL.util.svg.pointsToPolygon([.5 * t, 0, t, .5 * e, .7 * t, .5 * e, .7 * t, e, .3 * t, e, .3 * t, .5 * e, 0, .5 * e, .5 * t, 0])),
        n
    },
    arrowDown: function(t, e) {
        var n = document.createElementNS(SL.util.svg.NAMESPACE, "polygon");
        return n.setAttribute("points", SL.util.svg.pointsToPolygon([.5 * t, e, t, .5 * e, .7 * t, .5 * e, .7 * t, 0, .3 * t, 0, .3 * t, .5 * e, 0, .5 * e, .5 * t, e])),
        n
    },
    arrowLeft: function(t, e) {
        var n = document.createElementNS(SL.util.svg.NAMESPACE, "polygon");
        return n.setAttribute("points", SL.util.svg.pointsToPolygon([t, .3 * e, .5 * t, .3 * e, .5 * t, 0, 0, .5 * e, .5 * t, e, .5 * t, .7 * e, t, .7 * e, t, .3 * e])),
        n
    },
    arrowRight: function(t, e) {
        var n = document.createElementNS(SL.util.svg.NAMESPACE, "polygon");
        return n.setAttribute("points", SL.util.svg.pointsToPolygon([0, .3 * e, .5 * t, .3 * e, .5 * t, 0, t, .5 * e, .5 * t, e, .5 * t, .7 * e, 0, .7 * e])),
        n
    },
    polygon: function(t, e, n) {
        ...
        else if (n > 3) for (var o = t / 2,
        r = e / 2,
        a = 0; n > a; a++) {
            var l = o + o * Math.cos(2 * Math.PI * a / n),
            c = r + r * Math.sin(2 * Math.PI * a / n);
            l = Math.round(10 * l) / 10,
            c = Math.round(10 * c) / 10,
            s.push(l),
            s.push(c)
        }
        return i.setAttribute("points", SL.util.svg.pointsToPolygon(s)),
        i
    },
    symbol: function(t) {
        var e = document.createElementNS(SL.util.svg.NAMESPACE, "g"),
        n = SL.util.svg.SYMBOLS[t];
        return n && (e.innerSVG = SL.util.svg.SYMBOLS[t]),
        e
    }
},
SL.warnings = {
...
SL("helpers").FileUploader = Class.extend({
    ...
    upload: function() {
        ...
        e && !this.options.external && t.append("authenticity_token", e.getAttribute("content")),
...
SL("helpers").ImageUploader = Class.extend({
    ...
    show: function(t) {
        var e = $(".page-loader");
        0 === e.length && (e = $(['<div class="page-loader">', '<div class="page-loader-inner">', '<p class="page-loader-message"></p>', '<div class="page-loader-spinner spinner"></div>', "</div>", "</div>"].join("")).appendTo(document.body)),
        t && e.find(".page-loader-message").html(t),
        e.addClass("visible")
    },
    hide: function() {
...
SL("helpers").PollJob = Class.extend({
    init: function(t) {
        ...
        this.polled = new signals.Signal
    },
    start: function() {
        this.running = !0,
    ...
    poll: function() {
        this.pollTimes++,
        Date.now() - this.pollStart > this.options.timeout || this.pollTimes > this.options.retries ? (this.stop(), this.ended.dispatch()) : this.polled.dispatch()
    }
    ...
    setupPublisher: function() {
        ...
        $.ajax({
            ...
            this.setState(JSON.parse(t.state), !0),
            this.setupSocket(),
            this.ready.dispatch()
        }).error(function() {
    ...
    publish: function(t, e) {
        if (this.publishable) {
            ...
            n.publisher_id = this.options.publisherID,
            n = $.extend(n, e),
            this.log("publish", n.publisher_id),
            $.ajax({
                url: "/api/v1/decks/" + this.options.deckID + "/stream.json",
                type: "PUT",
                data: {
    ...
    cleanup: function() {
        var t = $(".reveal-viewport"),
        e = $(".reveal");
        t.attr("class", t.attr("class").replace(/theme\-(font|color)\-([a-z0-9-])*/gi, "")),
        SL.config.THEME_TRANSITIONS.forEach(function(t) {
            e.removeClass(t.id)
        })
    }
},
SL("components").DeckSharer = Class.extend({
    ...
    build: function() {
        ...
        this.domElement.append(['<div class="url">', "<h3>" + SL.locale.get("DECKSHARER_URL_TITLE") + "</h3>", '<input type="text" name="url" readonly="readonly" class="input-field" />', "</div>"].join("")),
        ...
        SL.current_user.isPro() && (t += '<option value="hidden">Hidden</option>'),
        this.domElement.append(['<div class="embed sl-form">', "<h3>" + SL.locale.get("DECKSHARER_EMBED_TITLE") + "</h3>", '<div class="options">', '<div class="option">', "<label>Width:</label>", '<input type="text" name="width" maxlength="4" class="input-field" />', "</div>", '<div class="option">', "<label>Height:</label>", '<input type="text" name="height" maxlength="4" class="input-field" />', "</div>", '<div class="option">', "<label>Footer style:</label>", '<select class="sl-select l" name="style">', t, "</select>", "</div>", "</div>", '<textarea name="output" readonly="readonly"></textarea>', "</div>"].join("")),
        this.embedStyleElement = this.domElement.find(".embed .options select[name=style]"),
        this.embedWidthElement = this.domElement.find(".embed .options input[name=width]"),
        this.embedHeightElement = this.domElement.find(".embed .options input[name=height]"),
        this.embedOutputElement = this.domElement.find(".embed textarea"),
        this.embedStyleElement.on("change", this.onStyleChanged),
        this.embedWidthElement.on("input", this.onSizeChanged),
        this.embedHeightElement.on("input", this.onSizeChanged),
        ...
        this.isPrivate && this.domElement.append(['<div class="note">', '<p class="note-inner">', SL.locale.get("DECKSHARER_PRIVATE_URL_NOTICE"), "</p>", "</div>"].join(""))
    },
    render: function(t) {
        if (t && "string" != typeof t.slug || "string" != typeof t.user.username) throw "Must specify username and slug of deck to embed.";
        this.data = t,
        this.isPrivate = "string" == typeof this.data.access_token && (this.data.visibility === SL.models.Deck.VISIBILITY_SELF || this.data.visibility === SL.models.Deck.VISIBILITY_TEAM),
        this.build(),
        this.generate()
    },
    appendTo: function(t) {
    ...
    generate: function() {
        var t = this.getDeckURL(),
        e = this.getDeckURL(!0) + "/embed",
        n = [];
        this.isPrivate && this.data.access_token && n.push("token=" + this.data.access_token),
        t += n.length ? "?" + n.join("&") : "",
        "string" == typeof this.style && this.style.length > 0 && n.push("style=" + this.style),
        e += n.length ? "?" + n.join("&") : "";
        ...
        this.embedOutputElement && this.embedOutputElement.text(i),
        this.linkOutputElement && this.linkOutputElement.val(t)
    },
    getDeckURL: function(t) {
        var e = this.data.slug || this.data.id,
        n = t ? "": "http:";
    ...
    formatValues: function() {
        for (var t = 0; t < this.values.length; t++) this.values[t] = SL.util.string.trim(this.values[t]),
    ...
    removeValue: function(t) {
        if ("string" == typeof t) for (var e = 0; e < this.values.length; e++) this.values[e] === t && this.values.splice(e, 1);
    ...
    init: function(t) {
        ...
        this.domElement.parents("form").first().on("submit", this.onFormSubmit.bind(this)),
        this.originalError && (this.domElement.removeClass("hidden"), this.validate(), this.inputElement.focus()),
        this.domElement.data("controller", this)
    },
    validate: function(t) {
        clearTimeout(this.validateTimeout);
        var e = this.inputElement.val();
        if ("string" != typeof e) return this.serverErrors = [],
        this.clientErrors = [],
        void this.render();
        ...
        t && this.isRequired() && this.clientErrors.push(SL.locale.FORM_ERROR_REQUIRED);
        return this.validateAsync(),
        this.render(),
        0 === this.clientErrors.length && 0 === this.serverErrors.length
    },
    ...
    beforeSubmit: function() {
        ...
        this.clientErrors.length > 0 || this.serverErrors.length > 0 ? (this.focus(), !1) : !0
    },
    ...
    onInput: function() {
        if (clearTimeout(this.validateTimeout), !SL.util.device.IS_PHONE && !SL.util.device.IS_TABLET) {
            var t = 600; (this.clientErrors.length || this.serverErrors.length) && (t = 300),
            this.validateTimeout = setTimeout(this.validate.bind(this), t)
        }
    },
    onInputChange: function(t) {
        this.domElement.hasClass("image") && this.renderImage(t.target),
        this.validate()
    },
    ...
    render: function() {
        var t = this.domElement.find(".profile-button .nav-item-anchor"),
        e = [{
            label: "Profile",
            icon: "home",
        ...
        SL.current_user.isEnterpriseManager() && e.push({
            label: "Themes",
            icon: "brush",
        ...
        SL.current_user.isPro() && !SL.current_user.isEnterprise() ? e.push({
            label: "Billing",
            icon: "credit",
            url: SL.routes.BILLING_DETAILS
        }) : SL.current_user.isEnterprise() || e.push({
            label: "Upgrade",
            icon: "star",
        ...
        this.dropdown = new SL.components.Menu({
            anchor: t,
            anchorSpacing: 10,
            alignment: "auto",
            minWidth: 160,
    ...
    bind: function() {
        ...
        function() {
            return window.location.href = "/about#logo",
            !1
        }),
    ...
    onWindowScroll: function() {
        this.isScrolledDown = $(window).scrollTop() > 30,
        this.domElement.toggleClass("show", this.isScrolledDown)
    },
    ...
    function t() {
        ...
        $(".kudos-trigger[data-kudos-id]").on("click",
        function(t) {
    ...
    function i(t) {
        ...
        e.attr("data-kudoed-by-user", "true"),
        r[t]++,
        o(t, r[t]);
    ...
    function s(t) {
        var e = $('.kudos-trigger[data-kudos-id="' + t + '"]');
        e.attr("data-kudoed-by-user", "false"),
        r[t]--,
        o(t, r[t]),
        e.find(".kudos-icon").removeClass("bounce")
    }
    function o(t, e) {
    ...
    init: function(t) {
        ...
        this.render(),
        this.renderList(),
        this.config.anchor.length && (/(iphone|ipod|ipad|android|windows\sphone)/gi.test(navigator.userAgent) ? (this.config.anchor.addClass("menu-show-on-touch"), this.config.anchor.on("touchstart pointerdown",
        function(t) {
            t.preventDefault(),
            this.toggle()
        }.bind(this)), this.config.anchor.on("click",
        function(t) {
            t.preventDefault()
    ...
    render: function() {
        ...
        this.listElement = $('<div class="sl-menu-list">').appendTo(this.domElement),
        this.arrowElement = $('<div class="sl-menu-arrow">').appendTo(this.domElement),
        this.hitareaElement = $('<div class="sl-menu-hitarea">').appendTo(this.domElement),
        this.listElement.css("minWidth", this.config.minWidth + "px")
    },
    renderList: function() {
        this.config.options.forEach(function(t) {
            var e;
            e = $("string" == typeof t.url ? '<a class="sl-menu-item" href="' + t.url + '">': '<div class="sl-menu-item">'),
            e.html('<span class="label">' + t.label + "</span>"),
            e.data("callback", t.callback),
            e.appendTo(this.listElement),
            e.on("click",
            function(t) {
                var e = $(t.currentTarget).data("callback");
                "function" == typeof e && e.apply(null),
                this.hide()
            }.bind(this)),
            t.icon && e.append('<span class="icon i-' + t.icon + '"></span>'),
            t.attributes && e.attr(t.attributes)
        }.bind(this)),
        this.listElement.find(".sl-menu-item:not(:last-child)").after('<div class="sl-menu-divider">')
    },
    bind: function() {
    ...
    layout: function() {
        if (this.config.anchor.length) {
            ...
            r = t.top + this.config.offsetY,
            a = this.config.anchor.outerWidth(),
            l = this.config.anchor.outerHeight(),
            c = this.domElement.outerWidth(),
            u = this.domElement.outerHeight(),
            d = c / 2,
            h = c / 2,
            p = 8;
    ...
    read: function() {
        ...
        case "storage":
            ...
            this.value < n && this.total < n ? (this.value = Math.round(this.value / e), this.total = Math.round(this.total / e), this.unit = "MB") : (this.value = (this.value / n).toFixed(2), this.total = (this.total / n).toFixed(2), this.unit = "GB")
        }
    },
    paint: function() {
    ...
    function t() {
        ...
        SL.htmlEditor.env.document.setValue(SL.util.html.indent(e)),
        SL.htmlEditor.focus(),
        a.find(".save-changes").on("click",
        function() {
            SL.editor.controllers.Markup.writeHTMLToCurrentSlide(SL.htmlEditor.env.document.getValue()),
            SL.modal.close()
        })
    }
    function e() {
    ...
    function n(t) {
        ...
        controller = new SL.components.DeckSharer,
        controller.prependTo(e),
        e.data("decksharer", controller),
        controller.render(t)
    }
    function i(t) {
        var e = $(['<div class="inner preview-deck">', '<div class="spinner centered"></div>', '<div class="deck"></div>', "<footer></footer>", "</div>"].join("")).appendTo(a),
        n = e.find(".deck").empty(),
        i = e.find("footer").empty();
        e.addClass("loading"),
        ...
        s.appendTo(n),
        i.append(t.footer ? t.footer: '<button class="button close l">Close</button>')
    }
    function s(t) {
        var e = $(['<div class="inner insert-snippet">', '<h3>Insert: "' + t.snippet.get("title") + '"</h3>', '<div class="variables sl-form"></div>', "<footer>", '<button class="button outline close l">Cancel</button>', '<button class="button insert l">Insert</button>', "</footer>", "</div>"].join("")).appendTo(a),
        n = a.find(".insert"),
        i = t.snippet.getTemplateVariables(),
        s = e.find(".variables");
        ...
        function() {
            ...
            t.callback(t.snippet.templatize(i)),
            SL.modal.close()
        })
    }
    function o() {
        var t = a.find(".preview-deck");
        t.find(".deck iframe").attr("src", ""),
        t.find(".deck").empty(),
        t.find("footer").empty()
    }
    function r() {
        var t = a.find(">.inner");
        t.css({
            left: Math.max((window.innerWidth - t.outerWidth()) / 2, 10),
            top: Math.max((window.innerHeight - t.outerHeight()) / 2, 10)
        })
    }
    var a = $('<div id="modal">').appendTo(document.body),
    l = $('<div id="modal-cover">').appendTo(document.body),
    c = $('<div id="modal-background">').appendTo(document.body),
    u = null,
    d = null;
    ...
    }),
    {
        open: function(o, l) {
            ...
            clearTimeout(d),
            c.show(),
            a.find(">.inner").removeClass("visible"),
            a.find("." + o).addClass("visible"),
            $(window).on("resize", r),
            r()
        },
        close: function() {
            $("html").removeClass("modal-open"),
            a.find(".save-changes").off(),
            a.find(".discard-changes").off(),
        ...
        isOpen: function(t) {
            ...
            return e && t && (e = a.find("." + t).hasClass("visible")),
            e
        }
    }
    ...
    0 === $(".sl-notifications").length && $(document.body).append('<div class="sl-notifications"></div>'),
    $(".sl-notifications>p").last().html() === t && $(".sl-notifications>p").last().remove(),
    "string" == typeof e && (e = {
        type: e
    }),
    e = $.extend({
...
SL("components").Prompt = Class.extend({
    ...
    render: function() {
        this.domElement = $('<div class="sl-prompt" data-type="' + this.config.type + '">'),
        this.innerElement = $('<div class="inner">').appendTo(this.domElement),
        this.arrowElement = $('<div class="arrow">').appendTo(this.innerElement),
        this.config.title && (this.titleElement = $('<h3 class="title">').html(this.config.title).appendTo(this.innerElement)),
        this.config.className && this.domElement.addClass(this.config.className),
        this.config.html && this.innerElement.append(this.config.html),
        "select" === this.config.type ? this.renderSelect() : "list" === this.config.type ? (this.renderList(), this.renderButtons(!this.config.multiselect, this.config.multiselect)) : "input" === this.config.type && (this.renderInput(), this.renderButtons())
    },
    renderSelect: function() {
        this.config.data.forEach(function(t) {
            var e = $('<a class="item button outline l">').html(t.html);
            e.data("callback", t.callback),
            e.appendTo(this.innerElement),
            e.on("vclick",
            function(t) {
                var e = $(t.currentTarget).data("callback");
                "function" == typeof e && e.apply(null),
            ...
            t.focused === !0 && e.addClass("focus"),
            t.selected === !0 && e.addClass("selected"),
            "string" == typeof t.className && e.addClass(t.className)
        }.bind(this)),
    ...
    renderList: function() {
        ...
        this.config.data.forEach(function(t) {
            ...
            e.html('<span class="title">' + (t.title ? t.title: t.value) + '</span><span class="checkmark icon i-checkmark"></span>'),
            e.data({
                callback: t.callback,
                value: t.value
            }),
            ...
            function(t) {
                ...
                n = e.data("callback"),
                i = e.data("value");
                this.config.multiselect && e.toggleClass("selected"),
                "function" == typeof n && n.apply(null, [i, e.hasClass("selected")]),
                this.config.multiselect || (this.confirmed.dispatch(i), this.destroy())
            }.bind(this)),
            t.focused === !0 && e.addClass("focus"),
            t.selected === !0 && e.addClass("selected"),
            "string" == typeof t.className && e.addClass(t.className)
    ...
    renderInput: function() {
        this.config.data.multiline === !0 ? this.inputElement = $('<textarea cols="40" rows="8">') : (this.inputElement = $('<input type="text">'), "number" == typeof this.config.data.width && this.inputElement.css("width", this.config.data.width)),
        this.config.data.value && this.inputElement.val(this.config.data.value),
        this.config.data.placeholder && this.inputElement.attr("placeholder", this.config.data.placeholder),
        this.config.data.maxlength && this.inputElement.attr("maxlength", this.config.data.maxlength),
        this.inputWrapperElement = $('<div class="input-wrapper">').append(this.inputElement),
        this.inputWrapperElement.appendTo(this.innerElement),
        this.onInputChanged()
    },
    renderButtons: function(t, e) {
        this.footerElement = $('<div class="footer">').appendTo(this.innerElement),
        !e && this.config.optional && this.config.cancelLabel && this.footerElement.append('<button class="button l outline white prompt-cancel">' + this.config.cancelLabel + "</button>"),
        !t && this.config.confirmLabel && this.footerElement.append('<button class="button l prompt-confirm">' + this.config.confirmLabel + "</button>")
    },
    bind: function() {
        $(window).on("resize", this.layout),
        $(document).on("keydown", this.onDocumentKeydown),
        this.domElement.on("vclick", this.onBackgroundClicked),
        "hidden" !== $("html").css("overflow") && $(window).on("scroll", this.layout),
        ...
        this.inputElement && this.inputElement.on("input", this.onInputChanged)
    },
    unbind: function() {
        $(window).off("resize scroll", this.layout),
        $(document).off("keydown", this.onDocumentKeydown),
        ...
        this.inputElement && this.inputElement.off("input", this.onInputChanged)
    },
    layout: function() {
        var t = this.innerElement.outerWidth(),
        e = this.innerElement.outerHeight(),
        n = $(this.config.anchor);
        if (n.length) {
            var i = n.offset(),
            s = 15,
            o = this.config.alignment,
            r = $(window).scrollLeft(),
            a = $(window).scrollTop(),
            l = i.left - $(window).scrollLeft(),
            c = i.top - $(window).scrollTop();
            l += this.config.offsetX,
            c += this.config.offsetY;
            var u = n.outerWidth(),
            d = n.outerHeight(),
            h = t / 2,
            p = t / 2,
            ...
            top: Math.round(.4 * (window.innerHeight - e))
        }),
    ...
    getValue: function() {
        var t = void 0;
        return "input" === this.config.type && (t = this.inputElement.val()),
        t
    },
    ...
    cancel: function() {
        ...
        } else this.canceled.dispatch(this.getValue()),
        this.destroy()
    },
    destroy: function() {
        this.destroyed.dispatch(),
    ...
    onDocumentKeydown: function(t) {
        if (27 === t.keyCode && (this.config.optional && this.cancel(), t.preventDefault()), "select" === this.config.type || "list" === this.config.type) if (13 === t.keyCode) {
            var e = this.innerElement.find(".focus");
            0 === e.length && (e = this.innerElement.find(".selected")),
            e.length && (e.trigger("click"), t.preventDefault())
...
SL("components").Resizer = Class.extend({
    ...
    function s(t, e) {
        ...
        if (c && u && !u.is(t) && i(), !c) {
            ...
            $.extend(s, e),
            u = $(t),
            c = new SL.components.Resizer(u, s),
            c.resizeUpdated.add(l),
            c.show(),
    ...
    function o(t) {
        var e = $(t.currentTarget),
        n = null;
        e.data("resizer-options") && (n = e.data("resizer-options")),
        e.data("target-element") && (e = e.data("target-element")),
        s(e, n)
    }
    function r(t) {
        if (c) if (c.isDestroyed()) i();
        else if (!c.isResizing()) {
            var e = Reveal.getScale(),
            n = SL.util.getRevealElementGlobalOffset(u),
            s = 3 * c.getOptions().padding,
            o = {
                top: n.y - s,
                right: n.x + u.outerWidth(!0) * e + s,
                bottom: n.y + u.outerHeight(!0) * e + s,
                left: n.x - s
...
SL("components").ScrollShadow = Class.extend({
    ...
    render: function() {
        this.shadowTop = $('<div class="sl-scroll-shadow-top">').appendTo(this.options.parentElement),
        this.shadowBottom = $('<div class="sl-scroll-shadow-bottom">').appendTo(this.options.parentElement),
    ...
    layout: function() {
        ...
        n = this.options.headerElement ? this.options.headerElement.outerHeight() : 0; (this.options.footerElement || this.options.headerElement) && this.options.contentElement.css("height", t - e - n),
        this.sync()
    },
    sync: function() {
    ...
    renderSearchResults: function(t) {
        if ($(".search").removeClass("empty"), this.searchResults.show(), this.searchResultsList.empty(), this.renderSearchPagination(t), t.results && t.results.length) {
            ...
            for (var e = 0,
            n = t.results.length; n > e; e++) this.searchResultsList.append(SL.util.html.createDeckThumbnail(t.results[e]))
    ...
    renderSearchPagination: function(t) {
        ...
        this.searchPagination && this.searchPagination.remove(),
        e > 1 && (this.searchPagination = $('<div class="search-results-pagination"></div>').appendTo(this.searchResultsHeader), this.searchPagination.append('<span class="page">' + SL.locale.get("SEARCH_PAGINATION_PAGE") + " " + this.searchPage + "/" + e + "</span>"), this.searchPage > 1 && this.searchPagination.append('<button class="button outline previous">' + SL.locale.get("PREVIOUS") + "</button>"), this.searchPagination.append('<button class="button outline next">' + SL.locale.get("NEXT") + "</button>"), this.searchPagination.find("button.previous").on("click",
        function() {
            this.search(this.searchTerm, Math.max(this.searchPage - 1, 1))
        }.bind(this)), this.searchPagination.find("button.next").on("click",
        function() {
    ...
    search: function(t, e, n) {
        if (this.searchTerm = t || this.searchFormInput.val(), this.searchPage = e || 1, this.searchSort = n || this.searchSort, window.history && "function" == typeof window.history.replaceState) {
            ...
            e > 1 && (i += "&page=" + e),
            window.history.replaceState(null, null, "/explore" + i)
        }
        this.searchSort || (this.searchSort = this.searchResultsSorting.find("input[type=radio]:checked").val()),
        this.searchResultsSorting.find("input[type=radio]").prop("checked", !1),
        this.searchResultsSorting.find("input[type=radio][value=" + this.searchSort + "]").prop("checked", !0),
        this.searchTerm ? (this.searchFormLoader.start(), $.ajax({
            type: "GET",
            url: this.config.url,
            context: this,
            data: {
    ...
    renderTemplate: function(t, e) {
        ...
        n.html(['<div class="template-item-thumb themed">', '<div class="template-item-thumb-content reveal">', '<div class="slides">', t.get("html"), "</div>", '<div class="backgrounds"></div>', "</div>", "</div>"].join("")),
        n.data("data-template", t),
        n.on("vclick", this.onTemplateSelected.bind(this, n)),
        t.get("label") && n.append('<span class="template-item-label">' + t.get("label") + "</span>"),
        e.replaceTemplateAt ? this.bodyElement.find(".template-item").eq(e.replaceTemplateAt).replaceWith(n) : e.prepend ? this.bodyElement.prepend(n) : this.bodyElement.append(n);
        ...
        if (r.addClass(n.find(".template-item-thumb .reveal section").attr("class")), r.appendTo(n.find(".template-item-thumb .reveal>.backgrounds")), (i || s) && (i && r.css("background-color", i), s && r.css("background-image", 'url("' + s + '")'), o && r.css("background-size", o)), this.isEditable()) {
            ...
            a.attr("data-tooltip", "Delete this template"),
            a.on("vclick", this.onTemplateDeleteClicked.bind(this, n)),
            a.appendTo(n)
        }
    },
    refresh: function() {
        if (this.isDefaultTemplates()) {
            var t = SL.templates.DEFAULT_TEMPLATES_DUPLICATE_INDEX,
            e = this.options.templates.at(t);
            e && (e.set("html", SL.templates.templatize(Reveal.getCurrentSlide())), this.renderTemplate(e, {
                replaceTemplateAt: t
            }))
        }
        var n = SL.view.getCurrentTheme(),
        i = this.bodyElement.find(".template-item");
        if (i.length) i.each(function(t, e) {
            var i = $(e).find(".template-item-thumb");
            i.attr("class", i.attr("class").replace(/theme\-(font|color)\-([a-z0-9-])*/gi, "")),
            i.addClass("theme-font-" + n.get("font")),
            i.addClass("theme-color-" + n.get("color")),
            SL.templates.layoutTemplate(i.find("section"), !0)
        }),
        this.bodyElement.find(".placeholder").remove();
        else {
            var s = "You haven't saved any custom templates yet.";
            this.isTeamTemplates() && (s = "All templates that you save here will be made available to everyone in your team."),
            this.bodyElement.html('<p class="placeholder">' + s + "</p>")
        }
    },
    appendTo: function(t) {
    ...
    onTemplateSelected: function(t, e) {
        e.preventDefault(),
        this.templateSelected.dispatch(t.data("data-template"))
    },
    onTemplateDeleteClicked: function(t, e) {
        ...
        SL.prompt({
            ...
            },
            {
                ...
                className: "negative",
                callback: function() {
                    var e = t.data("data-template"),
                    n = SL.config.AJAX_SLIDE_TEMPLATES_DELETE(e.get("id"));
                    this.isTeamTemplates() && (n = SL.config.AJAX_TEAM_SLIDE_TEMPLATES_DELETE(e.get("id"))),
                    $.ajax({
                        type: "DELETE",
                        url: n,
                        context: this
    ...
    onTemplateCreateClicked: function() {
        ...
        return this.addTemplateButtonLoader.start(),
        $.ajax({
            type: "POST",
            url: t,
            context: this,
            ...
            SL.analytics.trackEditor(this.isTeamTemplates() ? "Saved team template": "Saved user template")
        }).fail(function() {
            this.addTemplateButtonLoader.stop(),
    ...
    renderTemplates: function() {
        ...
        this.renderPage("default", "Default", t),
        SL.templates.getUserTemplates(function(t) {
            this.renderPage("user", "User", t)
        }.bind(this)),
        SL.templates.getTeamTemplates(function(t) { (SL.current_user.isEnterpriseManager() || !t.isEmpty()) && this.renderPage("team", "Team", t)
        }.bind(this))
    },
    renderPage: function(t, e, n) {
        ...
        function() {
            this.showPage(t),
            SL.analytics.trackEditor("Slide templates tab clicked", t)
        }.bind(this)),
        i.appendTo(this.headerElement);
    ...
    showPage: function(t) {
        ...
        this.bodyElement.find('.page[data-page-id="' + t + '"]').addClass("present"),
        this.bodyElement.find('.page[data-page-id="' + t + '"]').prevAll().addClass("past"),
        this.bodyElement.find('.page[data-page-id="' + t + '"]').nextAll().addClass("future"),
        this.headerElement.find(".page-tab").removeClass("selected"),
        this.headerElement.find('.page-tab[data-page-id="' + t + '"]').addClass("selected")
    },
    ...
    layout: function() {
        ...
        i = Math.min(i, n - 2 * t),
        s = Math.min(s, n - 2 * t),
        this.options.anchor && (o.left = this.options.anchor.offset().left, o.top = this.options.anchor.offset().top, o.width = this.options.anchor.outerWidth(), o.height = this.options.anchor.outerHeight(), o.right = o.left + o.width, o.bottom = o.top + o.height);
        var r, a;
        this.options.anchor && "r" === this.options.alignment ? (i = Math.min(i, o.left - 2 * t), r = o.left - i - this.options.arrowSize - t, a = o.top + o.height / 2 - s / 2) : this.options.anchor && "b" === this.options.alignment ? (s = Math.min(s, o.top - 2 * t), r = o.left + o.width / 2 - i / 2, a = o.top - s - this.options.arrowSize - t) : this.options.anchor && "l" === this.options.alignment ? (i = Math.min(i, e - o.right - 2 * t), r = o.right + this.options.arrowSize + t, a = o.top + o.height / 2 - s / 2) : (r = (e - i) / 2, a = (n - s) / 2),
        this.innerElement.css({
            width: i,
            height: s,
            left: r,
    ...
    show: function(t) {
        ...
        0 === this.pages.length && this.renderTemplates(),
    ...
    init: function(t) {
        ...
        "string" == typeof this.options.value && this.setValue(this.options.value),
        SL.editor.controllers.Capabilities.isTouchEditor() || this.focusInput()
    },
    render: function() {
        this.domElement = $('<div class="sl-text-editor">').appendTo(document.body),
        this.innerElement = $('<div class="sl-text-editor-inner">').appendTo(this.domElement),
        this.domElement.attr("data-type", this.options.type),
        "html" === this.options.type ? this.renderHTMLInput() : this.renderTextInput(),
        this.footerElement = $(['<div class="sl-text-editor-footer">', '<button class="button l outline white cancel-button">Cancel</button>', '<button class="button l positive save-button">Save</button>', "</div>"].join("")).appendTo(this.innerElement),
        setTimeout(function() {
            this.domElement.addClass("visible")
        }.bind(this), 1)
    },
    renderTextInput: function() {
        this.inputElement = $('<textarea class="sl-text-editor-input">').appendTo(this.innerElement),
        "code" === this.options.type && this.inputElement.tabby({
            tabString: "    "
        })
    },
    renderHTMLInput: function() {
        this.inputElement = $('<div class="editor sl-text-editor-input">').appendTo(this.innerElement),
        this.codeEditor && "function" == typeof this.codeEditor.destroy && (this.codeEditor.destroy(), this.codeEditor = null);
        try {
            this.codeEditor = ace.edit(this.inputElement.get(0)),
            this.codeEditor.setTheme("ace/theme/monokai"),
            this.codeEditor.setDisplayIndentGuides(!0),
            this.codeEditor.setShowPrintMargin(!1),
    ...
    setValue: function(t) {
        ...
        this.codeEditor ? this.codeEditor.env.document.setValue(t) : this.inputElement.val(t)
    },
    getValue: function() {
    ...
    render: function() {
        this.domElement = $('<div class="sl-themeoptions">').appendTo(this.config.container),
        "string" == typeof this.config.className && this.domElement.addClass(this.config.className),
        this.config.themes && this.renderThemes(),
        (this.config.center || this.config.rollingLinks) && this.renderOptions(),
        this.config.colors && this.renderColors(),
        this.config.fonts && this.renderFonts(),
        this.config.transitions && this.renderTransitions(),
        this.config.backgroundTransitions && this.renderBackgroundTransitions()
    },
    renderThemes: function() {
        if (this.config.themes && !this.config.themes.isEmpty()) {
            ...
            e = t.find("ul");
            e.append(['<li data-theme="" class="custom">', '<span class="thumb-icon icon i-equalizer"></span>', '<span class="thumb-label">Custom</span>', "</li>"].join("")),
            this.config.themes.forEach(function(t) {
    ...
    renderBackgroundTransitions: function() {
        ...
        t.append('<h3>Background Transition <span class="icon i-info info-icon" data-tooltip="Background transitions apply when navigating to or from a slide that has a background image or color." data-tooltip-maxwidth="250"></span></h3>'),
        t.append("<ul>");
        var e = t.find("ul");
        ...
        this.domElement.find(".background-transition li").on("vclick", this.onBackgroundTransitionClicked.bind(this))
    },
    populate: function(t) {
        t && (this.theme = t, this.updateSelection(), this.toggleDeprecatedOptions(), this.scroll())
    },
    scroll: function() {
        var t = this.domElement.find(".background-transition li.selected").get(0),
        e = this.domElement.find(".transition li.selected").get(0),
        n = this.domElement.find(".color li.selected").get(0),
        i = this.domElement.find(".font li.selected").get(0);
        SL.util.dom.scrollIntoViewIfNeeded(t, !0),
        SL.util.dom.scrollIntoViewIfNeeded(e, !0),
        SL.util.dom.scrollIntoViewIfNeeded(n, !0),
        SL.util.dom.scrollIntoViewIfNeeded(i, !0),
        this.domElement.scrollTop(0)
    },
    updateSelection: function() {
        this.config.themes && !this.config.themes.isEmpty() && this.domElement.toggleClass("using-theme", this.theme.has("id")),
        this.config.center && this.domElement.find("#theme-center").prop("checked", 1 == this.theme.get("center")),
        this.config.rollingLinks && this.domElement.find("#theme-rolling_links").prop("checked", 1 == this.theme.get("rolling_links")),
        this.domElement.find(".theme li").removeClass("selected"),
        this.domElement.find(".theme li[data-theme=" + this.theme.get("id") + "]").addClass("selected"),
        0 !== this.domElement.find(".theme li.selected").length || this.theme.has("id") || this.domElement.find('.theme li[data-theme=""]').addClass("selected"),
        this.domElement.find(".color li").removeClass("selected"),
        this.domElement.find(".color li[data-color=" + this.theme.get("color") + "]").addClass("selected"),
        this.domElement.find(".font li").removeClass("selected"),
        this.domElement.find(".font li[data-font=" + this.theme.get("font") + "]").addClass("selected"),
        this.domElement.find(".font li").each(function(t, e) {
            SL.util.html.removeClasses(e,
            function(t) {
        ...
        this.domElement.find(".transition li[data-transition=" + this.theme.get("transition") + "]").addClass("selected"),
        this.domElement.find(".background-transition li").removeClass("selected"),
        this.domElement.find(".background-transition li[data-background-transition=" + this.theme.get("background_transition") + "]").addClass("selected")
    },
    ...
    toggleDeprecatedOptions: function() {
        this.domElement.find(".transition .deprecated").toggle(this.theme.isTransitionDeprecated()),
        this.domElement.find(".background-transition .deprecated").toggle(this.theme.isBackgroundTransitionDeprecated())
    },
    getTheme: function() {
        return this.theme
    },
    ...
    onOptionChanged: function() {
        this.theme.set("center", this.domElement.find("#theme-center").is(":checked")),
        this.theme.set("rolling_links", this.domElement.find("#theme-rolling_links").is(":checked")),
        this.updateSelection(),
        this.applySelection(),
        this.changed.dispatch()
    },
    onColorClicked: function(t) {
        ...
        $(t.currentTarget).is("[data-pro]") ? void window.open("/pricing") : (this.theme.set("color", $(t.currentTarget).data("color")), this.updateSelection(), this.applySelection(), SL.analytics.trackTheming("Color option selected", this.theme.get("color")), void this.changed.dispatch())
    },
    onFontClicked: function(t) {
        t.preventDefault(),
        this.theme.set("font", $(t.currentTarget).data("font")),
        this.updateSelection(),
        this.applySelection(),
    ...
    onTransitionClicked: function(t) {
        t.preventDefault(),
        this.theme.set("transition", $(t.currentTarget).data("transition")),
        this.updateSelection(),
        this.applySelection(),
    ...
    onBackgroundTransitionClicked: function(t) {
        t.preventDefault(),
        this.theme.set("background_transition", $(t.currentTarget).data("background-transition")),
        this.updateSelection(),
        this.applySelection(),
        SL.analytics.trackTheming("Background transition option selected", this.theme.get("background_transition")),
        this.changed.dispatch()
    },
    destroy: function() {
        this.changed.dispose(),
    ...
    function t() {
        r = $("<div>").addClass("sl-tooltip"),
        a = $('<p class="sl-tooltip-inner">').appendTo(r),
        l = $('<div class="sl-tooltip-arrow">').appendTo(r),
        c = $('<div class="sl-tooltip-arrow-fill">').appendTo(l),
        e()
    }
    function e() {
        i = i.bind(this),
        ...
        function(t) {
            ...
            if (!e.is("[no-tooltip]")) {
                ...
                r = e.attr("data-tooltip-alignment"),
                a = e.attr("data-tooltip-maxwidth"),
                l = e.attr("data-tooltip-maxheight"),
                c = e.attr("data-tooltip-ox"),
                u = e.attr("data-tooltip-oy"),
                d = e.attr("data-tooltip-x"),
                ...
                if (i) {
                    var p = {
                        ...
                        alignment: r,
                        delay: parseInt(s, 10),
                        maxwidth: parseInt(a, 10),
                        maxheight: parseInt(l, 10)
                    };
                    c && (p.ox = parseFloat(c)),
                    u && (p.oy = parseFloat(u)),
                    d && h && (p.x = parseFloat(d), p.y = parseFloat(h), p.anchor = null),
                    n(i, p)
                }
            }
    ...
    function n(t, e) {
        if (!SL.util.device.IS_PHONE && !SL.util.device.IS_TABLET) {
            ...
            clearTimeout(p);
            var s = Date.now() - f;
            if ("number" == typeof u.delay && s > 500) return p = setTimeout(n.bind(this, t, u), u.delay),
            void delete u.delay;
            r.css("opacity", 0),
            r.appendTo(document.body),
            a.html(t),
            r.css("max-width", u.maxwidth ? u.maxwidth: null),
            r.css("max-height", u.maxheight ? u.maxheight: null),
            u.align && r.css("text-align", u.align),
            i(),
            r.stop(!0, !0).animate({
                opacity: 1
            },
    ...
    function i() {
        ...
        if (t.length) {
            ...
            o.x = o.left,
            o.y = o.top,
            u.anchor.parents(".reveal .slides").length && "undefined" != typeof window.Reveal && (o = SL.util.getRevealElementGlobalOffset(u.anchor));
            var c = t.outerWidth(),
            p = t.outerHeight(),
            f = a.outerWidth(),
            m = a.outerHeight(),
            ...
            g = Math.min(Math.max(g, n), window.innerWidth - f - n),
            v = Math.min(Math.max(v, n), window.innerHeight - m - n);
            var S = d + 3;
            switch (e) {
            case "t":
                y = o.x - g - i + c / 2,
                b = m,
                y = Math.min(Math.max(y, S), f - S);
                break;
            case "b":
                y = o.x - g - i + c / 2,
                b = -d,
    ...
    return t(),
    {
        ...
        anchorTo: function(t, e, n) {
            var i = {};
            "undefined" != typeof e && (i["data-tooltip"] = e),
            "number" == typeof n.delay && (i["data-tooltip-delay"] = n.delay),
            "string" == typeof n.alignment && (i["data-tooltip-alignment"] = n.alignment),
            $(t).attr(i)
        }
    }
    ...
    render: function() {
        ...
        this.nextButton = $('<button class="button no-transition positive l sl-tutorial-next">Next</button>'),
    ...
    step: function(t) {
        if (this.index < t) {
            ...
            for (this.index + 1 === this.options.steps.length && (this.skipButton.show(), this.nextButton.text("Next"), this.domElement.removeClass("last-step")); this.index > t;) this.options.steps[this.index].backwards.call(this.options.context),
            this.index -= 1;
            this.options.steps[this.index].forwards.call(this.options.context)
        }
    ...
    layout: function() {
        ...
        if (this.messageElement.is(":visible")) {
            ...
            if (this.messageOptions.anchor && this.messageOptions.alignment) {
                ...
                r = this.messageOptions.anchor.outerWidth(),
                a = this.messageOptions.anchor.outerHeight();
    ...
    onKeyDown: function(t) {
        return 37 === t.keyCode || 8 === t.keyCode ? this.prev() : (39 === t.keyCode || 32 === t.keyCode) && this.next(),
        !1
    },
    ...
    handleFeedback: function() {
        ...
        function(t) {
            ...
            s && s.length && (n.contact_title = s),
            UserVoice.push(["show", n]),
            t.preventDefault()
        })
    },
    ...
    handleAutoRefresh: function() {
        var t = SL.util.getQuery();
        if (t && t.autoRefresh) {
            var e = parseInt(t.autoRefresh, 10); ! isNaN(e) && e > 0 && setTimeout(function() {
    ...
    init: function() {
        ...
        "hidden" !== t || SL.current_deck.isPro() || (t = null),
        t && $("html").attr("data-embed-style", t),
        Modernizr.fullscreen === !1 && this.footerElement.find(".fullscreen").hide(),
        this.layout()
    },
    layout: function() {
        this.revealElement.height(this.footerElement.is(":visible") ? window.innerHeight - $(".embed-footer").height() : "100%"),
        Reveal.layout()
    },
    ...
    render: function() {
        ...
        n = t.thumbnail_url;
        this.summaryBubble = $(['<a class="summary-bubble" href="' + e + '" target="_blank">', '<div class="summary-bubble-picture" style="background-image: url(' + n + ')"></div>', '<div class="summary-bubble-content"></div>', "</a>"].join("")).appendTo(document.body),
    ...
    expandSummary: function(t) {
        ...
        "number" == typeof t && (this.collapseSummaryTimeout = setTimeout(this.collapseSummary.bind(this), t))
    },
    expandSummaryError: function() {
        this.summaryBubbleError = !0,
        this.expandSummary()
    },
    ...
    setPresentControls: function(t) {
        "boolean" != typeof t && (upsizing = SL.config.PRESENT_CONTROLS_DEFAULT),
        this.summaryBubble.toggle(t)
    },
    setPresentUpsizing: function(t) {
        "boolean" != typeof t && (upsizing = SL.config.PRESENT_UPSIZING_DEFAULT),
        Reveal.configure({
    ...
    onStreamStateChanged: function(t) {
        t && "boolean" == typeof t.present_controls && this.setPresentControls(t.present_controls),
        t && "boolean" == typeof t.present_upsizing && this.setPresentUpsizing(t.present_upsizing)
    },
    ...
    render: function() {
        ...
        this.presentationControls.find(".fullscreen-toggle").on("click", this.onFullscreenToggled.bind(this)),
        this.presentationControls.find(".controls-toggle").on("click", this.onControlsToggled.bind(this)),
        this.presentationControls.find(".upsizing-toggle").on("click", this.onUpsizingToggled.bind(this)),
        this.presentationControls.find(".button.start-presentation").on("click", this.onStartPresentationClicked.bind(this)),
        $(document).on("webkitfullscreenchange mozfullscreenchange fullscreenchange", this.onFullscreenChange.bind(this)),
    ...
    init: function() {
        this._super(),
        this.summaryBubble = $(".summary-bubble"),
        SL.util.setupReveal({
            history: !0,
            embedded: !0,
            pause: !1,
        ...
        this.hideSummaryTimeout = setTimeout(this.hideSummary.bind(this), 8e3),
        $("header .deck-promotion").length && $("header").addClass("extra-wide"),
        Modernizr.fullscreen === !1 && $(".deck-options .fullscreen-button").hide(),
        this.bind(),
        this.layout()
    },
    bind: function() {
        ...
        $(".deck-options .comment-button").on("click", this.onCommentsClicked.bind(this)),
        ...
        this.summaryBubble.on("click", this.hideSummary)
    },
    ...
    hideSummary: function() {
        this.summaryBubble && (this.summaryBubble.removeClass("visible"), this.summaryBubble.on("transitionend",
        function() {
            $(this).remove()
    ...
    layout: function() {
        ...
        e.length && t.length && (n.marginLeft = t.offset().left + t.outerWidth() - 10),
        e.css(n)
    },
    saveVisibility: function(t) {
        ...
        $.ajax(e).done(function(t) {
            ...
            "string" == typeof t.deck.slug && SL.current_deck.set("slug", t.deck.slug),
            "string" == typeof t.deck.visibility && SL.current_deck.set("visibility", t.deck.visibility)
        }).fail(function() {
            SL.notify(SL.locale.get("DECK_VISIBILITY_CHANGED_ERROR"), "negative")
        })
    },
    onShareClicked: function() {
        return "undefined" != typeof SLConfig && "string" == typeof SLConfig.deck.user.username && "string" == typeof SLConfig.deck.slug ? SL.modal.open("share-deck", SLConfig.deck) : SL.notify(SL.locale.get("GENERIC_ERROR"), "negative"),
    ...
    onForkClicked: function() {
        return SL.analytics.trackPresenting("Fork clicked"),
        $.ajax({
            type: "POST",
    ...
    onSlideChanged: function(t) {
        this.hideSummary();
        var e = "#";
        t.indexh && (e += "/" + t.indexh, t.indexv && (e += "/" + t.indexv)),
        this.editButton.attr("href", this.editButtonOriginalLink + e)
    },
    onWindowScroll: function() {
    ...
    setup: function() {
        ...
        function() {
            ...
            this.upcomingFrame.length && (this.upcomingReveal = this.upcomingFrame.get(0).contentWindow.Reveal, this.upcomingReveal.configure({
                history: !1,
                controls: !1,
                progress: !1,
                overview: !1,
            ...
            }), this.upcomingReveal.addEventListener("slidechanged", this.onUpcomingSlideChanged.bind(this)), this.upcomingFrame.get(0).contentWindow.document.body.className += " no-transition"),
            this.setupTimer(),
            this.setupTouch(),
            this.stream = new SL.helpers.StreamLive({
    ...
    syncTimer: function() {
        ...
        n = t.format("mm") + ":",
        i = t.format("ss");
        "00:" === e && (e = '<span class="dim">' + e + "</span>", "00:" === n && (n = '<span class="dim">' + n + "</span>")),
        this.timeTimerValue.html(e + n + i)
    },
    ...
    syncTouchControls: function() {
        if (this.touchControls) {
            ...
            n += $(".reveal .slides>section.present").prevAll("section").find(">section:gt(0)").length,
            n += 1,
            this.touchControlsSlideNumber.html(n + "/" + e)
        }
    },
    ...
    setupForm: function() {
        if (this.formElement = $("form"), this.formElement.length) {
            ...
            t.length && this.formElement.on("submit",
            function(e) {
                if (!e.isDefaultPrevented()) if ($(".g-recaptcha").length && "undefined" != typeof window.grecaptcha && "function" == typeof window.grecaptcha.getResponse) {
                    if (!grecaptcha.getResponse()) return SL.notify("Please answer the reCAPTCHA to prove you're not a robot"),
                    e.preventDefault(),
                    !1
                } else Ladda.create(t.get(0)).start()
            }.bind(this))
        }
    }
    ...
    setupVideo: function() { (SL.util.device.IS_PHONE || SL.util.device.IS_TABLET) && $(".features .features-item-figure").each(function() {
            var t = $(this),
        ...
        $(".features video").each(function(t, e) {
            ...
            e.find("span[data-src]").each(function(t, e) {
                e = $(e),
                n += '<source src="' + e.attr("data-src") + '" type="' + e.attr("data-type") + '">'
            }),
            n && e.html(n)
        })
    },
    bind: function() {
        ...
        SL.util.device.IS_PHONE || SL.util.device.IS_TABLET || (this.updateFeatureAnimations = $.debounce(this.updateFeatureAnimations, 300), $(window).on("resize", this.onWindowResize.bind(this)), $(window).on("scroll", this.onWindowScroll.bind(this))),
    ...
    trackScrolling: function() {
        ...
        i > .1 && !this.scrollTracking[.1] && (this.scrollTracking[.1] = !0, SL.analytics.track("Home: Scrolled", "10%")),
        i > .5 && !this.scrollTracking[.5] && (this.scrollTracking[.5] = !0, SL.analytics.track("Home: Scrolled", "50%")),
        i > .95 && !this.scrollTracking[.95] && (this.scrollTracking[.95] = !0, SL.analytics.track("Home: Scrolled", "100%"))
    },
    updateFeatureAnimations: function() {
        ...
        this.activeFeature && !this.activeFeature.is(t) && this.stopFeatureAnimation(),
        t && !t.hasClass("playing") && (this.activeFeature = t, this.startFeatureAnimation())
    },
    startFeatureAnimation: function() {
        if (this.activeFeature.addClass("playing"), this.activeFeature.is(".video-wrapper")) this.activeFeature.find("video").get(0).play();
            ...
            n = 1;
            this.activeFeature.attr("data-animation-step", n),
    ...
    setupTier: function(t, e) {
        var e = $(e),
        n = e.find(".cta a");
        n.length && !n.hasClass("disabled") && (e.on("click",
        function(t) {
            t.preventDefault(),
    ...
    init: function() {
        ...
        $("html").hasClass("subscriptions new") && ($('input[name="subscription[billing_period]"]').on("change", this.syncSubmitButton.bind(this)), this.syncSubmitButton())
    },
    syncSubmitButton: function() {
        ...
        0 === i.length && (i = $('<div class="devise-note">').insertAfter(this.formElement.find(".actions"))),
        e && n ? i.html("You are starting a <strong>" + e + "</strong> subscription and will be charged <strong>$" + n + "</strong> today.") : i.remove()
    },
    onFormSubmit: function(t) {
        return this.formSubmitLoader.start(),
        Stripe.createToken(this.formElement, this.onStripeResponse),
        t.preventDefault(),
        !1
    },
    onStripeResponse: function(t, e) {
        if (e.error) SL.notify(e.error.message, "negative"),
        this.formSubmitLoader.stop();
        else {
            var n = e.id;
            this.formElement.find('input[name="subscription[token]"]').remove(),
            this.formElement.append($('<input type="hidden" name="subscription[token]" />').val(n)),
    ...
    renderDetails: function() {
        ...
        if (e) {
            ...
            t.append('<footer class="actions"><a class="button s outline" href="' + SL.routes.SUBSCRIPTIONS_EDIT_CARD + '">Change credit card</a><button class="button s negative outline cancel-subscription ladda-button" data-style="expand-right" data-spinner-color="#222">' + this.strings.CONFIRM_UNSUBSCRIBE_ACTION + "</button></footer>"),
            this.data.get("can_change_period") && t.find(".actions").prepend('<a class="button s outline" href="' + SL.routes.SUBSCRIPTIONS_EDIT_PERIOD + '">Change billing period</a>')
        } else {
            var s = moment.unix(this.data.get("subscription.current_period_end")).format("MMM Do, YYYY");
            t.append('<div class="field status"><span class="label">Status</span><span class="value">Pro until ' + s + "</span></div>"),
            t.append('<footer class="actions"><a class="button s outline positive" href="' + SL.routes.SUBSCRIPTIONS_NEW + '">Return to Pro</a></footer>')
        }
    ...
    renderHistory: function() {
        ...
        if (this.data.get("can_toggle_notifications") === !0) {
            ...
            n.on("change", this.onEmailNotificationChanged.bind(this)),
            SL.current_user.notify_on_receipt && n.prop("checked", !0)
        }
        ...
        i && i.length ? i.forEach(function(t) {
            ...
            n.appendTo(e),
            SL.util.dom.insertCSRF(n.find(".download form"))
    ...
    onEmailNotificationChanged: function(t) {
        ...
        this.emailNotificationXHR = $.ajax({
            ...
            data: {
                user: {
                    notify_on_receipt: $(t.currentTarget).is(":checked")
                }
            }
        }).done(function() {
    ...
    submitToApp: function(t) {
        this.formData.subscription.token = t,
        $.ajax({
            type: "POST",
            ...
            e && e.user && e.user.email && e.user.email.length ? SL.notify("Email error: " + e.user.email[0], "negative") : SL.notify(SL.locale.get("GENERIC_ERROR"), "negative"),
            this.formSubmitLoader.stop()
        })
    },
    onStripeResponse: function(t, e) {
    ...
    load: function() {
        $.ajax({
            ...
            this.userData = new SL.models.Collection,
            this.userLimit = t.max,
    ...
    renderTable: function(t) {
        if (this.userData.isEmpty()) t.html('<p class="empty-notice">' + SL.locale.get("ORG_USERS_LIST_EMPTY") + "</p>");
            ...
            e.append('<tr><th class="name">Name</th><th class="username">Username</th><th class="email">Email</th><th class="actions">Actions</th></tr>'),
    ...
    renderUser: function(t) {
        ...
        if (e.append("<td>" + n + (t.name || "N/A") + "</td>"), e.append('<td><a href="/' + t.username + '" target="_blank">' + t.username + "</a></td>"), e.append("<td>" + t.email + "</td>"), SL.current_user.username && SL.current_user.username !== t.username) {
            var i = $("<td>");
            i.append('<button class="button outline ladda-button remove-user" data-style="zoom-out" data-spinner-color="#222" data-tooltip="Remove this user from the team"><span class="i-trash-stroke"></span></button>'),
            t.registered || (i.append('<button class="button outline ladda-button welcome-user" data-style="zoom-out" data-spinner-color="#222" data-tooltip="Re-send invite email"><span class="i-mail"></span></button>'), e.addClass("disabled")),
            e.append(i),
            e.find(".welcome-user").on("click",
            function(n) {
                this.welcomeUser(n, t, e)
            }.bind(this)),
            e.find(".remove-user").on("click",
            function(n) {
                this.removeUser(n, t, e)
            }.bind(this))
        } else e.append("<td></td>");
        e.appendTo(this.domElement.find("table")),
        this.bindLadda()
    },
    syncInviteForm: function() {
        $(".team-is-full-notice").remove(),
        this.isTeamFull() && $(".create-user-form").append('<div class="team-is-full-notice"><h4>This team is full</h4><p>To add new members please <a href="mailto:support@slides.com" data-feedback-mode="contact" data-feedback-screenshot_enabled="false">contact support</a>.</p></div>')
    },
    createUser: function() {
        if (this.isTeamFull()) return SL.notify("Your team is full, please contact support"),
        !1;
        ...
        $.ajax({
            ...
            this.userData.isEmpty() ? (this.userData.push(i), this.render()) : (this.userData.push(i), this.renderUser(i)),
            t.find("[name=email]").val(""),
            t.find("[name=username]").val(""),
            this.syncInviteForm(),
            e && e.stop(),
            SL.notify(SL.locale.get("ORG_USERS_INVITE_SEND_SUCCESS"))
        }).fail(function(t) {
            t = $.parseJSON(t.responseText) || {},
            e && e.stop(),
            "object" == typeof t.email && t.email.length ? SL.notify("Email error: " + t.email[0], "negative") : "object" == typeof t.username && t.username.length ? SL.notify("Username error: " + t.username[0], "negative") : SL.notify("Failed to add user", "negative")
        })
    },
            ...
            },
            {
                ...
                callback: function() {
                    ...
                    $.ajax({
                        ...
                        this.syncInviteForm(),
                        t && t.stop(),
                        SL.notify(SL.locale.get("ORG_USERS_REMOVE_SUCCESS"))
                    }).fail(function() {
                        t && t.stop(),
                        SL.notify(SL.locale.get("ORG_USERS_REMOVE_ERROR"), "negative")
                    })
                }.bind(this)
            }]
        })
    ...
    welcomeUser: function(t, e, n) {
        ...
        $.ajax({
            ...
            i && i.stop(),
            SL.notify(SL.locale.get("ORG_USERS_INVITE_SEND_ERROR"), "negative")
        })
    },
    isTeamFull: function() {
    ...
    init: function() {
        this._super(),
        this.themeData = new SL.models.Collection,
    ...
    load: function() {
        SL.helpers.PageLoader.show("Loading themes..."),
        $.ajax({
            type: "GET",
    ...
    editTheme: function(t) {
        if (this.panel) return this.panel.close(function() {
            this.editTheme(t)
        }.bind(this)),
        !1;
    ...
    createTheme: function() {
        $.ajax({
            ...
            this.themeData.isEmpty() ? (this.themeData.push(e), this.renderList(), this.makeDefaultTheme(e, null, !0)) : (this.themeData.push(e), this.renderListItem(e), SL.view.parseTimes()),
            this.editTheme(e)
        }).fail(function() {
            ...
            },
            {
                ...
                callback: function() {
                    ...
                    $.ajax({
                        ...
                        SL.util.anim.collapseListItem(i,
                        function() {
                            i.remove()
                        }),
                        SL.util.callback(e),
                        ...
                        this.panel && this.panel.getTheme().get("id") === n && this.panel.destroy(),
    ...
    makeDefaultTheme: function(t, e, n) {
        $.ajax({
            ...
            this.updateListDefault(),
            n || SL.notify(SL.locale.get("THEME_DEFAULT_SAVE_SUCCESS")),
            SL.util.callback(e)
        }).fail(function() {
    ...
    bind: function() {
        this.documentationLinkElement.on("click", this.onDocumentationLinkClicked.bind(this)),
    ...
    onDocumentationLinkClicked: function(t) {
        ...
        this.documentationLinkElement.text(this.documentationElement.is(":visible") ? "Less info": "More info")
    },
    ...
    onDocumentMouseMove: function(t) {
        ...
        n = Math.max(Math.min(n, this.listWidth - this.listItemSize), 0),
        i = Math.max(Math.min(i, this.listHeight - this.listItemSize), 0),
        this.dragGhost.css({
            left: n,
            top: i
        });
    ...
    validateSnippet: function(t) {
        ...
        if (s && o) i.push("Templates can not mix variables and selection tags.");
            ...
            n.push("Found " + r.length + " variables:"),
    ...
    previewSnippet: function(t) {
        ...
        n = e.$("#snippet-slide");
        0 === n.length && (n = $('<section id="snippet-slide">').appendTo(e.$(".reveal .slides"))),
        n.html(['<div class="sl-block" data-block-type="html" style="width: 100%; left: 0; top: 0; height: auto;">', '<div class="sl-block-content">', t.templatize(t.getTemplateVariables()), "</div>", "</div>"].join("")),
        e.SL.util.skipCSSTransitions(),
        e.Reveal.sync(),
        e.Reveal.slide(n.index())
    },
    ...
    onSnippetChange: function(t) {
        ...
        if (e.length) {
            ...
            if (s.length > 0) return SL.notify("Scripts are not allowed. Please remove all script tags for this snippet to save.", "negative"),
            !1;
            var o = e.data("model");
            o.set("title", n),
            o.set("template", i),
    ...
    renderPages: function() {
        this.PAGES.forEach(function(t) { ("function" != typeof t.condition || t.condition.call(this)) && ($('<button class="page-tab" data-page-id="' + t.id + '">' + t.name + "</button>").on("click", this.showPage.bind(this, t.id)).appendTo(this.tabsElement), this[t.factory]())
        }.bind(this))
    },
    renderSettings: function() {
        this.settingsElement = $('<div class="page sl-form" data-page-id="settings">').appendTo(this.pagesElement),
    ...
    renderCSS: function() {
        this.cssElement = $('<div class="page" data-page-id="css">').appendTo(this.pagesElement),
        this.cssElement.append('<div class="editor-wrapper"><div id="ace-less" class="editor"></div><div class="error"></div><div class="info" data-tooltip="' + SL.locale.get("THEME_CSS_DESCRIPTION") + '" data-tooltip-maxwidth="300" data-tooltip-align="left"><span class="icon i-info"></span></div></div>'),
        this.cssErrorElement = this.cssElement.find(".error");
        try {
            this.cssEditor = ace.edit("ace-less"),
            this.cssEditor.setTheme("ace/theme/monokai"),
            this.cssEditor.setDisplayIndentGuides(!0),
            this.cssEditor.setShowPrintMargin(!1),
            this.cssEditor.getSession().setMode("ace/mode/less"),
            this.cssEditor.env.document.setValue(this.theme.get("less") || ""),
            this.cssEditor.env.editor.on("change", this.onCSSInputChanged.bind(this)),
            this.syncCSS()
        } catch(t) {
    ...
    syncCSS: function() {
        ...
        t = e.length ? "Found custom slide classes:<br>- " + e.join("<br>- ") + "<br><br>" + SL.locale.get("THEME_CSS_DESCRIPTION") : SL.locale.get("THEME_CSS_DESCRIPTION"),
        this.cssElement.find(".info").toggleClass("positive", e.length > 0),
        this.cssElement.find(".info").attr("data-tooltip", t)
    },
    renderHTML: function() {
        this.htmlElement = $('<div class="page" data-page-id="html">').appendTo(this.pagesElement),
        this.htmlElement.append('<div class="editor-wrapper"><div id="ace-html" class="editor"></div>', '<div class="info" data-tooltip="' + SL.locale.get("THEME_HTML_DESCRIPTION") + '" data-tooltip-maxwidth="300" data-tooltip-align="left"><span class="icon i-info"></span></div></div>');
        try {
            this.htmlEditor = ace.edit("ace-html"),
            this.htmlEditor.setTheme("ace/theme/monokai"),
            this.htmlEditor.setDisplayIndentGuides(!0),
            this.htmlEditor.setShowPrintMargin(!1),
            this.htmlEditor.getSession().setMode("ace/mode/html"),
            this.htmlEditor.env.document.setValue(this.theme.get("html") || ""),
            this.htmlEditor.env.editor.on("change", this.onHTMLInputChanged.bind(this))
        } catch(t) {
            console.log("An error occurred while initializing the Ace HTML editor.")
        }
    },
    renderJS: function() {
        this.jsElement = $('<div class="page" data-page-id="js">').appendTo(this.pagesElement),
        this.jsElement.append('<div class="editor-wrapper"><div id="ace-js" class="editor"></div>', '<div class="info" data-tooltip="' + SL.locale.get("THEME_JS_DESCRIPTION") + '" data-tooltip-maxwidth="300" data-tooltip-align="left"><span class="icon i-info"></span></div></div>');
        try {
            this.jsEditor = ace.edit("ace-js"),
            this.jsEditor.setTheme("ace/theme/monokai"),
            this.jsEditor.setDisplayIndentGuides(!0),
            this.jsEditor.setShowPrintMargin(!1),
            this.jsEditor.getSession().setMode("ace/mode/javascript"),
            this.jsEditor.env.document.setValue(this.theme.get("js") || ""),
            this.jsEditor.env.editor.on("change", this.onJSInputChanged.bind(this))
        } catch(t) {
            console.log("An error occurred while initializing the Ace JS editor.")
        }
    },
    renderPalette: function() {
        this.palette = new SL.views.themes.edit.pages.Palette(this.editor, this.theme),
        this.palette.appendTo(this.pagesElement),
        this.palette.changed.add(this.checkUnsavedChanges.bind(this))
    },
    renderSnippets: function() {
        this.snippets = new SL.views.themes.edit.pages.Snippets(this.editor, this.theme),
    ...
    showPage: function(t) {
        ...
        "css" === t && this.cssEditor ? this.cssEditor.focus() : "html" === t && this.htmlEditor ? this.htmlEditor.focus() : "js" === t && this.jsEditor ? this.jsEditor.focus() : "palette" === t && this.palette && this.palette.refresh(),
        setTimeout(function() {
    ...
    preprocess: function(t, e) {
        ...
        this.cssEditor && this.theme.set("less", this.cssEditor.env.document.getValue()),
        this.htmlEditor && this.theme.set("html", this.htmlEditor.env.document.getValue()),
        this.jsEditor && this.theme.set("js", this.jsEditor.env.document.getValue()),
        this.cssParser || (this.cssParser = new less.Parser);
        var n = this.cssEditor.env.document.getValue();
        n ? this.cssParser.parse(".reveal { " + n + " }",
        function(i, s) {
            if (i) this.cssErrorElement.addClass("visible"),
            this.cssErrorElement.html(i.message),
            SL.util.callback(e, i);
            else {
                ...
                if (o) {
                    ...
                    o = a + o,
                    this.theme.set("less", n),
                    this.theme.set("css", o),
                    SL.util.callback(t)
                } else SL.util.callback(e)
            }
            this.checkUnsavedChanges()
        }.bind(this)) : (this.theme.set("less", ""), this.theme.set("css", ""), SL.util.callback(t)),
        this.checkUnsavedChanges()
    },
    ...
    onDocumentKeyDown: function(t) { (t.metaKey || t.ctrlKey) && 83 === t.keyCode && (this.hasUnsavedChanges() && this.save(), t.preventDefault())
    },
    destroy: function() {
        this.isDestroyed || (this.isDestroyed = !0, clearTimeout(this.previewTimeout), this.destroyed.dispatch(), this.destroyed.dispose(), $(document).off("keydown", this.onDocumentKeyDown), setTimeout(function() {
            this.cssEditor && (this.cssEditor.destroy(), this.cssEditor = null),
            this.htmlEditor && (this.htmlEditor.destroy(), this.htmlEditor = null),
            this.jsEditor && (this.jsEditor.destroy(), this.jsEditor = null),
    ...
    init: function() {
        ...
        $(".decks .deck").each(function(t, e) {
            ...
            e.find(".lock-icon").on("vclick", this.onVisibilityClicked.bind(this, e)),
            e.find(".visibility").on("vclick", this.onVisibilityClicked.bind(this, e)),
            e.hasClass("is-owner") && (e.find(".deck-title-value").attr({
    ...
    showAnnouncement: function() {
        if (Modernizr.localstorage && SL.current_user.isEnterpriseManager() && SL.current_team && SL.current_team.get("beta_new_editor") === !1) {
            ...
            if (!localStorage.getItem(t)) {
                ...
                e.find(".dismiss-button").on("click",
                function() {
                    e.remove(),
    ...
    getDeckData: function(t) {
        return {
            ...
            access_token: t.attr("data-access_token"),
    ...
    saveVisibility: function(t, e) {
        ...
        $.ajax(i).done(function(e) {
            ...
            "string" == typeof e.deck.slug && t.attr("data-slug", e.deck.slug),
            "string" == typeof e.deck.visibility && t.attr("data-visibility", e.deck.visibility)
        }).fail(function() {
            SL.notify(SL.locale.get("DECK_VISIBILITY_CHANGED_ERROR"), "negative")
        }).always(function() {
            s && s.stop(),
    ...
    onEditClicked: function(t, e) {
        e.preventDefault(),
        window.location = t.attr("data-url") + "/edit"
    },
            ...
            },
            {
                ...
                callback: function() {
                    ...
                    $.ajax({
                        ...
                        SL.util.anim.collapseListItem(t,
                        function() {
                            e && e.stop(),
                            t.remove()
                        }.bind(this)),
    ...
    onShareClicked: function(t, e) {
        e.preventDefault();
        var n = this.getDeckData(t);
        return "string" != typeof n.user.username || "string" != typeof n.slug && "string" != typeof n.id ? SL.notify(SL.locale.get("GENERIC_ERROR"), "negative") : SL.modal.open("share-deck", n),
        !1
    },
