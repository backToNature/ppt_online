...
(function() {
		...
		var a = {
			...
			domReady: function() {
				...
				return function(d) {
					...
					if (1 == f.length) if (document.addEventListener) document.addEventListener("DOMContentLoaded", a, !1),
	...
	CKEDITOR.event.prototype = function() {
		...
		b.prototype = {
			getListenerIndex: function(a) {
				for (var d = 0,
				f = this.listeners; d < f.length; d++) if (f[d].fn == a) return d;
				return - 1
			}
		};
		return {
	...
	CKEDITOR.dom = {}; (function() {
		...
		CKEDITOR.tools = {
			...
			indexOf: function(a, d) {
				if (typeof d == "function") for (var f = 0,
				b = a.length; f < b; f++) {
					if (d(a[f])) return f
				} else {
			...
			createClass: function(a) {
				...
				if (f) {
					d.prototype = this.prototypedCopy(f.prototype);
			...
			normalizeCssText: function(a, d) {
				var f = [],
				b,
				g = CKEDITOR.tools.parseCssText(a, true, d);
			...
			enableHtml5Elements: function(a, d) {
				for (var f = ["abbr", "article", "aside", "audio", "bdi", "canvas", "data", "datalist", "details", "figcaption", "figure", "footer", "header", "hgroup", "mark", "meter", "nav", "output", "progress", "section", "summary", "time", "video"], b = f.length, g; b--;) {
			...
			checkIfAnyArrayItemMatches: function(a, d) {
				for (var f = 0,
				b = a.length; f < b; ++f) if (a[f].match(d)) return true;
				return false
			},
	...
	CKEDITOR.dom.element.clearMarkers = function(a, e, b) {
		...
		function b(a) {
			for (var f = 0,
			b = 0,
			e = c[a].length; b < e; b++) f = f + (parseInt(this.getComputedStyle(c[a][b]) || 0, 10) || 0);
			return f
		}
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			append: function(a, f) {
				...
				f ? this.$.insertBefore(a.$, this.$.firstChild) : this.$.appendChild(a.$);
				return a
			},
			...
			getFirst: function(a) {
				var f = this.$.firstChild; (f = f && new CKEDITOR.dom.node(f)) && (a && !a(f)) && (f = f.getNext(a));
				return f
			},
			getLast: function(a) {
				var f = this.$.lastChild; (f = f && new CKEDITOR.dom.node(f)) && (a && !a(f)) && (f = f.getPrevious(a));
				return f
			},
			getStyle: function(a) {
			...
			is: function() {
				...
				for (var f = 0; f < arguments.length; f++) if (arguments[f] == a) return true;
				return false
			},
			...
			isEmptyInlineRemoveable: function() {
				...
				for (var a = this.getChildren(), f = 0, b = a.count(); f < b; f++) {
					var c = a.getItem(f);
			...
			moveChildren: function(a, f) {
				...
				if (b != a) {
					var c;
					if (f) for (; c = b.lastChild;) a.insertBefore(b.removeChild(c), a.firstChild);
			...
			setAttribute: function() {
				...
				return CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks) ?
				function(f, b) {
					f == "class" ? this.$.className = b: f == "style" ? this.$.style.cssText = b: f == "tabindex" ? this.$.tabIndex = b: f == "checked" ? this.$.checked = b: f == "contenteditable" ? a.call(this, "contentEditable", b) : a.apply(this, arguments);
					return this
			...
			removeStyle: function(a) {
				...
				if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
					...
					for (var b = [], i = 0; i < c.length; i++) if (e) for (var k = 0; k < e.length; k++) b.push([a, c[i], e[k]].join("-"));
	...
	!0, {
		...
		function a(a, b) {
			...
			if (this.current) g = this.current[u](false, m, o);
				...
				if (a) g.type == CKEDITOR.NODE_ELEMENT && (g = e > 0 ? g.getChild(e - 1) : o(g, true) === false ? null: g.getPreviousSourceNode(true, m, o));
				else {
					g = d;
			...
			for (c = m; c < h.length; c++) {
				...
				if (!e[c] || k.$.parentNode != e[c].$.parentNode) for (k = k.getPrevious(); k;) {
					...
					if (b == 2) q.$.insertBefore(k.$.cloneNode(true), q.$.firstChild);
						...
						k.remove();
						b == 1 && q.$.insertBefore(k.$, q.$.firstChild)
					}
					k = n
				}
				q && (q = H)
		...
		CKEDITOR.dom.range.prototype = {
			...
			enlarge: function(a, b) {
				...
				case CKEDITOR.ENLARGE_ELEMENT:
					...
					if (q.type == CKEDITOR.NODE_TEXT) {
						if (n) {
							q = !CKEDITOR.tools.trim(q.substring(0, n)).length && q;
							h = !!q
						}
						...
						for (; m;) {
							...
							if (m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious();
								...
								if (m.type == CKEDITOR.NODE_TEXT) {
									...
									d.test(i) && (m = null);
									q = /[\s\ufeff]$/.test(i)
								} else if ((m.$.offsetWidth > 0 || b && m.is("br")) && !m.data("cke-bookmark")) if (h && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
									i = m.getText();
									if (d.test(i)) m = null;
									else for (var n = m.$.getElementsByTagName("*"), G = 0, C; C = n[G++];) if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
										m = null;
										break
									}
									m && (q = !!i.length)
					...
					if (q.type == CKEDITOR.NODE_TEXT) if (CKEDITOR.tools.trim(q.substring(n)).length) h = true;
					else {
						h = !q.getLength();
						if (n == q.getLength()) {
							if (! (m = q.getNext())) j = q.getParent()
						} else J(q, n) && (j = q.getParent())
			...
			shrink: function(a, b, c) {
				if (!this.collapsed) {
					...
					d.guard = function(b, g) {
						if (m(b)) return true;
						if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || g && b.equals(u) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return false; ! g && b.type == CKEDITOR.NODE_ELEMENT && (u = b);
						return true
					};
			...
			moveToElementEditablePosition: function(a, b) {
				...
				for (var c = 0; a;) {
					...
					g = c,
					f = void 0;
					d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(false) && (f = d[b ? "getLast": "getFirst"](k)); ! g && !f && (f = d[b ? "getPrevious": "getNext"](k));
					a = f
				}
				return !! c
			},
				...
				for (this._.nextNode = null; p;) {
					...
					if (l) p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (l = 0);
						...
						if (CKEDITOR.dtd.$block[m] && p.getAttribute("contenteditable") == "false") {
							...
							if (m == "br") l = 1;
							else if (!h && !p.getChildCount() && m != "hr") {
								b = p;
								s = p.equals(g);
								break
							}
	...
	CKEDITOR.config = {
		...
		function a(a, b, c, d, g) {
			...
			d = a.length; c < d; ++c) {
				...
				if (f.elements === true || f.elements === null) g[e ? "unshift": "push"](f);
					...
					j = f.elements;
					delete f.elements;
					for (z in j) if (b[z]) b[z][e ? "unshift": "push"](f);
					else b[z] = [f]
				}
			}
		}
			...
			if (g.doFilter) {
				a: {
					...
					if (!a && !j) a = null;
						...
						if (a) {
							w = 0;
							for (t = a.length; w < t; ++w) e(a[w], b, q, h)
						}
						if (j) {
							w = 0;
		...
		function m(a, b, c) {
			var d = a.name;
			if (G.$empty[d] || !a.children.length) if (d == "hr" && b == "br") a.replaceWith(l());
			else {
				a.parent && c.push({
					check: "it",
					el: a.parent
				...
				if (g) {
					...
					g = a.parent;
					for (var f = g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g.name == "body",
					p, e = d.length; e > 0;) {
						m = d[--e];
		...
		CKEDITOR.filter.prototype = {
			...
			applyTo: function(a, b, c, d) {
				...
				null, true);
				f.length && (l = true);
				for (var q, a = [], d = x[d || (this.editor ? this.editor.enterMode: CKEDITOR.ENTER_P)]; c = f.pop();) c.type == CKEDITOR.NODE_ELEMENT ? m(c, d, a) : c.remove();
				for (; q = a.pop();) {
					c = q.el;
			...
			addContentForms: function(a) {
				if (!this.disabled && a) {
					...
					if (g) {
						for (b = 0; b < a.length; ++b) d.push(q(a[b], g));
			...
			check: function(a, b, c) {
				...
				b = j.length > 0 ? false: CKEDITOR.tools.objectCompare(g.attributes, e.attributes, true) ? true: false;
		...
		return {
			load: function(b, c, d, f) {
				...
				if (n === 0) o(true);
					...
					var s = function(a, b) { (b ? i: k).push(a);
						if (--n <= 0) {
	...
	CKEDITOR.event.implementOn(CKEDITOR.ui); (function() {
		...
		function f(a) {
			...
			c = v[b] || (v[b] = {});
			if (c.fn) {
				c.fn.call(a, a.config); (CKEDITOR.getUrl(a.config.customConfig) == b || !f(a)) && a.fireOnce("customConfigLoaded")
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			destroy: function(a) {
				this.fire("beforeDestroy"); ! a && s.call(this);
				this.editable(null);
			...
			setData: function(a, b, c) { ! c && this.fire("saveSnapshot");
				if (b || !c) this.once("dataReady",
				function(a) {
				...
				h; c = this._.htmlPartsRegex.exec(b);) {
					...
					if (h) h.push(c[0]);
						...
						if (!/="/.test(d)) {
							...
							this.onTagOpen(d, n, k); ! h && CKEDITOR.dtd.$cdata[d] && (h = [])
						}
	...
	CKEDITOR.htmlParser.fragment = function() {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function(f, h, n) {
			function i(a) {
				var b;
			...
			function s(b, c, d) {
				...
				if (b.previous === void 0) {
					...
					o(b); (!a(b) || b.children.length) && c.add(b);
					b.name == "pre" && (m = false);
				...
				if (a(f)) z.push(f);
					...
					if (d == "br") A.push(f);
						...
						for (;;) {
							...
							if (!f.isUnknown && !l.isUnknown && !p[d]) if (l.isOptionalClose) g.onTagClose(h);
								...
								l = h
							} else if (d in CKEDITOR.dtd.$listItem && !v(d, h)) g.onTagOpen(d == "li" ? "ul": "dl", {},
							0, 1);
		...
		CKEDITOR.htmlParser.fragment.prototype = {
			...
			forEach: function(a, b, c) {
				...
				if (d !== false) for (var c = this.children,
				e = 0; e < c.length; e++) {
					d = c[e];
		...
		a.prototype = {
			...
			exec: function(a, c) {
				...
				for (s = 0; s < n; s++) {
					...
					o = e[s];
					if (! (a.nonEditable && !o.options.applyToAll || a.nestedEditable && o.options.excludeNestedEditable)) {
			...
			execOnName: function(a, c) {
				...
				e = f.length,
				n; c && d < e; d++) {
					n = f[d]; ! (a.nonEditable && !n.options.applyToAll || a.nestedEditable && n.options.excludeNestedEditable) && (c = c.replace(n.value[0], n.value[1]))
				}
				return c
			}
		}
				...
				return function(e) {
					if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if (l) for (t(l, 1) && j.push(l); l;) {
							if (f(l) && (m = c(l)) && t(m)) if ((w = c(m)) && !f(w)) j.push(m);
							else {
								g(p).insertAfter(m);
								m.remove()
							}
						...
						if (j = typeof d == "function" ? d(e) !== false: d) if (!p && !CKEDITOR.env.needsBrFiller && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) j = false;
				...
				return function(b) {
					if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if ("data-cke-bogus" in e || "data-cke-eol" in e) delete e["data-cke-bogus"];
							...
							var j = c(b); ! e && f(b.parent) ? h(b.parent, g(a)) : f(e) && (j && !f(j)) && g(a).insertBefore(e)
						}
					}
				}
			} (p);
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			filter: function(a, b) {
				...
				for (i in e) {
					...
					k && ((n = a.onAttribute(b, f, k, n)) === false ? delete e[k] : e[k] = n)
				}
			...
			getFirst: function(b) {
				...
				for (var d = 0,
				f = this.children.length; d < f; ++d) if (b(this.children[d])) return this.children[d];
				return null
			},
			getHtml: function() {
			...
			setHtml: function(a) {
				for (var a = this.children = CKEDITOR.htmlParser.fragment.fromHtml(a).children, b = 0, f = a.length; b < f; ++b) a[b].parent = this
			},
			getOuterHtml: function() {
				var a = new CKEDITOR.htmlParser.basicWriter;
				this.writeHtml(a);
		...
		CKEDITOR.editor.prototype.setMode = function(a, b) {
			...
			if (! (a == c.mode || !e || !e[a])) {
				...
				this._.modes[a](function() {
					...
					o ? c.fire("unlockSnapshot") : a == "wysiwyg" && c.fire("saveSnapshot");
					setTimeout(function() {
						c.fire("mode");
						b && b.call(c)
					},
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				insertElementIntoRange: function(a, b) {
					...
					var m, h;
					if (f) for (; (m = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[m.getName()]) && (!h || !h[e]);) if (m.getName() in CKEDITOR.dtd.span) b.splitElement(m);
					...
					if (!this.is("textarea")) {
						...
						function(b) {
							...
							if (c in l) {
								...
								if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (e = b.getSelectedElement()) || (e = f(b))) {
									...
									a.fire("saveSnapshot");
									d = 1
								} else if (q.collapsed) if ((i = h.block) && (p = i[c ? "getPrevious": "getNext"](o)) && p.type == CKEDITOR.NODE_ELEMENT && p.is("table") && q[c ? "checkStartOfBlock": "checkEndOfBlock"]()) {
									a.fire("saveSnapshot");
									...
									a.fire("saveSnapshot");
									q["moveToElementEdit" + (c ? "End": "Start")](p);
									q.checkStartOfBlock() && q.checkEndOfBlock() ? p.remove() : q.select();
									a.fire("saveSnapshot");
									d = 1
						...
						function(b) {
							...
							if (b in l) {
								...
								e = d.startPath(),
								f = e.block;
								if (d.collapsed && f && d[b ? "checkStartOfBlock": "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !b) && d.collapsed) {
									...
									if ((d = d.startPath().block) && (!d || !d.contains(f))) {
										...
										var p; (p = (b ? d: f).getBogus()) && p.remove();
										p = c.createBookmarks(); (b ? f: d).moveChildren(b ? d: f, false);
		...
		var r = function() {
			...
			return function(h, i, u) {
				...
				if (!s.checkReadOnly()) {
					...
					x = o.createBookmark(); (t = x.startNode.getPrevious(c)) && a(t) && e(t) && r.push(t); (t = x.startNode.getNext(c)) && a(t) && e(t) && r.push(t);
					...
					if (x) {
						...
						for (j(y, D); x < y.length; x++) {
							...
							if (v) r = x > 0;
								...
								if (B.lastNotAllowed && x < y.length - 1) { (S = N ? t: S) && D.setEndAt(S, CKEDITOR.POSITION_AFTER_START);
									o = 0
								}
								D.collapse()
							}
		...
		v = function() {
			...
			return function(d) {
				...
				if (f.is("table")) {
					...
					f.is("tr") && (f = b(f, f.getParent().is("thead") ? "th": "td", m)); (e = f.getBogus()) && e.remove();
			...
			getRanges: function() {
				...
				function() {
					...
					var b = function(b, c) {
						...
						f, g, h = b.duplicate(), i = 0, l = e.length - 1, t = -1, m, k; i <= l;) {
							t = Math.floor((i + l) / 2);
							f = e[t];
	...
	CKEDITOR.STYLE_OBJECT = 3; (function() {
			...
			if (b.collapsed) {
				...
				for (n.getPosition(l) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
					...
					if (n.equals(l)) {
						...
						if (r && k && CKEDITOR.dtd.$block[q]) for (var u = n,
						A = c(u), C = void 0, H = A.length, P = 0, u = H && new CKEDITOR.dom.range(u.getDocument()); P < H; ++P) {
							var C = A[P],
						...
						if (A) if ((A = n.getParent()) && ((A.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(A))) {
							if (!p && (!q || !CKEDITOR.dtd.$removeEmpty[q] || (n.getPosition(l) | J) == J)) {
								p = b.clone();
								p.setStartBefore(n)
							}
							q = n.type;
							if (q == CKEDITOR.NODE_TEXT || r || q == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
								for (var q = n,
								L; (i = !q.getNext(G)) && (L = q.getParent(), j[L.getName()]) && (L.getPosition(m) | F) == F && (!g.childRule || g.childRule(L));) q = L;
								p.setEndAfter(q)
							}
						} else i = true;
						else i = true;
					...
					if (i && p && !p.collapsed) {
						for (var i = z(this, d), r = i.hasAttributes(), s = p.getCommonAncestor(), q = {},
						A = {},
						C = {},
						H = {},
						V, R, Y; i && s;) {
							if (s.getName() == f) {
								for (V in g.attributes) if (!H[V] && (Y = s.getAttribute(R))) i.getAttribute(V) == Y ? A[V] = 1 : H[V] = 1;
		...
		CKEDITOR.style.prototype = {
			...
			removeFromRange: function(a) {
				this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? b: this.type == CKEDITOR.STYLE_BLOCK ? n: this.type == CKEDITOR.STYLE_OBJECT ? f: null;
					...
					getNextRange: function(h) {
						...
						if (n && a.length > 1) {
							...
							if (h) for (var k = 0; a[e + k + 1];) {
								...
								h = 0,
								i = o.getById(d[k].endNode), o = o.getById(d[k + 1].startNode);;) {
		...
		function v(b) {
			...
			function l(a, d) {
				...
				if (!c.getById("cke_pastebin")) {
					...
					s = i.createBookmarks(),
					k = new CKEDITOR.dom.element((CKEDITOR.env.webkit || j.is("body")) && !CKEDITOR.env.ie ? "body": "div", c);
					k.setAttributes({
						id: "cke_pastebin",
						"data-cke-temp": "1"
					});
	...
	CKEDITOR.config.removeFormatAttributes = "class,style,lang,width,height,align,hspace,valign"; (function() {
		function f(a, b, c) {
			var e = CKEDITOR.document.getById(c),
			d;
			...
			null, null, 1),
			d = e.append(CKEDITOR.dom.element.createFromHtml(g.output({
				id: a.id,
				name: a.name,
				langDir: a.lang.dir,
				langCode: a.langCode,
			...
			e.getCustomData("cke_hasshared") ? d.hide() : e.setCustomData("cke_hasshared", 1),
			d.unselectable(),
			d.on("mousedown",
			function(a) {
				a = a.data;
			...
			function() {
				for (var a = 0,
				b, c = e.getChildren(); b = c.getItem(a); a++) b.type == CKEDITOR.NODE_ELEMENT && (!b.equals(d) && b.hasClass("cke_shared")) && b.hide();
				d.show()
			}),
			a.on("destroy",
			function() {
	...
	CKEDITOR.config.toolbarLocation = "top"; (function() {
		...
		function k(a) {
			...
			e && e.parentNode.removeChild(e); (e = b.getElementById("cke_shimscrpt")) && e.parentNode.removeChild(e);
